...
public final class PlayerMatchInfoNotifyOuterClass {
  ...
  public interface PlayerMatchInfoNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 NAMPEEDGBPE = 11;</code>
     * @return The nAMPEEDGBPE.
     */
    int getNAMPEEDGBPE();
    ...
    /**
     * <code>uint32 GAEKCLLKOMM = 5;</code>
     * @return The gAEKCLLKOMM.
     */
    int getGAEKCLLKOMM();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int NAMPEEDGBPE_FIELD_NUMBER = 11;
    private int nAMPEEDGBPE_;
    /**
     * <code>uint32 NAMPEEDGBPE = 11;</code>
     * @return The nAMPEEDGBPE.
     */
    @java.lang.Override
    public int getNAMPEEDGBPE() {
      return nAMPEEDGBPE_;
    }
    ...
    public static final int GAEKCLLKOMM_FIELD_NUMBER = 5;
    private int gAEKCLLKOMM_;
    /**
     * <code>uint32 GAEKCLLKOMM = 5;</code>
     * @return The gAEKCLLKOMM.
     */
    @java.lang.Override
    public int getGAEKCLLKOMM() {
      return gAEKCLLKOMM_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (gAEKCLLKOMM_ != 0) {
        output.writeUInt32(5, gAEKCLLKOMM_);
      }
      if (hostUid_ != 0) {
      ...
      if (nAMPEEDGBPE_ != 0) {
        output.writeUInt32(11, nAMPEEDGBPE_);
      }
      if (matchId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (gAEKCLLKOMM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, gAEKCLLKOMM_);
      }
      if (hostUid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (nAMPEEDGBPE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, nAMPEEDGBPE_);
      }
      if (matchId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNAMPEEDGBPE()
          != other.getNAMPEEDGBPE()) return false;
      if (getHostUid()
      ...
      if (getGAEKCLLKOMM()
          != other.getGAEKCLLKOMM()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NAMPEEDGBPE_FIELD_NUMBER;
      hash = (53 * hash) + getNAMPEEDGBPE();
      ...
      hash = (37 * hash) + GAEKCLLKOMM_FIELD_NUMBER;
      hash = (53 * hash) + getGAEKCLLKOMM();
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify other) {
        ...
        if (other.getNAMPEEDGBPE() != 0) {
          setNAMPEEDGBPE(other.getNAMPEEDGBPE());
        }
        ...
        if (other.getGAEKCLLKOMM() != 0) {
          setGAEKCLLKOMM(other.getGAEKCLLKOMM());
        }
      ...
      /**
       * <code>uint32 NAMPEEDGBPE = 11;</code>
       * @param value The nAMPEEDGBPE to set.
       * @return This builder for chaining.
       */
      public Builder setNAMPEEDGBPE(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNAMPEEDGBPE() {
      ...
      /**
       * <code>uint32 GAEKCLLKOMM = 5;</code>
       * @param value The gAEKCLLKOMM to set.
       * @return This builder for chaining.
       */
      public Builder setGAEKCLLKOMM(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGAEKCLLKOMM() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "EEDGBPE\030\013 \001(\r\022\020\n\010host_uid\030\006 \001(\r\022\022\n\ndunge" +
      "on_id\030\t \001(\r\022\022\n\nmp_play_id\030\007 \001(\r\022\036\n\nmatch" +
      "_type\030\016 \001(\0162\n.MatchType\022\023\n\013GAEKCLLKOMM\030\005" +
      " \001(\r\022\030\n\020match_param_list\030\002 \003(\r\022\020\n\010match_" +
      "id\030\r \001(\r\022\"\n\032mechanicus_difficult_level\030\010" +
    ...
    internal_static_PlayerMatchInfoNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerMatchInfoNotify_descriptor,
        new java.lang.String[] { "NAMPEEDGBPE", "HostUid", "DungeonId", "MpPlayId", "MatchType", "GAEKCLLKOMM", "MatchParamList", "MatchId", "MechanicusDifficultLevel", });
    emu.grasscutter.net.proto.MatchTypeOuterClass.getDescriptor();
  }
