...
public final class FungusFighterTrainingGallerySettleNotifyOuterClass {
  ...
  public interface FungusFighterTrainingGallerySettleNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 COCEMCJMFGA = 15;</code>
     * @return The cOCEMCJMFGA.
     */
    int getCOCEMCJMFGA();

    /**
     * <code>uint32 PNKNJPIMAFC = 12;</code>
     * @return The pNKNJPIMAFC.
     */
    int getPNKNJPIMAFC();
    ...
    /**
     * <code>uint32 total_used_time = 13;</code>
    ...
    /**
     * <code>uint32 GEAAIMCNKCK = 4;</code>
     * @return The gEAAIMCNKCK.
     */
    int getGEAAIMCNKCK();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int COCEMCJMFGA_FIELD_NUMBER = 15;
    private int cOCEMCJMFGA_;
    /**
     * <code>uint32 COCEMCJMFGA = 15;</code>
     * @return The cOCEMCJMFGA.
     */
    @java.lang.Override
    public int getCOCEMCJMFGA() {
      return cOCEMCJMFGA_;
    }

    public static final int PNKNJPIMAFC_FIELD_NUMBER = 12;
    private int pNKNJPIMAFC_;
    /**
     * <code>uint32 PNKNJPIMAFC = 12;</code>
     * @return The pNKNJPIMAFC.
     */
    @java.lang.Override
    public int getPNKNJPIMAFC() {
      return pNKNJPIMAFC_;
    }
    ...
    public static final int TOTAL_USED_TIME_FIELD_NUMBER = 13;
    ...
    public static final int GEAAIMCNKCK_FIELD_NUMBER = 4;
    private int gEAAIMCNKCK_;
    /**
     * <code>uint32 GEAAIMCNKCK = 4;</code>
     * @return The gEAAIMCNKCK.
     */
    @java.lang.Override
    public int getGEAAIMCNKCK() {
      return gEAAIMCNKCK_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (gEAAIMCNKCK_ != 0) {
        output.writeUInt32(4, gEAAIMCNKCK_);
      }
      if (isNewRecord_ != false) {
        output.writeBool(11, isNewRecord_);
      }
      if (pNKNJPIMAFC_ != 0) {
        output.writeUInt32(12, pNKNJPIMAFC_);
      }
      if (totalUsedTime_ != 0) {
        output.writeUInt32(13, totalUsedTime_);
      }
      if (cOCEMCJMFGA_ != 0) {
        output.writeUInt32(15, cOCEMCJMFGA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (gEAAIMCNKCK_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, gEAAIMCNKCK_);
      }
      if (isNewRecord_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (pNKNJPIMAFC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, pNKNJPIMAFC_);
      }
      if (totalUsedTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, totalUsedTime_);
      }
      if (cOCEMCJMFGA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, cOCEMCJMFGA_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getCOCEMCJMFGA()
          != other.getCOCEMCJMFGA()) return false;
      if (getPNKNJPIMAFC()
          != other.getPNKNJPIMAFC()) return false;
      if (getFinalScore()
      ...
      if (getGEAAIMCNKCK()
          != other.getGEAAIMCNKCK()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + COCEMCJMFGA_FIELD_NUMBER;
      hash = (53 * hash) + getCOCEMCJMFGA();
      hash = (37 * hash) + PNKNJPIMAFC_FIELD_NUMBER;
      hash = (53 * hash) + getPNKNJPIMAFC();
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsFinalSettle());
      hash = (37 * hash) + GEAAIMCNKCK_FIELD_NUMBER;
      hash = (53 * hash) + getGEAAIMCNKCK();
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FungusFighterTrainingGallerySettleNotifyOuterClass.FungusFighterTrainingGallerySettleNotify other) {
        ...
        if (other.getCOCEMCJMFGA() != 0) {
          setCOCEMCJMFGA(other.getCOCEMCJMFGA());
        }
        if (other.getPNKNJPIMAFC() != 0) {
          setPNKNJPIMAFC(other.getPNKNJPIMAFC());
        }
        ...
        if (other.getGEAAIMCNKCK() != 0) {
          setGEAAIMCNKCK(other.getGEAAIMCNKCK());
        }
      ...
      /**
       * <code>uint32 COCEMCJMFGA = 15;</code>
       * @param value The cOCEMCJMFGA to set.
       * @return This builder for chaining.
       */
      public Builder setCOCEMCJMFGA(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCOCEMCJMFGA() {
      ...
      /**
       * <code>uint32 PNKNJPIMAFC = 12;</code>
       * @param value The pNKNJPIMAFC to set.
       * @return This builder for chaining.
       */
      public Builder setPNKNJPIMAFC(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearPNKNJPIMAFC() {
      ...
      /**
       * <code>uint32 GEAAIMCNKCK = 4;</code>
       * @param value The gEAAIMCNKCK to set.
       * @return This builder for chaining.
       */
      public Builder setGEAAIMCNKCK(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGEAAIMCNKCK() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\006reason\030\002 \001(\0162\022.GalleryStopReason\022\023\n\013CO" +
      "CEMCJMFGA\030\017 \001(\r\022\023\n\013PNKNJPIMAFC\030\014 \001(\r\022\023\n\013" +
      "final_score\030\001 \001(\r\022\027\n\017total_used_time\030\r \001" +
      "(\r\022\025\n\ris_new_record\030\013 \001(\010\022\027\n\017is_final_se" +
      "ttle\030\003 \001(\010\022\023\n\013GEAAIMCNKCK\030\004 \001(\rB\033\n\031emu.g" +
    ...
    internal_static_FungusFighterTrainingGallerySettleNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FungusFighterTrainingGallerySettleNotify_descriptor,
        new java.lang.String[] { "Reason", "COCEMCJMFGA", "PNKNJPIMAFC", "FinalScore", "TotalUsedTime", "IsNewRecord", "IsFinalSettle", "GEAAIMCNKCK", });
    emu.grasscutter.net.proto.GalleryStopReasonOuterClass.getDescriptor();
  }
