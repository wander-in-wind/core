...
public final class ClientNewMailNotifyOuterClass {
  ...
  public interface ClientNewMailNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 BKHHHACGKKA = 2;</code>
     * @return The bKHHHACGKKA.
     */
    int getBKHHHACGKKA();

    /**
     * <code>bool NIKMLGOAFIA = 3;</code>
     * @return The nIKMLGOAFIA.
     */
    boolean getNIKMLGOAFIA();

    /**
     * <code>uint32 JEGNPFIFGOI = 1;</code>
     * @return The jEGNPFIFGOI.
     */
    int getJEGNPFIFGOI();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              jEGNPFIFGOI_ = input.readUInt32();
              break;
            }
            case 16: {

              bKHHHACGKKA_ = input.readUInt32();
              break;
            }
            case 24: {

              nIKMLGOAFIA_ = input.readBool();
              break;
            }
            default: {
    ...
    public static final int BKHHHACGKKA_FIELD_NUMBER = 2;
    private int bKHHHACGKKA_;
    /**
     * <code>uint32 BKHHHACGKKA = 2;</code>
     * @return The bKHHHACGKKA.
     */
    @java.lang.Override
    public int getBKHHHACGKKA() {
      return bKHHHACGKKA_;
    }

    public static final int NIKMLGOAFIA_FIELD_NUMBER = 3;
    private boolean nIKMLGOAFIA_;
    /**
     * <code>bool NIKMLGOAFIA = 3;</code>
     * @return The nIKMLGOAFIA.
     */
    @java.lang.Override
    public boolean getNIKMLGOAFIA() {
      return nIKMLGOAFIA_;
    }

    public static final int JEGNPFIFGOI_FIELD_NUMBER = 1;
    private int jEGNPFIFGOI_;
    /**
     * <code>uint32 JEGNPFIFGOI = 1;</code>
     * @return The jEGNPFIFGOI.
     */
    @java.lang.Override
    public int getJEGNPFIFGOI() {
      return jEGNPFIFGOI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (jEGNPFIFGOI_ != 0) {
        output.writeUInt32(1, jEGNPFIFGOI_);
      }
      if (bKHHHACGKKA_ != 0) {
        output.writeUInt32(2, bKHHHACGKKA_);
      }
      if (nIKMLGOAFIA_ != false) {
        output.writeBool(3, nIKMLGOAFIA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (jEGNPFIFGOI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, jEGNPFIFGOI_);
      }
      if (bKHHHACGKKA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, bKHHHACGKKA_);
      }
      if (nIKMLGOAFIA_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, nIKMLGOAFIA_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getBKHHHACGKKA()
          != other.getBKHHHACGKKA()) return false;
      if (getNIKMLGOAFIA()
          != other.getNIKMLGOAFIA()) return false;
      if (getJEGNPFIFGOI()
          != other.getJEGNPFIFGOI()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + BKHHHACGKKA_FIELD_NUMBER;
      hash = (53 * hash) + getBKHHHACGKKA();
      hash = (37 * hash) + NIKMLGOAFIA_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getNIKMLGOAFIA());
      hash = (37 * hash) + JEGNPFIFGOI_FIELD_NUMBER;
      hash = (53 * hash) + getJEGNPFIFGOI();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ClientNewMailNotifyOuterClass.ClientNewMailNotify buildPartial() {
        ...
        result.bKHHHACGKKA_ = bKHHHACGKKA_;
        result.nIKMLGOAFIA_ = nIKMLGOAFIA_;
        result.jEGNPFIFGOI_ = jEGNPFIFGOI_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ClientNewMailNotifyOuterClass.ClientNewMailNotify other) {
        ...
        if (other.getBKHHHACGKKA() != 0) {
          setBKHHHACGKKA(other.getBKHHHACGKKA());
        }
        if (other.getNIKMLGOAFIA() != false) {
          setNIKMLGOAFIA(other.getNIKMLGOAFIA());
        }
        if (other.getJEGNPFIFGOI() != 0) {
          setJEGNPFIFGOI(other.getJEGNPFIFGOI());
        }
      ...
      /**
       * <code>uint32 BKHHHACGKKA = 2;</code>
       * @param value The bKHHHACGKKA to set.
       * @return This builder for chaining.
       */
      public Builder setBKHHHACGKKA(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBKHHHACGKKA() {
      ...
      /**
       * <code>bool NIKMLGOAFIA = 3;</code>
       * @param value The nIKMLGOAFIA to set.
       * @return This builder for chaining.
       */
      public Builder setNIKMLGOAFIA(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNIKMLGOAFIA() {
      ...
      /**
       * <code>uint32 JEGNPFIFGOI = 1;</code>
       * @param value The jEGNPFIFGOI to set.
       * @return This builder for chaining.
       */
      public Builder setJEGNPFIFGOI(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearJEGNPFIFGOI() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "MailNotify\022\023\n\013BKHHHACGKKA\030\002 \001(\r\022\023\n\013NIKML" +
      "GOAFIA\030\003 \001(\010\022\023\n\013JEGNPFIFGOI\030\001 \001(\rB\033\n\031emu" +
    ...
    internal_static_ClientNewMailNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ClientNewMailNotify_descriptor,
        new java.lang.String[] { "BKHHHACGKKA", "NIKMLGOAFIA", "JEGNPFIFGOI", });
  }
