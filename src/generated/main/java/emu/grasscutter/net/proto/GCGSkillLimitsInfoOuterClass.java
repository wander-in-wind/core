...
public final class GCGSkillLimitsInfoOuterClass {
  ...
  public interface GCGSkillLimitsInfoOrBuilder extends
    ...
    /**
     * <code>repeated .GCGLimitsInfo limits_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LIMITS_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < limitsList_.size(); i++) {
        output.writeMessage(1, limitsList_.get(i));
      }
      if (skillId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < limitsList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, limitsList_.get(i));
      }
      if (skillId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "d\030\013 \001(\r\022#\n\013limits_list\030\001 \003(\0132\016.GCGLimits" +
