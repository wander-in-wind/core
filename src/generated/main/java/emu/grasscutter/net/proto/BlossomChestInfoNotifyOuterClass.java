...
public final class BlossomChestInfoNotifyOuterClass {
  ...
  public interface BlossomChestInfoNotifyOrBuilder extends
    ...
    /**
     * <code>.BlossomChestInfo blossom_chest_info = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BLOSSOM_CHEST_INFO_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (blossomChestInfo_ != null) {
        output.writeMessage(1, getBlossomChestInfo());
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (blossomChestInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getBlossomChestInfo());
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022-\n\022blossom_chest_info\030\001 \001(\0132\021.BlossomCh" +
