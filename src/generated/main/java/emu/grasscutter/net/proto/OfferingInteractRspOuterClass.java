...
public final class OfferingInteractRspOuterClass {
  ...
  public interface OfferingInteractRspOrBuilder extends
    ...
    /**
     * <code>.PlayerOfferingData offering_data = 9;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int OFFERING_DATA_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (offeringData_ != null) {
        output.writeMessage(9, getOfferingData());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (offeringData_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, getOfferingData());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "offering_data\030\t \001(\0132\023.PlayerOfferingData" +
