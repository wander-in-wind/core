...
public final class TakeResinCardDailyRewardRspOuterClass {
  ...
  public interface TakeResinCardDailyRewardRspOrBuilder extends
    ...
    /**
     * <code>repeated .ItemParam item_vec = 12;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ITEM_VEC_FIELD_NUMBER = 12;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < itemVec_.size(); i++) {
        output.writeMessage(12, itemVec_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < itemVec_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, itemVec_.get(i));
      }
      if (productConfigId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Rsp\022\031\n\021product_config_id\030\016 \001(\r\022\017\n\007retcod" +
      "e\030\001 \001(\005\022\034\n\010item_vec\030\014 \003(\0132\n.ItemParamB\033\n" +
