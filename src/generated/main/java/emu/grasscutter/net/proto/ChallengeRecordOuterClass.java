...
public final class ChallengeRecordOuterClass {
  ...
  public interface ChallengeRecordOrBuilder extends
    ...
    /**
     * <code>uint32 MDLNIEHGHHD = 1;</code>
     * @return The mDLNIEHGHHD.
     */
    int getMDLNIEHGHHD();

    /**
     * <code>uint32 HHHBNDFPJJI = 15;</code>
     * @return The hHHBNDFPJJI.
     */
    int getHHHBNDFPJJI();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MDLNIEHGHHD_FIELD_NUMBER = 1;
    private int mDLNIEHGHHD_;
    /**
     * <code>uint32 MDLNIEHGHHD = 1;</code>
     * @return The mDLNIEHGHHD.
     */
    @java.lang.Override
    public int getMDLNIEHGHHD() {
      return mDLNIEHGHHD_;
    }

    public static final int HHHBNDFPJJI_FIELD_NUMBER = 15;
    private int hHHBNDFPJJI_;
    /**
     * <code>uint32 HHHBNDFPJJI = 15;</code>
     * @return The hHHBNDFPJJI.
     */
    @java.lang.Override
    public int getHHHBNDFPJJI() {
      return hHHBNDFPJJI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (mDLNIEHGHHD_ != 0) {
        output.writeUInt32(1, mDLNIEHGHHD_);
      }
      ...
      if (hHHBNDFPJJI_ != 0) {
        output.writeUInt32(15, hHHBNDFPJJI_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (mDLNIEHGHHD_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, mDLNIEHGHHD_);
      }
      if (challengeIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (hHHBNDFPJJI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, hHHBNDFPJJI_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getMDLNIEHGHHD()
          != other.getMDLNIEHGHHD()) return false;
      if (getHHHBNDFPJJI()
          != other.getHHHBNDFPJJI()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + MDLNIEHGHHD_FIELD_NUMBER;
      hash = (53 * hash) + getMDLNIEHGHHD();
      hash = (37 * hash) + HHHBNDFPJJI_FIELD_NUMBER;
      hash = (53 * hash) + getHHHBNDFPJJI();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ChallengeRecordOuterClass.ChallengeRecord buildPartial() {
        ...
        result.mDLNIEHGHHD_ = mDLNIEHGHHD_;
        result.hHHBNDFPJJI_ = hHHBNDFPJJI_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ChallengeRecordOuterClass.ChallengeRecord other) {
        ...
        if (other.getMDLNIEHGHHD() != 0) {
          setMDLNIEHGHHD(other.getMDLNIEHGHHD());
        }
        if (other.getHHHBNDFPJJI() != 0) {
          setHHHBNDFPJJI(other.getHHHBNDFPJJI());
        }
      ...
      /**
       * <code>uint32 MDLNIEHGHHD = 1;</code>
       * @param value The mDLNIEHGHHD to set.
       * @return This builder for chaining.
       */
      public Builder setMDLNIEHGHHD(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMDLNIEHGHHD() {
      ...
      /**
       * <code>uint32 HHHBNDFPJJI = 15;</code>
       * @param value The hHHBNDFPJJI to set.
       * @return This builder for chaining.
       */
      public Builder setHHHBNDFPJJI(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHHHBNDFPJJI() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rd\022\024\n\014challenge_id\030\003 \001(\r\022\027\n\017challenge_in" +
      "dex\030\002 \001(\r\022\023\n\013MDLNIEHGHHD\030\001 \001(\r\022\023\n\013HHHBND" +
      "FPJJI\030\017 \001(\rB\033\n\031emu.grasscutter.net.proto" +
      "b\006proto3"
    };
    ...
    internal_static_ChallengeRecord_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ChallengeRecord_descriptor,
        new java.lang.String[] { "ChallengeId", "ChallengeIndex", "MDLNIEHGHHD", "HHHBNDFPJJI", });
  }
