...
public final class SceneGallerySorushTrialHitmanInfoOuterClass {
  ...
  public interface SceneGallerySorushTrialHitmanInfoOrBuilder extends
    ...
    /**
     * <code>uint64 CMDIOKFHHKF = 1;</code>
     * @return The cMDIOKFHHKF.
     */
    long getCMDIOKFHHKF();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CMDIOKFHHKF_FIELD_NUMBER = 1;
    private long cMDIOKFHHKF_;
    /**
     * <code>uint64 CMDIOKFHHKF = 1;</code>
     * @return The cMDIOKFHHKF.
     */
    @java.lang.Override
    public long getCMDIOKFHHKF() {
      return cMDIOKFHHKF_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (cMDIOKFHHKF_ != 0L) {
        output.writeUInt64(1, cMDIOKFHHKF_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (cMDIOKFHHKF_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(1, cMDIOKFHHKF_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getCMDIOKFHHKF()
          != other.getCMDIOKFHHKF()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + CMDIOKFHHKF_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SceneGallerySorushTrialHitmanInfoOuterClass.SceneGallerySorushTrialHitmanInfo buildPartial() {
        ...
        result.cMDIOKFHHKF_ = cMDIOKFHHKF_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SceneGallerySorushTrialHitmanInfoOuterClass.SceneGallerySorushTrialHitmanInfo other) {
        ...
        if (other.getCMDIOKFHHKF() != 0L) {
          setCMDIOKFHHKF(other.getCMDIOKFHHKF());
        }
      ...
      /**
       * <code>uint64 CMDIOKFHHKF = 1;</code>
       * @param value The cMDIOKFHHKF to set.
       * @return This builder for chaining.
       */
      public Builder setCMDIOKFHHKF(long value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCMDIOKFHHKF() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\013CMDIOKFHHKF\030\001 \001(\004B\033\n\031emu.grasscutter.n" +
      "et.protob\006proto3"
    };
    ...
    internal_static_SceneGallerySorushTrialHitmanInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneGallerySorushTrialHitmanInfo_descriptor,
        new java.lang.String[] { "CMDIOKFHHKF", });
  }
