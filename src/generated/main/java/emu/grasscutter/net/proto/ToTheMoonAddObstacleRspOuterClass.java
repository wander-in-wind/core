...
public final class ToTheMoonAddObstacleRspOuterClass {
  ...
  public interface ToTheMoonAddObstacleRspOrBuilder extends
    ...
    /**
     * <code>.DynamicNodes dynamic_nodes = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DYNAMIC_NODES_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (dynamicNodes_ != null) {
        output.writeMessage(3, getDynamicNodes());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (dynamicNodes_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getDynamicNodes());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\007retcode\030\006 \001(\005\022\020\n\010query_id\030\007 \001(\005\022$\n\rdyn" +
      "amic_nodes\030\003 \001(\0132\r.DynamicNodesB\033\n\031emu.g" +
