...
public final class FleurFairBossSettleInfoOuterClass {
  ...
  public interface FleurFairBossSettleInfoOrBuilder extends
    ...
    /**
     * <code>repeated .FleurFairPlayerStatInfo stat_info_list = 8;</code>
     */
    ...
    /**
     * <code>uint32 reward_token_num = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int STAT_INFO_LIST_FIELD_NUMBER = 8;
    ...
    public static final int REWARD_TOKEN_NUM_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (rewardTokenNum_ != 0) {
        output.writeUInt32(7, rewardTokenNum_);
      }
      for (int i = 0; i < statInfoList_.size(); i++) {
        output.writeMessage(8, statInfoList_.get(i));
      }
      if (isSuccess_ != false) {
    ...
    public int getSerializedSize() {
      ...
      if (rewardTokenNum_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, rewardTokenNum_);
      }
      for (int i = 0; i < statInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, statInfoList_.get(i));
      }
      if (isSuccess_ != false) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "SettleInfo\022\016\n\006energy\030\004 \001(\r\022\021\n\tcost_time\030" +
      "\001 \001(\r\022\022\n\nis_success\030\t \001(\010\0220\n\016stat_info_l" +
      "ist\030\010 \003(\0132\030.FleurFairPlayerStatInfo\022\030\n\020r" +
      "eward_token_num\030\007 \001(\rB\033\n\031emu.grasscutter" +
    ...
    internal_static_FleurFairBossSettleInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FleurFairBossSettleInfo_descriptor,
        new java.lang.String[] { "Energy", "CostTime", "IsSuccess", "StatInfoList", "RewardTokenNum", });
    emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.getDescriptor();
  }
