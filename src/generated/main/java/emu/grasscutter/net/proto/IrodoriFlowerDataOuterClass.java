...
public final class IrodoriFlowerDataOuterClass {
  ...
  public interface IrodoriFlowerDataOrBuilder extends
    ...
    /**
     * <code>repeated .ItemParam used_flower_list = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int USED_FLOWER_LIST_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < usedFlowerList_.size(); i++) {
        output.writeMessage(7, usedFlowerList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < usedFlowerList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, usedFlowerList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e_list\030\001 \003(\r\022$\n\020used_flower_list\030\007 \003(\0132\n" +
