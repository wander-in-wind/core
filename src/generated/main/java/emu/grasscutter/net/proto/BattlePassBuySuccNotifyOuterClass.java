...
public final class BattlePassBuySuccNotifyOuterClass {
  ...
  public interface BattlePassBuySuccNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 KIHLPOPDEHO = 5;</code>
     * @return The kIHLPOPDEHO.
     */
    int getKIHLPOPDEHO();

    /**
     * <code>uint32 CLAPOODOICH = 8;</code>
     * @return The cLAPOODOICH.
     */
    int getCLAPOODOICH();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              kIHLPOPDEHO_ = input.readUInt32();
              break;
            }
            case 64: {

              cLAPOODOICH_ = input.readUInt32();
              break;
            }
            case 120: {
    ...
    public static final int KIHLPOPDEHO_FIELD_NUMBER = 5;
    private int kIHLPOPDEHO_;
    /**
     * <code>uint32 KIHLPOPDEHO = 5;</code>
     * @return The kIHLPOPDEHO.
     */
    @java.lang.Override
    public int getKIHLPOPDEHO() {
      return kIHLPOPDEHO_;
    }

    public static final int CLAPOODOICH_FIELD_NUMBER = 8;
    private int cLAPOODOICH_;
    /**
     * <code>uint32 CLAPOODOICH = 8;</code>
     * @return The cLAPOODOICH.
     */
    @java.lang.Override
    public int getCLAPOODOICH() {
      return cLAPOODOICH_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (kIHLPOPDEHO_ != 0) {
        output.writeUInt32(5, kIHLPOPDEHO_);
      }
      if (cLAPOODOICH_ != 0) {
        output.writeUInt32(8, cLAPOODOICH_);
      }
      if (scheduleId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (kIHLPOPDEHO_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, kIHLPOPDEHO_);
      }
      if (cLAPOODOICH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, cLAPOODOICH_);
      }
      if (scheduleId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getKIHLPOPDEHO()
          != other.getKIHLPOPDEHO()) return false;
      if (getCLAPOODOICH()
          != other.getCLAPOODOICH()) return false;
      if (getScheduleId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + KIHLPOPDEHO_FIELD_NUMBER;
      hash = (53 * hash) + getKIHLPOPDEHO();
      hash = (37 * hash) + CLAPOODOICH_FIELD_NUMBER;
      hash = (53 * hash) + getCLAPOODOICH();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.BattlePassBuySuccNotifyOuterClass.BattlePassBuySuccNotify buildPartial() {
        ...
        result.kIHLPOPDEHO_ = kIHLPOPDEHO_;
        result.cLAPOODOICH_ = cLAPOODOICH_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BattlePassBuySuccNotifyOuterClass.BattlePassBuySuccNotify other) {
        ...
        if (other.getKIHLPOPDEHO() != 0) {
          setKIHLPOPDEHO(other.getKIHLPOPDEHO());
        }
        if (other.getCLAPOODOICH() != 0) {
          setCLAPOODOICH(other.getCLAPOODOICH());
        }
      ...
      /**
       * <code>uint32 KIHLPOPDEHO = 5;</code>
       * @param value The kIHLPOPDEHO to set.
       * @return This builder for chaining.
       */
      public Builder setKIHLPOPDEHO(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearKIHLPOPDEHO() {
      ...
      /**
       * <code>uint32 CLAPOODOICH = 8;</code>
       * @param value The cLAPOODOICH to set.
       * @return This builder for chaining.
       */
      public Builder setCLAPOODOICH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCLAPOODOICH() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "IHLPOPDEHO\030\005 \001(\r\022\023\n\013CLAPOODOICH\030\010 \001(\r\022\023\n" +
      "\013schedule_id\030\017 \001(\r\022\035\n\titem_list\030\002 \003(\0132\n." +
    ...
    internal_static_BattlePassBuySuccNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BattlePassBuySuccNotify_descriptor,
        new java.lang.String[] { "KIHLPOPDEHO", "CLAPOODOICH", "ScheduleId", "ItemList", });
    emu.grasscutter.net.proto.ItemParamOuterClass.getDescriptor();
  }
