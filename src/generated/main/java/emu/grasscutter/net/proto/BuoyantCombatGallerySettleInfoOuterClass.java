...
public final class BuoyantCombatGallerySettleInfoOuterClass {
  ...
  public interface BuoyantCombatGallerySettleInfoOrBuilder extends
    ...
    /**
     * <code>uint32 FGNPAGJDGMJ = 1;</code>
     * @return The fGNPAGJDGMJ.
     */
    int getFGNPAGJDGMJ();

    /**
     * <code>uint32 ECNCAFKGHNJ = 13;</code>
     * @return The eCNCAFKGHNJ.
     */
    int getECNCAFKGHNJ();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int FGNPAGJDGMJ_FIELD_NUMBER = 1;
    private int fGNPAGJDGMJ_;
    /**
     * <code>uint32 FGNPAGJDGMJ = 1;</code>
     * @return The fGNPAGJDGMJ.
     */
    @java.lang.Override
    public int getFGNPAGJDGMJ() {
      return fGNPAGJDGMJ_;
    }

    public static final int ECNCAFKGHNJ_FIELD_NUMBER = 13;
    private int eCNCAFKGHNJ_;
    /**
     * <code>uint32 ECNCAFKGHNJ = 13;</code>
     * @return The eCNCAFKGHNJ.
     */
    @java.lang.Override
    public int getECNCAFKGHNJ() {
      return eCNCAFKGHNJ_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (fGNPAGJDGMJ_ != 0) {
        output.writeUInt32(1, fGNPAGJDGMJ_);
      }
      ...
      if (eCNCAFKGHNJ_ != 0) {
        output.writeUInt32(13, eCNCAFKGHNJ_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (fGNPAGJDGMJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, fGNPAGJDGMJ_);
      }
      if (killMonsterCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (eCNCAFKGHNJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, eCNCAFKGHNJ_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getFGNPAGJDGMJ()
          != other.getFGNPAGJDGMJ()) return false;
      if (getECNCAFKGHNJ()
          != other.getECNCAFKGHNJ()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + FGNPAGJDGMJ_FIELD_NUMBER;
      hash = (53 * hash) + getFGNPAGJDGMJ();
      hash = (37 * hash) + ECNCAFKGHNJ_FIELD_NUMBER;
      hash = (53 * hash) + getECNCAFKGHNJ();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo buildPartial() {
        ...
        result.fGNPAGJDGMJ_ = fGNPAGJDGMJ_;
        result.eCNCAFKGHNJ_ = eCNCAFKGHNJ_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo other) {
        ...
        if (other.getFGNPAGJDGMJ() != 0) {
          setFGNPAGJDGMJ(other.getFGNPAGJDGMJ());
        }
        if (other.getECNCAFKGHNJ() != 0) {
          setECNCAFKGHNJ(other.getECNCAFKGHNJ());
        }
      ...
      /**
       * <code>uint32 FGNPAGJDGMJ = 1;</code>
       * @param value The fGNPAGJDGMJ to set.
       * @return This builder for chaining.
       */
      public Builder setFGNPAGJDGMJ(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearFGNPAGJDGMJ() {
      ...
      /**
       * <code>uint32 ECNCAFKGHNJ = 13;</code>
       * @param value The eCNCAFKGHNJ to set.
       * @return This builder for chaining.
       */
      public Builder setECNCAFKGHNJ(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearECNCAFKGHNJ() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\001\n\036BuoyantCombatGallerySettleInfo\022\022\n\ngal" +
      "lery_id\030\006 \001(\r\022\023\n\013final_score\030\003 \001(\r\022\023\n\013FG" +
      "NPAGJDGMJ\030\001 \001(\r\022\023\n\013ECNCAFKGHNJ\030\r \001(\r\022\032\n\022" +
      "kill_monster_count\030\002 \001(\r\022\025\n\rgallery_leve" +
      "l\030\007 \001(\r\022\"\n\032kill_special_monster_count\030\010 " +
    ...
    internal_static_BuoyantCombatGallerySettleInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BuoyantCombatGallerySettleInfo_descriptor,
        new java.lang.String[] { "GalleryId", "FinalScore", "FGNPAGJDGMJ", "ECNCAFKGHNJ", "KillMonsterCount", "GalleryLevel", "KillSpecialMonsterCount", });
  }
