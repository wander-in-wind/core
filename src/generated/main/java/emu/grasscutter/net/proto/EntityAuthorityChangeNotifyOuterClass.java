...
public final class EntityAuthorityChangeNotifyOuterClass {
  ...
  public interface EntityAuthorityChangeNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .AuthorityChange authority_change_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AUTHORITY_CHANGE_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < authorityChangeList_.size(); i++) {
        output.writeMessage(6, authorityChangeList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < authorityChangeList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, authorityChangeList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ngeNotify\022/\n\025authority_change_list\030\006 \003(\013" +
