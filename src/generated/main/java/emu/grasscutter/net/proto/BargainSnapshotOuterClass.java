...
public final class BargainSnapshotOuterClass {
  ...
  public interface BargainSnapshotOrBuilder extends
    ...
    /**
     * <code>uint32 FBLDNHGMENF = 7;</code>
     * @return The fBLDNHGMENF.
     */
    int getFBLDNHGMENF();

    /**
     * <code>uint32 LJKDGKOHKPG = 15;</code>
     * @return The lJKDGKOHKPG.
     */
    int getLJKDGKOHKPG();

    /**
     * <code>int32 cur_mood = 2;</code>
     * @return The curMood.
     */
    int getCurMood();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int FBLDNHGMENF_FIELD_NUMBER = 7;
    private int fBLDNHGMENF_;
    /**
     * <code>uint32 FBLDNHGMENF = 7;</code>
     * @return The fBLDNHGMENF.
     */
    @java.lang.Override
    public int getFBLDNHGMENF() {
      return fBLDNHGMENF_;
    }

    public static final int LJKDGKOHKPG_FIELD_NUMBER = 15;
    private int lJKDGKOHKPG_;
    /**
     * <code>uint32 LJKDGKOHKPG = 15;</code>
     * @return The lJKDGKOHKPG.
     */
    @java.lang.Override
    public int getLJKDGKOHKPG() {
      return lJKDGKOHKPG_;
    }

    public static final int CUR_MOOD_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (curMood_ != 0) {
        output.writeInt32(2, curMood_);
      }
      if (fBLDNHGMENF_ != 0) {
        output.writeUInt32(7, fBLDNHGMENF_);
      }
      if (bargainId_ != 0) {
        output.writeUInt32(13, bargainId_);
      }
      if (lJKDGKOHKPG_ != 0) {
        output.writeUInt32(15, lJKDGKOHKPG_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (curMood_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(2, curMood_);
      }
      if (fBLDNHGMENF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, fBLDNHGMENF_);
      }
      if (bargainId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (lJKDGKOHKPG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, lJKDGKOHKPG_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getFBLDNHGMENF()
          != other.getFBLDNHGMENF()) return false;
      if (getLJKDGKOHKPG()
          != other.getLJKDGKOHKPG()) return false;
      if (getCurMood()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + FBLDNHGMENF_FIELD_NUMBER;
      hash = (53 * hash) + getFBLDNHGMENF();
      hash = (37 * hash) + LJKDGKOHKPG_FIELD_NUMBER;
      hash = (53 * hash) + getLJKDGKOHKPG();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.BargainSnapshotOuterClass.BargainSnapshot buildPartial() {
        ...
        result.fBLDNHGMENF_ = fBLDNHGMENF_;
        result.lJKDGKOHKPG_ = lJKDGKOHKPG_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BargainSnapshotOuterClass.BargainSnapshot other) {
        ...
        if (other.getFBLDNHGMENF() != 0) {
          setFBLDNHGMENF(other.getFBLDNHGMENF());
        }
        if (other.getLJKDGKOHKPG() != 0) {
          setLJKDGKOHKPG(other.getLJKDGKOHKPG());
        }
      ...
      /**
       * <code>uint32 FBLDNHGMENF = 7;</code>
       * @param value The fBLDNHGMENF to set.
       * @return This builder for chaining.
       */
      public Builder setFBLDNHGMENF(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearFBLDNHGMENF() {
      ...
      /**
       * <code>uint32 LJKDGKOHKPG = 15;</code>
       * @param value The lJKDGKOHKPG to set.
       * @return This builder for chaining.
       */
      public Builder setLJKDGKOHKPG(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLJKDGKOHKPG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ot\022\023\n\013FBLDNHGMENF\030\007 \001(\r\022\023\n\013LJKDGKOHKPG\030\017" +
      " \001(\r\022\020\n\010cur_mood\030\002 \001(\005\022\022\n\nbargain_id\030\r \001" +
    ...
    internal_static_BargainSnapshot_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BargainSnapshot_descriptor,
        new java.lang.String[] { "FBLDNHGMENF", "LJKDGKOHKPG", "CurMood", "BargainId", });
  }
