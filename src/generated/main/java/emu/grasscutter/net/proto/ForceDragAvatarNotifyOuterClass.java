...
public final class ForceDragAvatarNotifyOuterClass {
  ...
  public interface ForceDragAvatarNotifyOrBuilder extends
    ...
    /**
     * <code>bool is_first_valid = 4;</code>
     * @return The isFirstValid.
     */
    boolean getIsFirstValid();

    /**
     * <code>uint64 HBPMGOHDIOO = 8;</code>
     * @return The hBPMGOHDIOO.
     */
    long getHBPMGOHDIOO();
    ...
    /**
     * <code>uint64 HEDKENGIAPE = 5;</code>
     * @return The hEDKENGIAPE.
     */
    long getHEDKENGIAPE();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_FIRST_VALID_FIELD_NUMBER = 4;
    ...
    public static final int HBPMGOHDIOO_FIELD_NUMBER = 8;
    private long hBPMGOHDIOO_;
    /**
     * <code>uint64 HBPMGOHDIOO = 8;</code>
     * @return The hBPMGOHDIOO.
     */
    @java.lang.Override
    public long getHBPMGOHDIOO() {
      return hBPMGOHDIOO_;
    }
    ...
    public static final int HEDKENGIAPE_FIELD_NUMBER = 5;
    private long hEDKENGIAPE_;
    /**
     * <code>uint64 HEDKENGIAPE = 5;</code>
     * @return The hEDKENGIAPE.
     */
    @java.lang.Override
    public long getHEDKENGIAPE() {
      return hEDKENGIAPE_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isFirstValid_ != false) {
        output.writeBool(4, isFirstValid_);
      }
      if (hEDKENGIAPE_ != 0L) {
        output.writeUInt64(5, hEDKENGIAPE_);
      }
      if (motionInfo_ != null) {
      ...
      if (hBPMGOHDIOO_ != 0L) {
        output.writeUInt64(8, hBPMGOHDIOO_);
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (isFirstValid_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(4, isFirstValid_);
      }
      if (hEDKENGIAPE_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(5, hEDKENGIAPE_);
      }
      if (motionInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (hBPMGOHDIOO_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(8, hBPMGOHDIOO_);
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getHBPMGOHDIOO()
          != other.getHBPMGOHDIOO()) return false;
      if (getEntityId()
      ...
      if (getHEDKENGIAPE()
          != other.getHEDKENGIAPE()) return false;
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsFirstValid());
      hash = (37 * hash) + HBPMGOHDIOO_FIELD_NUMBER;
      ...
      hash = (37 * hash) + HEDKENGIAPE_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getHEDKENGIAPE());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ForceDragAvatarNotifyOuterClass.ForceDragAvatarNotify buildPartial() {
        ...
        result.hBPMGOHDIOO_ = hBPMGOHDIOO_;
        ...
        result.hEDKENGIAPE_ = hEDKENGIAPE_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ForceDragAvatarNotifyOuterClass.ForceDragAvatarNotify other) {
        ...
        if (other.getHBPMGOHDIOO() != 0L) {
          setHBPMGOHDIOO(other.getHBPMGOHDIOO());
        }
        ...
        if (other.getHEDKENGIAPE() != 0L) {
          setHEDKENGIAPE(other.getHEDKENGIAPE());
        }
      ...
      /**
       * <code>uint64 HBPMGOHDIOO = 8;</code>
       * @param value The hBPMGOHDIOO to set.
       * @return This builder for chaining.
       */
      public Builder setHBPMGOHDIOO(long value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHBPMGOHDIOO() {
      ...
      /**
       * <code>uint64 HEDKENGIAPE = 5;</code>
       * @param value The hEDKENGIAPE to set.
       * @return This builder for chaining.
       */
      public Builder setHEDKENGIAPE(long value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHEDKENGIAPE() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ne_time\030\007 \001(\r\022\026\n\016is_first_valid\030\004 \001(\010\022\023\n" +
      "\013HBPMGOHDIOO\030\010 \001(\004\022\021\n\tentity_id\030\t \001(\r\022 \n" +
      "\013motion_info\030\006 \001(\0132\013.MotionInfo\022\023\n\013HEDKE" +
      "NGIAPE\030\005 \001(\004B\033\n\031emu.grasscutter.net.prot" +
      "ob\006proto3"
    };
    ...
    internal_static_ForceDragAvatarNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ForceDragAvatarNotify_descriptor,
        new java.lang.String[] { "SceneTime", "IsFirstValid", "HBPMGOHDIOO", "EntityId", "MotionInfo", "HEDKENGIAPE", });
    emu.grasscutter.net.proto.MotionInfoOuterClass.getDescriptor();
  }
