...
public final class GCGInviteGuestBattleRspOuterClass {
  ...
  public interface GCGInviteGuestBattleRspOrBuilder extends
    ...
    /**
     * <code>uint32 LNNOPIDBJDH = 6;</code>
     * @return The lNNOPIDBJDH.
     */
    int getLNNOPIDBJDH();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LNNOPIDBJDH_FIELD_NUMBER = 6;
    private int lNNOPIDBJDH_;
    /**
     * <code>uint32 LNNOPIDBJDH = 6;</code>
     * @return The lNNOPIDBJDH.
     */
    @java.lang.Override
    public int getLNNOPIDBJDH() {
      return lNNOPIDBJDH_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lNNOPIDBJDH_ != 0) {
        output.writeUInt32(6, lNNOPIDBJDH_);
      }
      if (retcode_ != 0) {
        output.writeInt32(8, retcode_);
      }
      if (confirmEndTime_ != 0) {
        output.writeUInt32(13, confirmEndTime_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (lNNOPIDBJDH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, lNNOPIDBJDH_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (confirmEndTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, confirmEndTime_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getLNNOPIDBJDH()
          != other.getLNNOPIDBJDH()) return false;
      if (getRetcode()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + LNNOPIDBJDH_FIELD_NUMBER;
      hash = (53 * hash) + getLNNOPIDBJDH();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.GCGInviteGuestBattleRspOuterClass.GCGInviteGuestBattleRsp buildPartial() {
        ...
        result.lNNOPIDBJDH_ = lNNOPIDBJDH_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GCGInviteGuestBattleRspOuterClass.GCGInviteGuestBattleRsp other) {
        ...
        if (other.getLNNOPIDBJDH() != 0) {
          setLNNOPIDBJDH(other.getLNNOPIDBJDH());
        }
      ...
      /**
       * <code>uint32 LNNOPIDBJDH = 6;</code>
       * @param value The lNNOPIDBJDH to set.
       * @return This builder for chaining.
       */
      public Builder setLNNOPIDBJDH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLNNOPIDBJDH() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "h_end_time\030\001 \001(\r\022\023\n\013LNNOPIDBJDH\030\006 \001(\r\022\017\n" +
      "\007retcode\030\010 \001(\005\022\030\n\020confirm_end_time\030\r \001(\r" +
    ...
    internal_static_GCGInviteGuestBattleRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGInviteGuestBattleRsp_descriptor,
        new java.lang.String[] { "Uid", "PunishEndTime", "LNNOPIDBJDH", "Retcode", "ConfirmEndTime", });
  }
