...
public final class ElectroherculesBattleSettleNotifyOuterClass {
  ...
  public interface ElectroherculesBattleSettleNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 diffculty = 2;</code>
     * @return The diffculty.
     */
    int getDiffculty();

    /**
     * <code>bool LIEHECKPKDA = 6;</code>
     * @return The lIEHECKPKDA.
     */
    boolean getLIEHECKPKDA();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DIFFCULTY_FIELD_NUMBER = 2;
    ...
    public static final int LIEHECKPKDA_FIELD_NUMBER = 6;
    private boolean lIEHECKPKDA_;
    /**
     * <code>bool LIEHECKPKDA = 6;</code>
     * @return The lIEHECKPKDA.
     */
    @java.lang.Override
    public boolean getLIEHECKPKDA() {
      return lIEHECKPKDA_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (diffculty_ != 0) {
        output.writeUInt32(2, diffculty_);
      }
      if (stageId_ != 0) {
        output.writeUInt32(5, stageId_);
      }
      if (lIEHECKPKDA_ != false) {
        output.writeBool(6, lIEHECKPKDA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (diffculty_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, diffculty_);
      }
      if (stageId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (lIEHECKPKDA_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(6, lIEHECKPKDA_);
      }
      if (isNewRecord_ != false) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getLIEHECKPKDA()
          != other.getLIEHECKPKDA()) return false;
      if (getIsNewRecord()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + LIEHECKPKDA_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ElectroherculesBattleSettleNotifyOuterClass.ElectroherculesBattleSettleNotify buildPartial() {
        ...
        result.lIEHECKPKDA_ = lIEHECKPKDA_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ElectroherculesBattleSettleNotifyOuterClass.ElectroherculesBattleSettleNotify other) {
        ...
        if (other.getLIEHECKPKDA() != false) {
          setLIEHECKPKDA(other.getLIEHECKPKDA());
        }
      ...
      /**
       * <code>bool LIEHECKPKDA = 6;</code>
       * @param value The lIEHECKPKDA to set.
       * @return This builder for chaining.
       */
      public Builder setLIEHECKPKDA(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLIEHECKPKDA() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\021\n\tdiffculty\030\002 \001(\r\022\023\n\013LIEHECKPKDA\030\006 \001(\010\022" +
      "\025\n\ris_new_record\030\007 \001(\010\022\017\n\007is_succ\030\017 \001(\010\022" +
      "\023\n\013finish_time\030\010 \001(\r\022\020\n\010stage_id\030\005 \001(\r\022\022" +
    ...
    internal_static_ElectroherculesBattleSettleNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ElectroherculesBattleSettleNotify_descriptor,
        new java.lang.String[] { "Diffculty", "LIEHECKPKDA", "IsNewRecord", "IsSucc", "FinishTime", "StageId", "GalleryId", });
  }
