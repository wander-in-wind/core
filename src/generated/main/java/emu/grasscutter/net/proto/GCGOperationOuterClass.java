...
public final class GCGOperationOuterClass {
  ...
  public interface GCGOperationOrBuilder extends
    ...
    /**
     * <code>.GCGOperationRedraw op_redraw = 13;</code>
    ...
    /**
     * <code>.GCGOperationOnStageSelect op_select_on_stage = 5;</code>
    ...
    /**
     * <code>.GCGOperationReroll op_reroll = 7;</code>
    ...
    /**
     * <code>.GCGOperationPass op_pass = 14;</code>
    ...
    /**
     * <code>.GCGOperationReboot op_reboot = 10;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum OpCase
      ...
      public static OpCase forNumber(int value) {
        switch (value) {
          case 13: return OP_REDRAW;
          case 5: return OP_SELECT_ON_STAGE;
          case 7: return OP_REROLL;
          case 4: return OP_ATTACK;
          case 14: return OP_PASS;
          case 1: return OP_PLAY_CARD;
          case 10: return OP_REBOOT;
    ...
    public static final int OP_REDRAW_FIELD_NUMBER = 13;
    /**
     * <code>.GCGOperationRedraw op_redraw = 13;</code>
     * @return Whether the opRedraw field is set.
     */
    ...
    public static final int OP_SELECT_ON_STAGE_FIELD_NUMBER = 5;
    /**
     * <code>.GCGOperationOnStageSelect op_select_on_stage = 5;</code>
     * @return Whether the opSelectOnStage field is set.
     */
    ...
    public static final int OP_REROLL_FIELD_NUMBER = 7;
    /**
     * <code>.GCGOperationReroll op_reroll = 7;</code>
     * @return Whether the opReroll field is set.
     */
    ...
    public static final int OP_PASS_FIELD_NUMBER = 14;
    /**
     * <code>.GCGOperationPass op_pass = 14;</code>
     * @return Whether the opPass field is set.
     */
    ...
    public static final int OP_REBOOT_FIELD_NUMBER = 10;
    /**
     * <code>.GCGOperationReboot op_reboot = 10;</code>
     * @return Whether the opReboot field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (opCase_ == 5) {
        output.writeMessage(5, (emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect) op_);
      }
      if (opCase_ == 7) {
        output.writeMessage(7, (emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll) op_);
      }
      if (opCase_ == 9) {
        output.writeMessage(9, (emu.grasscutter.net.proto.GCGOperationSurrenderOuterClass.GCGOperationSurrender) op_);
      }
      if (opCase_ == 10) {
        output.writeMessage(10, (emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot) op_);
      }
      if (opCase_ == 13) {
        output.writeMessage(13, (emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw) op_);
      }
      if (opCase_ == 14) {
        output.writeMessage(14, (emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass) op_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (opCase_ == 5) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, (emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect) op_);
      }
      if (opCase_ == 7) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, (emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationReroll) op_);
      }
      if (opCase_ == 9) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (opCase_ == 10) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, (emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationReboot) op_);
      }
      if (opCase_ == 13) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, (emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedraw) op_);
      }
      if (opCase_ == 14) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, (emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPass) op_);
      }
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRedrawOuterClass.GCGOperationRedrawOrBuilder getOpRedrawOrBuilder() {
        if ((opCase_ == 13) && (opRedrawBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelectOrBuilder getOpSelectOnStageOrBuilder() {
        if ((opCase_ == 5) && (opSelectOnStageBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRerollOuterClass.GCGOperationRerollOrBuilder getOpRerollOrBuilder() {
        if ((opCase_ == 7) && (opRerollBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationPassOuterClass.GCGOperationPassOrBuilder getOpPassOrBuilder() {
        if ((opCase_ == 14) && (opPassBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GCGOperationRebootOuterClass.GCGOperationRebootOrBuilder getOpRebootOrBuilder() {
        if ((opCase_ == 10) && (opRebootBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\002\n\014GCGOperation\022(\n\top_redraw\030\r \001(\0132\023.GCG" +
      "OperationRedrawH\000\0228\n\022op_select_on_stage\030" +
      "\005 \001(\0132\032.GCGOperationOnStageSelectH\000\022(\n\to" +
      "p_reroll\030\007 \001(\0132\023.GCGOperationRerollH\000\022(\n" +
      "\top_attack\030\004 \001(\0132\023.GCGOperationAttackH\000\022" +
      "$\n\007op_pass\030\016 \001(\0132\021.GCGOperationPassH\000\022-\n" +
      "\014op_play_card\030\001 \001(\0132\025.GCGOperationPlayCa" +
      "rdH\000\022(\n\top_reboot\030\n \001(\0132\023.GCGOperationRe" +
