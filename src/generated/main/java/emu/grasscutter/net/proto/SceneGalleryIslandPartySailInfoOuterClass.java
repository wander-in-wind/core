...
public final class SceneGalleryIslandPartySailInfoOuterClass {
  ...
  public interface SceneGalleryIslandPartySailInfoOrBuilder extends
    ...
    /**
     * <code>uint32 BEBDPAPHFMM = 9;</code>
     * @return The bEBDPAPHFMM.
     */
    int getBEBDPAPHFMM();

    /**
     * <code>uint32 MEIDOEMPBOH = 3;</code>
     * @return The mEIDOEMPBOH.
     */
    int getMEIDOEMPBOH();
    ...
    /**
     * <code>uint32 FHFHIGBGEBG = 6;</code>
     * @return The fHFHIGBGEBG.
     */
    int getFHFHIGBGEBG();

    /**
     * <code>uint32 ABOELDEOICA = 2;</code>
     * @return The aBOELDEOICA.
     */
    int getABOELDEOICA();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              aBOELDEOICA_ = input.readUInt32();
              break;
            }
            case 24: {

              mEIDOEMPBOH_ = input.readUInt32();
              break;
            }
            case 48: {

              fHFHIGBGEBG_ = input.readUInt32();
              break;
            }
            case 72: {

              bEBDPAPHFMM_ = input.readUInt32();
              break;
            }
            case 88: {
              int rawValue = input.readEnum();
    ...
    public static final int BEBDPAPHFMM_FIELD_NUMBER = 9;
    private int bEBDPAPHFMM_;
    /**
     * <code>uint32 BEBDPAPHFMM = 9;</code>
     * @return The bEBDPAPHFMM.
     */
    @java.lang.Override
    public int getBEBDPAPHFMM() {
      return bEBDPAPHFMM_;
    }

    public static final int MEIDOEMPBOH_FIELD_NUMBER = 3;
    private int mEIDOEMPBOH_;
    /**
     * <code>uint32 MEIDOEMPBOH = 3;</code>
     * @return The mEIDOEMPBOH.
     */
    @java.lang.Override
    public int getMEIDOEMPBOH() {
      return mEIDOEMPBOH_;
    }
    ...
    public static final int FHFHIGBGEBG_FIELD_NUMBER = 6;
    private int fHFHIGBGEBG_;
    /**
     * <code>uint32 FHFHIGBGEBG = 6;</code>
     * @return The fHFHIGBGEBG.
     */
    @java.lang.Override
    public int getFHFHIGBGEBG() {
      return fHFHIGBGEBG_;
    }

    public static final int ABOELDEOICA_FIELD_NUMBER = 2;
    private int aBOELDEOICA_;
    /**
     * <code>uint32 ABOELDEOICA = 2;</code>
     * @return The aBOELDEOICA.
     */
    @java.lang.Override
    public int getABOELDEOICA() {
      return aBOELDEOICA_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (aBOELDEOICA_ != 0) {
        output.writeUInt32(2, aBOELDEOICA_);
      }
      if (mEIDOEMPBOH_ != 0) {
        output.writeUInt32(3, mEIDOEMPBOH_);
      }
      if (fHFHIGBGEBG_ != 0) {
        output.writeUInt32(6, fHFHIGBGEBG_);
      }
      if (bEBDPAPHFMM_ != 0) {
        output.writeUInt32(9, bEBDPAPHFMM_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (aBOELDEOICA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, aBOELDEOICA_);
      }
      if (mEIDOEMPBOH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, mEIDOEMPBOH_);
      }
      if (fHFHIGBGEBG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, fHFHIGBGEBG_);
      }
      if (bEBDPAPHFMM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, bEBDPAPHFMM_);
      }
      if (stage_ != emu.grasscutter.net.proto.IslandPartySailStageOuterClass.IslandPartySailStage.ISLAND_PARTY_SAIL_STAGE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getBEBDPAPHFMM()
          != other.getBEBDPAPHFMM()) return false;
      if (getMEIDOEMPBOH()
          != other.getMEIDOEMPBOH()) return false;
      if (stage_ != other.stage_) return false;
      if (getFHFHIGBGEBG()
          != other.getFHFHIGBGEBG()) return false;
      if (getABOELDEOICA()
          != other.getABOELDEOICA()) return false;
      if (getCoin()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + BEBDPAPHFMM_FIELD_NUMBER;
      hash = (53 * hash) + getBEBDPAPHFMM();
      hash = (37 * hash) + MEIDOEMPBOH_FIELD_NUMBER;
      hash = (53 * hash) + getMEIDOEMPBOH();
      hash = (37 * hash) + STAGE_FIELD_NUMBER;
      hash = (53 * hash) + stage_;
      hash = (37 * hash) + FHFHIGBGEBG_FIELD_NUMBER;
      hash = (53 * hash) + getFHFHIGBGEBG();
      hash = (37 * hash) + ABOELDEOICA_FIELD_NUMBER;
      hash = (53 * hash) + getABOELDEOICA();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass.SceneGalleryIslandPartySailInfo buildPartial() {
        ...
        result.bEBDPAPHFMM_ = bEBDPAPHFMM_;
        result.mEIDOEMPBOH_ = mEIDOEMPBOH_;
        result.stage_ = stage_;
        result.fHFHIGBGEBG_ = fHFHIGBGEBG_;
        result.aBOELDEOICA_ = aBOELDEOICA_;
        result.coin_ = coin_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SceneGalleryIslandPartySailInfoOuterClass.SceneGalleryIslandPartySailInfo other) {
        ...
        if (other.getBEBDPAPHFMM() != 0) {
          setBEBDPAPHFMM(other.getBEBDPAPHFMM());
        }
        if (other.getMEIDOEMPBOH() != 0) {
          setMEIDOEMPBOH(other.getMEIDOEMPBOH());
        }
        if (other.stage_ != 0) {
          setStageValue(other.getStageValue());
        }
        if (other.getFHFHIGBGEBG() != 0) {
          setFHFHIGBGEBG(other.getFHFHIGBGEBG());
        }
        if (other.getABOELDEOICA() != 0) {
          setABOELDEOICA(other.getABOELDEOICA());
        }
        if (other.getCoin() != 0) {
      ...
      /**
       * <code>uint32 BEBDPAPHFMM = 9;</code>
       * @param value The bEBDPAPHFMM to set.
       * @return This builder for chaining.
       */
      public Builder setBEBDPAPHFMM(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBEBDPAPHFMM() {
      ...
      /**
       * <code>uint32 MEIDOEMPBOH = 3;</code>
       * @param value The mEIDOEMPBOH to set.
       * @return This builder for chaining.
       */
      public Builder setMEIDOEMPBOH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMEIDOEMPBOH() {
      ...
      /**
       * <code>uint32 FHFHIGBGEBG = 6;</code>
       * @param value The fHFHIGBGEBG to set.
       * @return This builder for chaining.
       */
      public Builder setFHFHIGBGEBG(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearFHFHIGBGEBG() {
      ...
      /**
       * <code>uint32 ABOELDEOICA = 2;</code>
       * @param value The aBOELDEOICA to set.
       * @return This builder for chaining.
       */
      public Builder setABOELDEOICA(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearABOELDEOICA() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ySailInfo\022)\n\014start_source\030\001 \001(\0162\023.Galler" +
      "yStartSource\022\023\n\013BEBDPAPHFMM\030\t \001(\r\022\023\n\013MEI" +
      "DOEMPBOH\030\003 \001(\r\022$\n\005stage\030\013 \001(\0162\025.IslandPa" +
      "rtySailStage\022\023\n\013FHFHIGBGEBG\030\006 \001(\r\022\023\n\013ABO" +
      "ELDEOICA\030\002 \001(\r\022\014\n\004coin\030\014 \001(\rB\033\n\031emu.gras" +
    ...
    internal_static_SceneGalleryIslandPartySailInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneGalleryIslandPartySailInfo_descriptor,
        new java.lang.String[] { "StartSource", "BEBDPAPHFMM", "MEIDOEMPBOH", "Stage", "FHFHIGBGEBG", "ABOELDEOICA", "Coin", });
    emu.grasscutter.net.proto.GalleryStartSourceOuterClass.getDescriptor();
    emu.grasscutter.net.proto.IslandPartySailStageOuterClass.getDescriptor();
  }
