...
public final class AnchorPointDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (nextUsableTime_ != 0) {
        output.writeUInt32(1, nextUsableTime_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (nextUsableTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, nextUsableTime_);
      }
      for (int i = 0; i < anchorPointList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\021anchor_point_list\030\013 \003(\0132\020.AnchorPointDa" +
      "ta\022\030\n\020next_usable_time\030\001 \001(\rB\033\n\031emu.gras" +
