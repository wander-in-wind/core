...
public final class AbilityMixinBreakoutOuterClass {
  ...
  public interface AbilityMixinBreakoutOrBuilder extends
    ...
    /**
     * <code>.AbilityMixinBreakout.SyncType sync_type = 7;</code>
    ...
    /**
     * <code>.BreakoutSyncPing sync_ping = 6;</code>
    ...
    /**
     * <code>.BreakoutSyncSnapShot sync_snap_shot = 9;</code>
    ...
    /**
     * <code>.BreakoutSyncAction sync_action = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum SyncCase
      ...
      public static SyncCase forNumber(int value) {
        switch (value) {
          ...
          case 6: return SYNC_PING;
          case 1: return SYNC_FINISH_GAME;
          case 9: return SYNC_SNAP_SHOT;
          case 2: return SYNC_ACTION;
    ...
    public static final int SYNC_PING_FIELD_NUMBER = 6;
    /**
     * <code>.BreakoutSyncPing sync_ping = 6;</code>
     * @return Whether the syncPing field is set.
     */
    ...
    public static final int SYNC_SNAP_SHOT_FIELD_NUMBER = 9;
    /**
     * <code>.BreakoutSyncSnapShot sync_snap_shot = 9;</code>
     * @return Whether the syncSnapShot field is set.
     */
    ...
    public static final int SYNC_ACTION_FIELD_NUMBER = 2;
    /**
     * <code>.BreakoutSyncAction sync_action = 2;</code>
     * @return Whether the syncAction field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (syncCase_ == 2) {
        output.writeMessage(2, (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_);
      }
      if (syncCase_ == 3) {
        output.writeMessage(3, (emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect) sync_);
      }
      if (syncCase_ == 6) {
        output.writeMessage(6, (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing) sync_);
      }
      if (syncType_ != emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType.SYNC_TYPE_NONE.getNumber()) {
        output.writeEnum(7, syncType_);
      }
      if (syncCase_ == 9) {
        output.writeMessage(9, (emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot) sync_);
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (syncCase_ == 2) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_);
      }
      if (syncCase_ == 3) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, (emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect) sync_);
      }
      if (syncCase_ == 6) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing) sync_);
      }
      if (syncType_ != emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType.SYNC_TYPE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(7, syncType_);
      }
      if (syncCase_ == 9) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, (emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot) sync_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnectOrBuilder getSyncCreateConnectOrBuilder() {
        if ((syncCase_ == 3) && (syncCreateConnectBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPingOrBuilder getSyncPingOrBuilder() {
        if ((syncCase_ == 6) && (syncPingBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShotOrBuilder getSyncSnapShotOrBuilder() {
        if ((syncCase_ == 9) && (syncSnapShotBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncActionOrBuilder getSyncActionOrBuilder() {
        if ((syncCase_ == 2) && (syncActionBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tcode\030\r \001(\005\0221\n\tsync_type\030\007 \001(\0162\036.Ability" +
      "MixinBreakout.SyncType\0229\n\023sync_create_co" +
      "nnect\030\003 \001(\0132\032.BreakoutSyncCreateConnectH" +
      "\000\022&\n\tsync_ping\030\006 \001(\0132\021.BreakoutSyncPingH" +
      "\000\0223\n\020sync_finish_game\030\001 \001(\0132\027.BreakoutSy" +
      "ncFinishGameH\000\022/\n\016sync_snap_shot\030\t \001(\0132\025" +
      ".BreakoutSyncSnapShotH\000\022*\n\013sync_action\030\002" +
