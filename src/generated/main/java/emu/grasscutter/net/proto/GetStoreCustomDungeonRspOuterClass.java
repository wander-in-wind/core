...
public final class GetStoreCustomDungeonRspOuterClass {
  ...
  public interface GetStoreCustomDungeonRspOrBuilder extends
    ...
    /**
     * <code>repeated .OtherCustomDungeonBrief custom_dungeon_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CUSTOM_DUNGEON_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < customDungeonList_.size(); i++) {
        output.writeMessage(6, customDungeonList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < customDungeonList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, customDungeonList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "mDungeonRsp\0225\n\023custom_dungeon_list\030\006 \003(\013" +
