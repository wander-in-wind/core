...
public final class FungusDetailOuterClass {
  ...
  public interface FungusDetailOrBuilder extends
    ...
    /**
     * <code>uint32 capture_order = 6;</code>
     * @return The captureOrder.
     */
    int getCaptureOrder();
    ...
    /**
     * <code>uint32 min_cultivate_step = 1;</code>
     * @return The minCultivateStep.
     */
    int getMinCultivateStep();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              minCultivateStep_ = input.readUInt32();
              break;
            }
            case 40: {
            ...
            case 48: {
              ...
              captureOrder_ = input.readUInt32();
              break;
            }
            case 72: {
    ...
    public static final int CAPTURE_ORDER_FIELD_NUMBER = 6;
    private int captureOrder_;
    /**
     * <code>uint32 capture_order = 6;</code>
     * @return The captureOrder.
     */
    ...
    public static final int MIN_CULTIVATE_STEP_FIELD_NUMBER = 1;
    private int minCultivateStep_;
    /**
     * <code>uint32 min_cultivate_step = 1;</code>
     * @return The minCultivateStep.
     */
    @java.lang.Override
    public int getMinCultivateStep() {
      return minCultivateStep_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (minCultivateStep_ != 0) {
        output.writeUInt32(1, minCultivateStep_);
      }
      if (isCultivate_ != false) {
        output.writeBool(5, isCultivate_);
      }
      if (captureOrder_ != 0) {
        output.writeUInt32(6, captureOrder_);
      }
      if (fungusId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (minCultivateStep_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, minCultivateStep_);
      }
      if (isCultivate_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (captureOrder_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, captureOrder_);
      }
      if (fungusId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getCaptureOrder()
          != other.getCaptureOrder()) return false;
      if (getNameId()
          != other.getNameId()) return false;
      if (getMinCultivateStep()
          != other.getMinCultivateStep()) return false;
      if (getFungusId()
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsCultivate());
      hash = (37 * hash) + CAPTURE_ORDER_FIELD_NUMBER;
      hash = (53 * hash) + getCaptureOrder();
      hash = (37 * hash) + NAME_ID_FIELD_NUMBER;
      hash = (53 * hash) + getNameId();
      hash = (37 * hash) + MIN_CULTIVATE_STEP_FIELD_NUMBER;
      hash = (53 * hash) + getMinCultivateStep();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.FungusDetailOuterClass.FungusDetail buildPartial() {
        ...
        result.captureOrder_ = captureOrder_;
        result.nameId_ = nameId_;
        result.minCultivateStep_ = minCultivateStep_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FungusDetailOuterClass.FungusDetail other) {
        ...
        if (other.getCaptureOrder() != 0) {
          setCaptureOrder(other.getCaptureOrder());
        }
        if (other.getNameId() != 0) {
          setNameId(other.getNameId());
        }
        if (other.getMinCultivateStep() != 0) {
          setMinCultivateStep(other.getMinCultivateStep());
        }
      ...
      /**
       * <code>uint32 capture_order = 6;</code>
       * @param value The captureOrder to set.
       * @return This builder for chaining.
       */
      public Builder setCaptureOrder(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCaptureOrder() {
      ...
      /**
       * <code>uint32 min_cultivate_step = 1;</code>
       * @param value The minCultivateStep to set.
       * @return This builder for chaining.
       */
      public Builder setMinCultivateStep(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMinCultivateStep() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\022FungusDetail.proto\"{\n\014FungusDetail\022\024\n\014" +
      "is_cultivate\030\005 \001(\010\022\025\n\rcapture_order\030\006 \001(" +
      "\r\022\017\n\007name_id\030\016 \001(\r\022\032\n\022min_cultivate_step" +
    ...
    internal_static_FungusDetail_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FungusDetail_descriptor,
        new java.lang.String[] { "IsCultivate", "CaptureOrder", "NameId", "MinCultivateStep", "FungusId", });
  }
