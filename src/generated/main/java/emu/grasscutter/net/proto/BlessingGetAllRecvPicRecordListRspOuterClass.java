...
public final class BlessingGetAllRecvPicRecordListRspOuterClass {
  ...
  public interface BlessingGetAllRecvPicRecordListRspOrBuilder extends
    ...
    /**
     * <code>repeated .BlessingRecvPicRecord recv_pic_record_list = 14;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int RECV_PIC_RECORD_LIST_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < recvPicRecordList_.size(); i++) {
        output.writeMessage(14, recvPicRecordList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < recvPicRecordList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, recvPicRecordList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "c_record_list\030\016 \003(\0132\026.BlessingRecvPicRec" +
