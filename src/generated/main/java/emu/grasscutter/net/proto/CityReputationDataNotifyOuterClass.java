...
public final class CityReputationDataNotifyOuterClass {
  ...
  public interface CityReputationDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .CityReputationSimpleInfo simple_info_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SIMPLE_INFO_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < simpleInfoList_.size(); i++) {
        output.writeMessage(6, simpleInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < simpleInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, simpleInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "onDataNotify\0223\n\020simple_info_list\030\006 \003(\0132\031" +
