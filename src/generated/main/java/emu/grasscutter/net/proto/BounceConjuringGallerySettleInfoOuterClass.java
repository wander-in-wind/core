...
public final class BounceConjuringGallerySettleInfoOuterClass {
  ...
  public interface BounceConjuringGallerySettleInfoOrBuilder extends
    ...
    /**
     * <code>uint32 BIMOGNBEGNI = 15;</code>
     * @return The bIMOGNBEGNI.
     */
    int getBIMOGNBEGNI();

    /**
     * <code>uint32 GIMNNOIMHAN = 7;</code>
     * @return The gIMNNOIMHAN.
     */
    int getGIMNNOIMHAN();
    ...
    /**
     * <code>uint32 LLEPOGBFEMP = 6;</code>
     * @return The lLEPOGBFEMP.
     */
    int getLLEPOGBFEMP();

    /**
     * <code>uint32 CDKGPFEDKLO = 13;</code>
     * @return The cDKGPFEDKLO.
     */
    int getCDKGPFEDKLO();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 48: {
              ...
              lLEPOGBFEMP_ = input.readUInt32();
              break;
            }
            case 56: {

              gIMNNOIMHAN_ = input.readUInt32();
              break;
            }
            case 64: {
            ...
            case 104: {
              ...
              cDKGPFEDKLO_ = input.readUInt32();
              break;
            }
            case 120: {

              bIMOGNBEGNI_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int GADGET_COUNT_MAP_FIELD_NUMBER = 3;
    ...
    public static final int BIMOGNBEGNI_FIELD_NUMBER = 15;
    private int bIMOGNBEGNI_;
    /**
     * <code>uint32 BIMOGNBEGNI = 15;</code>
     * @return The bIMOGNBEGNI.
     */
    @java.lang.Override
    public int getBIMOGNBEGNI() {
      return bIMOGNBEGNI_;
    }

    public static final int GIMNNOIMHAN_FIELD_NUMBER = 7;
    private int gIMNNOIMHAN_;
    /**
     * <code>uint32 GIMNNOIMHAN = 7;</code>
     * @return The gIMNNOIMHAN.
     */
    @java.lang.Override
    public int getGIMNNOIMHAN() {
      return gIMNNOIMHAN_;
    }
    ...
    public static final int LLEPOGBFEMP_FIELD_NUMBER = 6;
    private int lLEPOGBFEMP_;
    /**
     * <code>uint32 LLEPOGBFEMP = 6;</code>
     * @return The lLEPOGBFEMP.
     */
    @java.lang.Override
    public int getLLEPOGBFEMP() {
      return lLEPOGBFEMP_;
    }

    public static final int CDKGPFEDKLO_FIELD_NUMBER = 13;
    private int cDKGPFEDKLO_;
    /**
     * <code>uint32 CDKGPFEDKLO = 13;</code>
     * @return The cDKGPFEDKLO.
     */
    @java.lang.Override
    public int getCDKGPFEDKLO() {
      return cDKGPFEDKLO_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lLEPOGBFEMP_ != 0) {
        output.writeUInt32(6, lLEPOGBFEMP_);
      }
      if (gIMNNOIMHAN_ != 0) {
        output.writeUInt32(7, gIMNNOIMHAN_);
      }
      if (score_ != 0) {
      ...
      if (cDKGPFEDKLO_ != 0) {
        output.writeUInt32(13, cDKGPFEDKLO_);
      }
      if (bIMOGNBEGNI_ != 0) {
        output.writeUInt32(15, bIMOGNBEGNI_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (lLEPOGBFEMP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, lLEPOGBFEMP_);
      }
      if (gIMNNOIMHAN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, gIMNNOIMHAN_);
      }
      if (score_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (cDKGPFEDKLO_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, cDKGPFEDKLO_);
      }
      if (bIMOGNBEGNI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, bIMOGNBEGNI_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getBIMOGNBEGNI()
          != other.getBIMOGNBEGNI()) return false;
      if (getGIMNNOIMHAN()
          != other.getGIMNNOIMHAN()) return false;
      if (getScore()
      ...
      if (getLLEPOGBFEMP()
          != other.getLLEPOGBFEMP()) return false;
      if (getCDKGPFEDKLO()
          != other.getCDKGPFEDKLO()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + BIMOGNBEGNI_FIELD_NUMBER;
      hash = (53 * hash) + getBIMOGNBEGNI();
      hash = (37 * hash) + GIMNNOIMHAN_FIELD_NUMBER;
      hash = (53 * hash) + getGIMNNOIMHAN();
      ...
      hash = (37 * hash) + LLEPOGBFEMP_FIELD_NUMBER;
      hash = (53 * hash) + getLLEPOGBFEMP();
      hash = (37 * hash) + CDKGPFEDKLO_FIELD_NUMBER;
      hash = (53 * hash) + getCDKGPFEDKLO();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.BounceConjuringGallerySettleInfoOuterClass.BounceConjuringGallerySettleInfo buildPartial() {
        ...
        result.bIMOGNBEGNI_ = bIMOGNBEGNI_;
        result.gIMNNOIMHAN_ = gIMNNOIMHAN_;
        ...
        result.lLEPOGBFEMP_ = lLEPOGBFEMP_;
        result.cDKGPFEDKLO_ = cDKGPFEDKLO_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BounceConjuringGallerySettleInfoOuterClass.BounceConjuringGallerySettleInfo other) {
        ...
        if (other.getBIMOGNBEGNI() != 0) {
          setBIMOGNBEGNI(other.getBIMOGNBEGNI());
        }
        if (other.getGIMNNOIMHAN() != 0) {
          setGIMNNOIMHAN(other.getGIMNNOIMHAN());
        }
        if (other.getScore() != 0) {
        ...
        if (other.getLLEPOGBFEMP() != 0) {
          setLLEPOGBFEMP(other.getLLEPOGBFEMP());
        }
        if (other.getCDKGPFEDKLO() != 0) {
          setCDKGPFEDKLO(other.getCDKGPFEDKLO());
        }
      ...
      /**
       * <code>uint32 BIMOGNBEGNI = 15;</code>
       * @param value The bIMOGNBEGNI to set.
       * @return This builder for chaining.
       */
      public Builder setBIMOGNBEGNI(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBIMOGNBEGNI() {
      ...
      /**
       * <code>uint32 GIMNNOIMHAN = 7;</code>
       * @param value The gIMNNOIMHAN to set.
       * @return This builder for chaining.
       */
      public Builder setGIMNNOIMHAN(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGIMNNOIMHAN() {
      ...
      /**
       * <code>uint32 LLEPOGBFEMP = 6;</code>
       * @param value The lLEPOGBFEMP to set.
       * @return This builder for chaining.
       */
      public Builder setLLEPOGBFEMP(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLLEPOGBFEMP() {
      ...
      /**
       * <code>uint32 CDKGPFEDKLO = 13;</code>
       * @param value The cDKGPFEDKLO to set.
       * @return This builder for chaining.
       */
      public Builder setCDKGPFEDKLO(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCDKGPFEDKLO() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "SettleInfo\022O\n\020gadget_count_map\030\003 \003(\01325.B" +
      "ounceConjuringGallerySettleInfo.GadgetCo" +
      "untMapEntry\022\023\n\013BIMOGNBEGNI\030\017 \001(\r\022\023\n\013GIMN" +
      "NOIMHAN\030\007 \001(\r\022\r\n\005score\030\010 \001(\r\022)\n\tcard_lis" +
      "t\030\005 \003(\0132\026.ExhibitionDisplayInfo\022\016\n\006damag" +
      "e\030\n \001(\002\022&\n\013player_info\030\001 \001(\0132\021.OnlinePla" +
      "yerInfo\022\023\n\013LLEPOGBFEMP\030\006 \001(\r\022\023\n\013CDKGPFED" +
      "KLO\030\r \001(\r\0325\n\023GadgetCountMapEntry\022\013\n\003key\030" +
    ...
    internal_static_BounceConjuringGallerySettleInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BounceConjuringGallerySettleInfo_descriptor,
        new java.lang.String[] { "GadgetCountMap", "BIMOGNBEGNI", "GIMNNOIMHAN", "Score", "CardList", "Damage", "PlayerInfo", "LLEPOGBFEMP", "CDKGPFEDKLO", });
    internal_static_BounceConjuringGallerySettleInfo_GadgetCountMapEntry_descriptor =
