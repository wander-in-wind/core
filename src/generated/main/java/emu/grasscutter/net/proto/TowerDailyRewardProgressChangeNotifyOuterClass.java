...
public final class TowerDailyRewardProgressChangeNotifyOuterClass {
  ...
  public interface TowerDailyRewardProgressChangeNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 NKMMGNAGOOA = 4;</code>
     * @return The nKMMGNAGOOA.
     */
    int getNKMMGNAGOOA();

    /**
     * <code>uint32 GMMJNDFMHAM = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int NKMMGNAGOOA_FIELD_NUMBER = 4;
    private int nKMMGNAGOOA_;
    /**
     * <code>uint32 NKMMGNAGOOA = 4;</code>
     * @return The nKMMGNAGOOA.
     */
    @java.lang.Override
    public int getNKMMGNAGOOA() {
      return nKMMGNAGOOA_;
    }

    public static final int GMMJNDFMHAM_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (gMMJNDFMHAM_ != 0) {
        output.writeUInt32(3, gMMJNDFMHAM_);
      }
      if (nKMMGNAGOOA_ != 0) {
        output.writeUInt32(4, nKMMGNAGOOA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (gMMJNDFMHAM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, gMMJNDFMHAM_);
      }
      if (nKMMGNAGOOA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, nKMMGNAGOOA_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNKMMGNAGOOA()
          != other.getNKMMGNAGOOA()) return false;
      if (getGMMJNDFMHAM()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NKMMGNAGOOA_FIELD_NUMBER;
      hash = (53 * hash) + getNKMMGNAGOOA();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.TowerDailyRewardProgressChangeNotifyOuterClass.TowerDailyRewardProgressChangeNotify buildPartial() {
        ...
        result.nKMMGNAGOOA_ = nKMMGNAGOOA_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.TowerDailyRewardProgressChangeNotifyOuterClass.TowerDailyRewardProgressChangeNotify other) {
        ...
        if (other.getNKMMGNAGOOA() != 0) {
          setNKMMGNAGOOA(other.getNKMMGNAGOOA());
        }
      ...
      /**
       * <code>uint32 NKMMGNAGOOA = 4;</code>
       * @param value The nKMMGNAGOOA to set.
       * @return This builder for chaining.
       */
      public Builder setNKMMGNAGOOA(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNKMMGNAGOOA() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tify\022\023\n\013NKMMGNAGOOA\030\004 \001(\r\022\023\n\013GMMJNDFMHAM" +
    ...
    internal_static_TowerDailyRewardProgressChangeNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TowerDailyRewardProgressChangeNotify_descriptor,
        new java.lang.String[] { "NKMMGNAGOOA", "GMMJNDFMHAM", });
  }
