...
public final class SpiceStageDataOuterClass {
  ...
  public interface SpiceStageDataOrBuilder extends
    ...
    /**
     * <code>uint32 success_times = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SUCCESS_TIMES_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (successTimes_ != 0) {
        output.writeUInt32(1, successTimes_);
      }
      if (stageId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (successTimes_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, successTimes_);
      }
      if (stageId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
