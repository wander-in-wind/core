...
public final class PSNBlackListNotifyOuterClass {
  ...
  public interface PSNBlackListNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .FriendBrief psn_blacklist = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PSN_BLACKLIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < psnBlacklist_.size(); i++) {
        output.writeMessage(4, psnBlacklist_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < psnBlacklist_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, psnBlacklist_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "list\030\004 \003(\0132\014.FriendBriefB\033\n\031emu.grasscut" +
