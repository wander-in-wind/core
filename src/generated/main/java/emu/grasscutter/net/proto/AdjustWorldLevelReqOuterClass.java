...
public final class AdjustWorldLevelReqOuterClass {
  ...
  public interface AdjustWorldLevelReqOrBuilder extends
    ...
    /**
     * <code>uint32 LJJOOOBJAKM = 13;</code>
     * @return The lJJOOOBJAKM.
     */
    int getLJJOOOBJAKM();

    /**
     * <code>uint32 GEIJKDPEJKG = 15;</code>
     * @return The gEIJKDPEJKG.
     */
    int getGEIJKDPEJKG();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 104: {
              ...
              lJJOOOBJAKM_ = input.readUInt32();
              break;
            }
            case 120: {

              gEIJKDPEJKG_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int LJJOOOBJAKM_FIELD_NUMBER = 13;
    private int lJJOOOBJAKM_;
    /**
     * <code>uint32 LJJOOOBJAKM = 13;</code>
     * @return The lJJOOOBJAKM.
     */
    @java.lang.Override
    public int getLJJOOOBJAKM() {
      return lJJOOOBJAKM_;
    }

    public static final int GEIJKDPEJKG_FIELD_NUMBER = 15;
    private int gEIJKDPEJKG_;
    /**
     * <code>uint32 GEIJKDPEJKG = 15;</code>
     * @return The gEIJKDPEJKG.
     */
    @java.lang.Override
    public int getGEIJKDPEJKG() {
      return gEIJKDPEJKG_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lJJOOOBJAKM_ != 0) {
        output.writeUInt32(13, lJJOOOBJAKM_);
      }
      if (gEIJKDPEJKG_ != 0) {
        output.writeUInt32(15, gEIJKDPEJKG_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (lJJOOOBJAKM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, lJJOOOBJAKM_);
      }
      if (gEIJKDPEJKG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, gEIJKDPEJKG_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getLJJOOOBJAKM()
          != other.getLJJOOOBJAKM()) return false;
      if (getGEIJKDPEJKG()
          != other.getGEIJKDPEJKG()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + LJJOOOBJAKM_FIELD_NUMBER;
      hash = (53 * hash) + getLJJOOOBJAKM();
      hash = (37 * hash) + GEIJKDPEJKG_FIELD_NUMBER;
      hash = (53 * hash) + getGEIJKDPEJKG();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.AdjustWorldLevelReqOuterClass.AdjustWorldLevelReq buildPartial() {
        ...
        result.lJJOOOBJAKM_ = lJJOOOBJAKM_;
        result.gEIJKDPEJKG_ = gEIJKDPEJKG_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AdjustWorldLevelReqOuterClass.AdjustWorldLevelReq other) {
        ...
        if (other.getLJJOOOBJAKM() != 0) {
          setLJJOOOBJAKM(other.getLJJOOOBJAKM());
        }
        if (other.getGEIJKDPEJKG() != 0) {
          setGEIJKDPEJKG(other.getGEIJKDPEJKG());
        }
      ...
      /**
       * <code>uint32 LJJOOOBJAKM = 13;</code>
       * @param value The lJJOOOBJAKM to set.
       * @return This builder for chaining.
       */
      public Builder setLJJOOOBJAKM(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLJJOOOBJAKM() {
      ...
      /**
       * <code>uint32 GEIJKDPEJKG = 15;</code>
       * @param value The gEIJKDPEJKG to set.
       * @return This builder for chaining.
       */
      public Builder setGEIJKDPEJKG(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGEIJKDPEJKG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ldLevelReq\022\023\n\013LJJOOOBJAKM\030\r \001(\r\022\023\n\013GEIJK" +
      "DPEJKG\030\017 \001(\rB\033\n\031emu.grasscutter.net.prot" +
      "ob\006proto3"
    };
    ...
    internal_static_AdjustWorldLevelReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AdjustWorldLevelReq_descriptor,
        new java.lang.String[] { "LJJOOOBJAKM", "GEIJKDPEJKG", });
  }
