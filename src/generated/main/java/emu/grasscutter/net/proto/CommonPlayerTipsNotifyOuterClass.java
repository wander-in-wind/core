...
public final class CommonPlayerTipsNotifyOuterClass {
  ...
  public interface CommonPlayerTipsNotifyOrBuilder extends
    ...
    /**
     * <code>repeated string text_map_id_list = 14;</code>
    ...
    /**
     * <code>uint32 notify_type = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int TEXT_MAP_ID_LIST_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (notifyType_ != 0) {
        output.writeUInt32(7, notifyType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (notifyType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, notifyType_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < textMapIdList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "PlayerTipsNotify\022\030\n\020text_map_id_list\030\016 \003" +
      "(\t\022\023\n\013notify_type\030\007 \001(\rB\033\n\031emu.grasscutt" +
