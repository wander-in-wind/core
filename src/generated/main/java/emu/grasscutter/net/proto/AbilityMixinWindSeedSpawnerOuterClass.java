...
public final class AbilityMixinWindSeedSpawnerOuterClass {
  ...
  public interface AbilityMixinWindSeedSpawnerOrBuilder extends
    ...
    /**
     * <code>.AbilityMixinWindSeedSpawner.AddSignal add_signal = 6;</code>
    ...
    /**
     * <code>.AbilityMixinWindSeedSpawner.RefreshSeed refresh_seed = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface RefreshSeedOrBuilder extends
      ...
      /**
       * <code>repeated .Vector pos_list = 8;</code>
       */
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final int POS_LIST_FIELD_NUMBER = 8;
    ...
    public enum CmdCase
      ...
      public static CmdCase forNumber(int value) {
        switch (value) {
          case 6: return ADD_SIGNAL;
          case 1: return REFRESH_SEED;
    ...
    public static final int ADD_SIGNAL_FIELD_NUMBER = 6;
    /**
     * <code>.AbilityMixinWindSeedSpawner.AddSignal add_signal = 6;</code>
     * @return Whether the addSignal field is set.
     */
    ...
    public static final int REFRESH_SEED_FIELD_NUMBER = 1;
    /**
     * <code>.AbilityMixinWindSeedSpawner.RefreshSeed refresh_seed = 1;</code>
     * @return Whether the refreshSeed field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (cmdCase_ == 1) {
        output.writeMessage(1, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeed) cmd_);
      }
      if (cmdCase_ == 4) {
      ...
      if (cmdCase_ == 6) {
        output.writeMessage(6, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignal) cmd_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (cmdCase_ == 1) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeed) cmd_);
      }
      if (cmdCase_ == 4) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (cmdCase_ == 6) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignal) cmd_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignalOrBuilder getAddSignalOrBuilder() {
        if ((cmdCase_ == 6) && (addSignalBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeedOrBuilder getRefreshSeedOrBuilder() {
        if ((cmdCase_ == 1) && (refreshSeedBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "r\022<\n\nadd_signal\030\006 \001(\0132&.AbilityMixinWind" +
      "SeedSpawner.AddSignalH\000\022@\n\014refresh_seed\030" +
      "\001 \001(\0132(.AbilityMixinWindSeedSpawner.Refr" +
      "eshSeedH\000\022<\n\ncatch_seed\030\004 \001(\0132&.AbilityM" +
      "ixinWindSeedSpawner.CatchSeedH\000\032\013\n\tAddSi" +
      "gnal\032(\n\013RefreshSeed\022\031\n\010pos_list\030\010 \003(\0132\007." +
      "Vector\032\036\n\tCatchSeed\022\021\n\tentity_id\030\016 \001(\rB\005" +
