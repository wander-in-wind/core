...
public final class AbilityMixinWindSeedSpawnerOuterClass {
  ...
  public interface AbilityMixinWindSeedSpawnerOrBuilder extends
    ...
    /**
     * <code>.AbilityMixinWindSeedSpawner.CatchSeed catch_seed = 11;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface RefreshSeedOrBuilder extends
      ...
      /**
       * <code>repeated .Vector pos_list = 6;</code>
       */
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final int POS_LIST_FIELD_NUMBER = 6;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        for (int i = 0; i < posList_.size(); i++) {
          output.writeMessage(6, posList_.get(i));
        }
        unknownFields.writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        for (int i = 0; i < posList_.size(); i++) {
          size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(6, posList_.get(i));
        }
        size += unknownFields.getSerializedSize();
        memoizedSize = size;
        return size;
    ...
    public static final int CATCH_SEED_FIELD_NUMBER = 11;
    /**
     * <code>.AbilityMixinWindSeedSpawner.CatchSeed catch_seed = 11;</code>
     * @return Whether the catchSeed field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (cmdCase_ == 11) {
        output.writeMessage(11, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeed) cmd_);
      }
      if (cmdCase_ == 15) {
        output.writeMessage(15, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeed) cmd_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (cmdCase_ == 11) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(11, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeed) cmd_);
      }
      if (cmdCase_ == 15) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(15, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeed) cmd_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeedOrBuilder getRefreshSeedOrBuilder() {
        if ((cmdCase_ == 15) && (refreshSeedBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeedOrBuilder getCatchSeedOrBuilder() {
        if ((cmdCase_ == 11) && (catchSeedBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\017 \001(\0132(.AbilityMixinWindSeedSpawner.Refr" +
      "eshSeedH\000\022<\n\ncatch_seed\030\013 \001(\0132&.AbilityM" +
      "ixinWindSeedSpawner.CatchSeedH\000\032\013\n\tAddSi" +
      "gnal\032(\n\013RefreshSeed\022\031\n\010pos_list\030\006 \003(\0132\007." +
      "Vector\032\036\n\tCatchSeed\022\021\n\tentity_id\030\010 \001(\rB\005" +
