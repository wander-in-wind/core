...
public final class AbilityMetaTriggerElementReactionOuterClass {
  ...
  public interface AbilityMetaTriggerElementReactionOrBuilder extends
    ...
    /**
     * <code>uint32 JNBEDFOKMPM = 9;</code>
     * @return The jNBEDFOKMPM.
     */
    int getJNBEDFOKMPM();

    /**
     * <code>int32 hit_index = 6;</code>
     * @return The hitIndex.
     */
    int getHitIndex();

    /**
     * <code>uint32 element_reaction_type = 3;</code>
     * @return The elementReactionType.
     */
    int getElementReactionType();

    /**
     * <code>uint32 trigger_entity_id = 4;</code>
     * @return The triggerEntityId.
     */
    int getTriggerEntityId();

    /**
     * <code>uint32 GFAPKLBLADP = 15;</code>
     * @return The gFAPKLBLADP.
     */
    int getGFAPKLBLADP();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 72: {
              ...
              jNBEDFOKMPM_ = input.readUInt32();
              break;
            }
            case 120: {

              gFAPKLBLADP_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int JNBEDFOKMPM_FIELD_NUMBER = 9;
    private int jNBEDFOKMPM_;
    /**
     * <code>uint32 JNBEDFOKMPM = 9;</code>
     * @return The jNBEDFOKMPM.
     */
    @java.lang.Override
    public int getJNBEDFOKMPM() {
      return jNBEDFOKMPM_;
    }

    public static final int HIT_INDEX_FIELD_NUMBER = 6;
    ...
    public static final int ELEMENT_REACTION_TYPE_FIELD_NUMBER = 3;
    ...
    public static final int TRIGGER_ENTITY_ID_FIELD_NUMBER = 4;
    ...
    public static final int GFAPKLBLADP_FIELD_NUMBER = 15;
    private int gFAPKLBLADP_;
    /**
     * <code>uint32 GFAPKLBLADP = 15;</code>
     * @return The gFAPKLBLADP.
     */
    @java.lang.Override
    public int getGFAPKLBLADP() {
      return gFAPKLBLADP_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (elementReactionType_ != 0) {
        output.writeUInt32(3, elementReactionType_);
      }
      if (triggerEntityId_ != 0) {
        output.writeUInt32(4, triggerEntityId_);
      }
      if (hitIndex_ != 0) {
        output.writeInt32(6, hitIndex_);
      }
      if (jNBEDFOKMPM_ != 0) {
        output.writeUInt32(9, jNBEDFOKMPM_);
      }
      if (gFAPKLBLADP_ != 0) {
        output.writeUInt32(15, gFAPKLBLADP_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (elementReactionType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, elementReactionType_);
      }
      if (triggerEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, triggerEntityId_);
      }
      if (hitIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(6, hitIndex_);
      }
      if (jNBEDFOKMPM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, jNBEDFOKMPM_);
      }
      if (gFAPKLBLADP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, gFAPKLBLADP_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getJNBEDFOKMPM()
          != other.getJNBEDFOKMPM()) return false;
      if (getHitIndex()
      ...
      if (getGFAPKLBLADP()
          != other.getGFAPKLBLADP()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + JNBEDFOKMPM_FIELD_NUMBER;
      hash = (53 * hash) + getJNBEDFOKMPM();
      ...
      hash = (37 * hash) + GFAPKLBLADP_FIELD_NUMBER;
      hash = (53 * hash) + getGFAPKLBLADP();
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AbilityMetaTriggerElementReactionOuterClass.AbilityMetaTriggerElementReaction other) {
        ...
        if (other.getJNBEDFOKMPM() != 0) {
          setJNBEDFOKMPM(other.getJNBEDFOKMPM());
        }
        ...
        if (other.getGFAPKLBLADP() != 0) {
          setGFAPKLBLADP(other.getGFAPKLBLADP());
        }
      ...
      /**
       * <code>uint32 JNBEDFOKMPM = 9;</code>
       * @param value The jNBEDFOKMPM to set.
       * @return This builder for chaining.
       */
      public Builder setJNBEDFOKMPM(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearJNBEDFOKMPM() {
      ...
      /**
       * <code>uint32 GFAPKLBLADP = 15;</code>
       * @param value The gFAPKLBLADP to set.
       * @return This builder for chaining.
       */
      public Builder setGFAPKLBLADP(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGFAPKLBLADP() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\023\n\013JNBEDFOKMPM\030\t \001(\r\022\021\n\thit_index\030\006 \001(\005\022" +
      "\035\n\025element_reaction_type\030\003 \001(\r\022\031\n\021trigge" +
      "r_entity_id\030\004 \001(\r\022\023\n\013GFAPKLBLADP\030\017 \001(\rB\033" +
    ...
    internal_static_AbilityMetaTriggerElementReaction_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityMetaTriggerElementReaction_descriptor,
        new java.lang.String[] { "JNBEDFOKMPM", "HitIndex", "ElementReactionType", "TriggerEntityId", "GFAPKLBLADP", });
  }
