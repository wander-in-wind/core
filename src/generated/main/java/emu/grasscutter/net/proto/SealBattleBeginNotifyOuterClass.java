...
public final class SealBattleBeginNotifyOuterClass {
  ...
  public interface SealBattleBeginNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 NILJHJLDIPH = 13;</code>
     * @return The nILJHJLDIPH.
     */
    int getNILJHJLDIPH();
    ...
    /**
     * <code>.SealBattleType battle_type = 9;</code>
    ...
    /**
     * <code>uint32 BLCDBPALGPL = 3;</code>
     * @return The bLCDBPALGPL.
     */
    int getBLCDBPALGPL();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int NILJHJLDIPH_FIELD_NUMBER = 13;
    private int nILJHJLDIPH_;
    /**
     * <code>uint32 NILJHJLDIPH = 13;</code>
     * @return The nILJHJLDIPH.
     */
    @java.lang.Override
    public int getNILJHJLDIPH() {
      return nILJHJLDIPH_;
    }
    ...
    public static final int BATTLE_TYPE_FIELD_NUMBER = 9;
    ...
    public static final int BLCDBPALGPL_FIELD_NUMBER = 3;
    private int bLCDBPALGPL_;
    /**
     * <code>uint32 BLCDBPALGPL = 3;</code>
     * @return The bLCDBPALGPL.
     */
    @java.lang.Override
    public int getBLCDBPALGPL() {
      return bLCDBPALGPL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (bLCDBPALGPL_ != 0) {
        output.writeUInt32(3, bLCDBPALGPL_);
      }
      ...
      if (nILJHJLDIPH_ != 0) {
        output.writeUInt32(13, nILJHJLDIPH_);
      }
      if (sealEntityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (bLCDBPALGPL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, bLCDBPALGPL_);
      }
      if (battleType_ != emu.grasscutter.net.proto.SealBattleTypeOuterClass.SealBattleType.SEAL_BATTLE_KEEP_ALIVE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (nILJHJLDIPH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, nILJHJLDIPH_);
      }
      if (sealEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NILJHJLDIPH_FIELD_NUMBER;
      hash = (53 * hash) + getNILJHJLDIPH();
      ...
      hash = (37 * hash) + BLCDBPALGPL_FIELD_NUMBER;
      hash = (53 * hash) + getBLCDBPALGPL();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SealBattleBeginNotifyOuterClass.SealBattleBeginNotify buildPartial() {
        ...
        result.nILJHJLDIPH_ = nILJHJLDIPH_;
        result.sealEntityId_ = sealEntityId_;
        result.battleType_ = battleType_;
        result.bLCDBPALGPL_ = bLCDBPALGPL_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SealBattleBeginNotifyOuterClass.SealBattleBeginNotify other) {
        ...
        if (other.getNILJHJLDIPH() != 0) {
          setNILJHJLDIPH(other.getNILJHJLDIPH());
        }
        ...
        if (other.getBLCDBPALGPL() != 0) {
          setBLCDBPALGPL(other.getBLCDBPALGPL());
        }
      ...
      /**
       * <code>uint32 NILJHJLDIPH = 13;</code>
       * @param value The nILJHJLDIPH to set.
       * @return This builder for chaining.
       */
      public Builder setNILJHJLDIPH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNILJHJLDIPH() {
      ...
      /**
       * <code>uint32 BLCDBPALGPL = 3;</code>
       * @param value The bLCDBPALGPL to set.
       * @return This builder for chaining.
       */
      public Builder setBLCDBPALGPL(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBLCDBPALGPL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "NILJHJLDIPH\030\r \001(\r\022\026\n\016seal_entity_id\030\017 \001(" +
      "\r\022$\n\013battle_type\030\t \001(\0162\017.SealBattleType\022" +
      "\023\n\013BLCDBPALGPL\030\003 \001(\rB\033\n\031emu.grasscutter." +
    ...
    internal_static_SealBattleBeginNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SealBattleBeginNotify_descriptor,
        new java.lang.String[] { "NILJHJLDIPH", "SealEntityId", "BattleType", "BLCDBPALGPL", });
    emu.grasscutter.net.proto.SealBattleTypeOuterClass.getDescriptor();
  }
