...
public final class OtherCustomDungeonBriefOuterClass {
  ...
  public interface OtherCustomDungeonBriefOrBuilder extends
    ...
    /**
     * <code>.CustomDungeonSocial social = 1;</code>
    ...
    /**
     * <code>.SocialDetail creator_detail = 3;</code>
    ...
    /**
     * <code>.CustomDungeonAbstract abstract = 7;</code>
    ...
    /**
     * <code>bool DODBAMEJAFH = 5;</code>
     * @return The dODBAMEJAFH.
     */
    boolean getDODBAMEJAFH();

    /**
     * <code>bool OBLLPOAMFKN = 4;</code>
     * @return The oBLLPOAMFKN.
     */
    boolean getOBLLPOAMFKN();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              oBLLPOAMFKN_ = input.readBool();
              break;
            }
            case 40: {

              dODBAMEJAFH_ = input.readBool();
              break;
            }
            case 48: {
    ...
    public static final int CREATOR_DETAIL_FIELD_NUMBER = 3;
    ...
    public static final int DODBAMEJAFH_FIELD_NUMBER = 5;
    private boolean dODBAMEJAFH_;
    /**
     * <code>bool DODBAMEJAFH = 5;</code>
     * @return The dODBAMEJAFH.
     */
    @java.lang.Override
    public boolean getDODBAMEJAFH() {
      return dODBAMEJAFH_;
    }

    public static final int OBLLPOAMFKN_FIELD_NUMBER = 4;
    private boolean oBLLPOAMFKN_;
    /**
     * <code>bool OBLLPOAMFKN = 4;</code>
     * @return The oBLLPOAMFKN.
     */
    @java.lang.Override
    public boolean getOBLLPOAMFKN() {
      return oBLLPOAMFKN_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (social_ != null) {
        output.writeMessage(1, getSocial());
      }
      if (dungeonId_ != 0) {
        output.writeUInt32(2, dungeonId_);
      }
      if (creatorDetail_ != null) {
        output.writeMessage(3, getCreatorDetail());
      }
      if (oBLLPOAMFKN_ != false) {
        output.writeBool(4, oBLLPOAMFKN_);
      }
      if (dODBAMEJAFH_ != false) {
        output.writeBool(5, dODBAMEJAFH_);
      }
      ...
      if (abstract_ != null) {
        output.writeMessage(7, getAbstract());
      }
      ...
      if (isPsnPlatform_ != false) {
        output.writeBool(12, isPsnPlatform_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (social_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getSocial());
      }
      if (dungeonId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (creatorDetail_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getCreatorDetail());
      }
      if (oBLLPOAMFKN_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(4, oBLLPOAMFKN_);
      }
      if (dODBAMEJAFH_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(5, dODBAMEJAFH_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < tagList_.size(); i++) {
      ...
      if (abstract_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, getAbstract());
      }
      if (battleMinCostTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isPsnPlatform_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(12, isPsnPlatform_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getDODBAMEJAFH()
          != other.getDODBAMEJAFH()) return false;
      if (getOBLLPOAMFKN()
          != other.getOBLLPOAMFKN()) return false;
      if (getDungeonGuid()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + DODBAMEJAFH_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getDODBAMEJAFH());
      hash = (37 * hash) + OBLLPOAMFKN_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getOBLLPOAMFKN());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief buildPartial() {
        ...
        result.dODBAMEJAFH_ = dODBAMEJAFH_;
        result.oBLLPOAMFKN_ = oBLLPOAMFKN_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief other) {
        ...
        if (other.getDODBAMEJAFH() != false) {
          setDODBAMEJAFH(other.getDODBAMEJAFH());
        }
        if (other.getOBLLPOAMFKN() != false) {
          setOBLLPOAMFKN(other.getOBLLPOAMFKN());
        }
      ...
      /**
       * <code>bool DODBAMEJAFH = 5;</code>
       * @param value The dODBAMEJAFH to set.
       * @return This builder for chaining.
       */
      public Builder setDODBAMEJAFH(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearDODBAMEJAFH() {
      ...
      /**
       * <code>bool OBLLPOAMFKN = 4;</code>
       * @param value The oBLLPOAMFKN to set.
       * @return This builder for chaining.
       */
      public Builder setOBLLPOAMFKN(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearOBLLPOAMFKN() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ief\022&\n\007setting\030\013 \001(\0132\025.CustomDungeonSett" +
      "ing\022$\n\006social\030\001 \001(\0132\024.CustomDungeonSocia" +
      "l\022%\n\016creator_detail\030\003 \001(\0132\r.SocialDetail" +
      "\022\034\n\024battle_min_cost_time\030\t \001(\r\022\020\n\010tag_li" +
      "st\030\006 \003(\r\022(\n\010abstract\030\007 \001(\0132\026.CustomDunge" +
      "onAbstract\022\023\n\013DODBAMEJAFH\030\005 \001(\010\022\023\n\013OBLLP" +
      "OAMFKN\030\004 \001(\010\022\024\n\014dungeon_guid\030\n \001(\004\022\022\n\ndu" +
      "ngeon_id\030\002 \001(\r\022\027\n\017is_psn_platform\030\014 \001(\010B" +
    ...
    internal_static_OtherCustomDungeonBrief_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_OtherCustomDungeonBrief_descriptor,
        new java.lang.String[] { "Setting", "Social", "CreatorDetail", "BattleMinCostTime", "TagList", "Abstract", "DODBAMEJAFH", "OBLLPOAMFKN", "DungeonGuid", "DungeonId", "IsPsnPlatform", });
    emu.grasscutter.net.proto.CustomDungeonAbstractOuterClass.getDescriptor();
    emu.grasscutter.net.proto.CustomDungeonSettingOuterClass.getDescriptor();
    emu.grasscutter.net.proto.CustomDungeonSocialOuterClass.getDescriptor();
    emu.grasscutter.net.proto.SocialDetailOuterClass.getDescriptor();
