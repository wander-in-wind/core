...
public final class VintageMarketStoreViewStrategyRspOuterClass {
  ...
  public interface VintageMarketStoreViewStrategyRspOrBuilder extends
    ...
    /**
     * <code>uint32 strategy_id = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (strategyId_ != 0) {
        output.writeUInt32(7, strategyId_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (strategyId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, strategyId_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < strategyList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\013strategy_id\030\007 \001(\r\022\017\n\007retcode\030\002 \001(\005\022\025\n\r" +
      "strategy_list\030\013 \003(\rB\033\n\031emu.grasscutter.n" +
      "et.protob\006proto3"
    };
