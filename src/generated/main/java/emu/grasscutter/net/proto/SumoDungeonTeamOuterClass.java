...
public final class SumoDungeonTeamOuterClass {
  ...
  public interface SumoDungeonTeamOrBuilder extends
    ...
    /**
     * <code>repeated .SumoDungeonAvatar dungeon_avatar_list = 8;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DUNGEON_AVATAR_LIST_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < dungeonAvatarList_.size(); i++) {
        output.writeMessage(8, dungeonAvatarList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < dungeonAvatarList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, dungeonAvatarList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "vatar_list\030\010 \003(\0132\022.SumoDungeonAvatarB\033\n\031" +
