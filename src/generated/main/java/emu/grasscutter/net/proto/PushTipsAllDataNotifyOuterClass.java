...
public final class PushTipsAllDataNotifyOuterClass {
  ...
  public interface PushTipsAllDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .PushTipsData push_tips_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PUSH_TIPS_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < pushTipsList_.size(); i++) {
        output.writeMessage(3, pushTipsList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < pushTipsList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, pushTipsList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "sh_tips_list\030\003 \003(\0132\r.PushTipsDataB\033\n\031emu" +
