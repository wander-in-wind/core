...
public final class BlessingGetFriendPicListRspOuterClass {
  ...
  public interface BlessingGetFriendPicListRspOrBuilder extends
    ...
    /**
     * <code>repeated .BlessingFriendPicData friend_pic_data_list = 5;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int FRIEND_PIC_DATA_LIST_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < friendPicDataList_.size(); i++) {
        output.writeMessage(5, friendPicDataList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < friendPicDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, friendPicDataList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\005 \003(\0132\026.BlessingFriendPicData\022\017\n\007retcode" +
