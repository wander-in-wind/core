...
public final class BrickBreakerSettleNotifyOuterClass {
  ...
  public interface BrickBreakerSettleNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .Uint32Pair update_skill_list = 9;</code>
     */
    ...
    /**
     * <code>.BrickBreakerSettleNotify.SettleReason reason = 11;</code>
    ...
    /**
     * <code>bool is_single_mode = 13;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int UPDATE_SKILL_LIST_FIELD_NUMBER = 9;
    ...
    public static final int IS_SINGLE_MODE_FIELD_NUMBER = 13;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < updateSkillList_.size(); i++) {
        output.writeMessage(9, updateSkillList_.get(i));
      }
      ...
      if (isSingleMode_ != false) {
        output.writeBool(13, isSingleMode_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < updateSkillList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, updateSkillList_.get(i));
      }
      if (reason_ != emu.grasscutter.net.proto.BrickBreakerSettleNotifyOuterClass.BrickBreakerSettleNotify.SettleReason.SETTLE_REASON_TIME_OUT.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isSingleMode_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(13, isSingleMode_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "&\n\021update_skill_list\030\t \003(\0132\013.Uint32Pair\022" +
      "\020\n\010level_id\030\010 \001(\r\022\022\n\nis_dungeon\030\001 \001(\010\022\025\n" +
      "\ris_new_record\030\005 \001(\010\022\014\n\004time\030\007 \001(\r\0226\n\006re" +
      "ason\030\013 \001(\0162&.BrickBreakerSettleNotify.Se" +
      "ttleReason\022\026\n\016is_single_mode\030\r \001(\010\022\r\n\005co" +
      "mbo\030\014 \001(\r\022\r\n\005score\030\006 \001(\r\022\022\n\ngallery_id\030\002" +
    ...
    internal_static_BrickBreakerSettleNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BrickBreakerSettleNotify_descriptor,
        new java.lang.String[] { "UpdateSkillList", "LevelId", "IsDungeon", "IsNewRecord", "Time", "Reason", "IsSingleMode", "Combo", "Score", "GalleryId", });
    emu.grasscutter.net.proto.Uint32PairOuterClass.getDescriptor();
  }
