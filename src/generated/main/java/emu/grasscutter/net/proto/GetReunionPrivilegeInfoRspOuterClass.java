...
public final class GetReunionPrivilegeInfoRspOuterClass {
  ...
  public interface GetReunionPrivilegeInfoRspOrBuilder extends
    ...
    /**
     * <code>.ReunionPrivilegeInfo privilege_info = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PRIVILEGE_INFO_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (privilegeInfo_ != null) {
        output.writeMessage(2, getPrivilegeInfo());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (privilegeInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, getPrivilegeInfo());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ilegeInfoRsp\022-\n\016privilege_info\030\002 \001(\0132\025.R" +
