...
public final class PlayerCompoundMaterialRspOuterClass {
  ...
  public interface PlayerCompoundMaterialRspOrBuilder extends
    ...
    /**
     * <code>.CompoundQueueData compound_queue_data = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int COMPOUND_QUEUE_DATA_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (compoundQueueData_ != null) {
        output.writeMessage(5, getCompoundQueueData());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (compoundQueueData_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, getCompoundQueueData());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rialRsp\022/\n\023compound_queue_data\030\005 \001(\0132\022.C" +
