...
public final class SceneGalleryInstableSprayBuffInfoOuterClass {
  ...
  public interface SceneGalleryInstableSprayBuffInfoOrBuilder extends
    ...
    /**
     * <code>uint64 JAADBLKABKF = 12;</code>
     * @return The jAADBLKABKF.
     */
    long getJAADBLKABKF();

    /**
     * <code>uint64 PEPAMAPELFG = 11;</code>
     * @return The pEPAMAPELFG.
     */
    long getPEPAMAPELFG();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 88: {
              ...
              pEPAMAPELFG_ = input.readUInt64();
              break;
            }
            case 96: {

              jAADBLKABKF_ = input.readUInt64();
              break;
            }
            case 112: {
    ...
    public static final int JAADBLKABKF_FIELD_NUMBER = 12;
    private long jAADBLKABKF_;
    /**
     * <code>uint64 JAADBLKABKF = 12;</code>
     * @return The jAADBLKABKF.
     */
    @java.lang.Override
    public long getJAADBLKABKF() {
      return jAADBLKABKF_;
    }

    public static final int PEPAMAPELFG_FIELD_NUMBER = 11;
    private long pEPAMAPELFG_;
    /**
     * <code>uint64 PEPAMAPELFG = 11;</code>
     * @return The pEPAMAPELFG.
     */
    @java.lang.Override
    public long getPEPAMAPELFG() {
      return pEPAMAPELFG_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (pEPAMAPELFG_ != 0L) {
        output.writeUInt64(11, pEPAMAPELFG_);
      }
      if (jAADBLKABKF_ != 0L) {
        output.writeUInt64(12, jAADBLKABKF_);
      }
      if (buffId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (pEPAMAPELFG_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(11, pEPAMAPELFG_);
      }
      if (jAADBLKABKF_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(12, jAADBLKABKF_);
      }
      if (buffId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getJAADBLKABKF()
          != other.getJAADBLKABKF()) return false;
      if (getPEPAMAPELFG()
          != other.getPEPAMAPELFG()) return false;
      if (getBuffId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + JAADBLKABKF_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getJAADBLKABKF());
      hash = (37 * hash) + PEPAMAPELFG_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getPEPAMAPELFG());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SceneGalleryInstableSprayBuffInfoOuterClass.SceneGalleryInstableSprayBuffInfo buildPartial() {
        ...
        result.jAADBLKABKF_ = jAADBLKABKF_;
        result.pEPAMAPELFG_ = pEPAMAPELFG_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SceneGalleryInstableSprayBuffInfoOuterClass.SceneGalleryInstableSprayBuffInfo other) {
        ...
        if (other.getJAADBLKABKF() != 0L) {
          setJAADBLKABKF(other.getJAADBLKABKF());
        }
        if (other.getPEPAMAPELFG() != 0L) {
          setPEPAMAPELFG(other.getPEPAMAPELFG());
        }
      ...
      /**
       * <code>uint64 JAADBLKABKF = 12;</code>
       * @param value The jAADBLKABKF to set.
       * @return This builder for chaining.
       */
      public Builder setJAADBLKABKF(long value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearJAADBLKABKF() {
      ...
      /**
       * <code>uint64 PEPAMAPELFG = 11;</code>
       * @param value The pEPAMAPELFG to set.
       * @return This builder for chaining.
       */
      public Builder setPEPAMAPELFG(long value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearPEPAMAPELFG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\013JAADBLKABKF\030\014 \001(\004\022\023\n\013PEPAMAPELFG\030\013 \001(\004" +
    ...
    internal_static_SceneGalleryInstableSprayBuffInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneGalleryInstableSprayBuffInfo_descriptor,
        new java.lang.String[] { "JAADBLKABKF", "PEPAMAPELFG", "BuffId", });
  }
