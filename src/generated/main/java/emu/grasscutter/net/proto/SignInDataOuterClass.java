...
public final class SignInDataOuterClass {
  ...
  public interface SignInDataOrBuilder extends
    ...
    /**
     * <code>repeated .ItemParam reward_item_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int REWARD_ITEM_LIST_FIELD_NUMBER = 2;
    ...
    public static final int DAY_COUNT_FIELD_NUMBER = 12;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < rewardItemList_.size(); i++) {
        output.writeMessage(2, rewardItemList_.get(i));
      }
      if (dayCount_ != 0) {
        output.writeUInt32(12, dayCount_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < rewardItemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, rewardItemList_.get(i));
      }
      if (dayCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, dayCount_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ignInData\022$\n\020reward_item_list\030\002 \003(\0132\n.It" +
      "emParam\022\021\n\tday_count\030\014 \001(\rB\033\n\031emu.grassc" +
