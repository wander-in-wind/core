...
public final class TowerMonthlyDetailOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (monthlyCombatRecord_ != null) {
        output.writeMessage(4, getMonthlyCombatRecord());
      }
      if (monthlyBrief_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (monthlyCombatRecord_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, getMonthlyCombatRecord());
      }
      if (monthlyBrief_ != null) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ef\030\016 \001(\0132\022.TowerMonthlyBrief\0228\n\025monthly_" +
      "combat_record\030\004 \001(\0132\031.TowerMonthlyCombat" +
