...
public final class AbilityMetaUpdateBaseReactionDamageOuterClass {
  ...
  public interface AbilityMetaUpdateBaseReactionDamageOrBuilder extends
    ...
    /**
     * <code>.AbilityString ability_name = 14;</code>
    ...
    /**
     * <code>uint32 source_caster_id = 8;</code>
     * @return The sourceCasterId.
     */
    int getSourceCasterId();

    /**
     * <code>uint32 reaction_type = 12;</code>
     * @return The reactionType.
     */
    int getReactionType();

    /**
     * <code>.AbilityString global_value_key = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ABILITY_NAME_FIELD_NUMBER = 14;
    ...
    public static final int SOURCE_CASTER_ID_FIELD_NUMBER = 8;
    ...
    public static final int REACTION_TYPE_FIELD_NUMBER = 12;
    ...
    public static final int GLOBAL_VALUE_KEY_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (globalValueKey_ != null) {
        output.writeMessage(6, getGlobalValueKey());
      }
      if (sourceCasterId_ != 0) {
        output.writeUInt32(8, sourceCasterId_);
      }
      if (reactionType_ != 0) {
        output.writeUInt32(12, reactionType_);
      }
      if (abilityName_ != null) {
        output.writeMessage(14, getAbilityName());
      }
    ...
    public int getSerializedSize() {
      ...
      if (globalValueKey_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, getGlobalValueKey());
      }
      if (sourceCasterId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, sourceCasterId_);
      }
      if (reactionType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, reactionType_);
      }
      if (abilityName_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, getAbilityName());
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\016 \001(\0132\016.AbilityString\022\030\n\020source_caster_" +
      "id\030\010 \001(\r\022\025\n\rreaction_type\030\014 \001(\r\022(\n\020globa" +
      "l_value_key\030\006 \001(\0132\016.AbilityStringB\033\n\031emu" +
    ...
    internal_static_AbilityMetaUpdateBaseReactionDamage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityMetaUpdateBaseReactionDamage_descriptor,
        new java.lang.String[] { "AbilityName", "SourceCasterId", "ReactionType", "GlobalValueKey", });
    emu.grasscutter.net.proto.AbilityStringOuterClass.getDescriptor();
  }
