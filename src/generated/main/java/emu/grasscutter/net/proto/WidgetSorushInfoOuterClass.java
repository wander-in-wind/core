...
public final class WidgetSorushInfoOuterClass {
  ...
  public interface WidgetSorushInfoOrBuilder extends
    ...
    /**
     * <code>bool DJHLJCJAIEG = 8;</code>
     * @return The dJHLJCJAIEG.
     */
    boolean getDJHLJCJAIEG();

    /**
     * <code>bool CPAPAEPOFOE = 4;</code>
     * @return The cPAPAEPOFOE.
     */
    boolean getCPAPAEPOFOE();

    /**
     * <code>bool KIKBFGKBJKP = 6;</code>
     * @return The kIKBFGKBJKP.
     */
    boolean getKIKBFGKBJKP();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              cPAPAEPOFOE_ = input.readBool();
              break;
            }
            case 48: {

              kIKBFGKBJKP_ = input.readBool();
              break;
            }
            case 58: {
    ...
    public static final int DJHLJCJAIEG_FIELD_NUMBER = 8;
    private boolean dJHLJCJAIEG_;
    /**
     * <code>bool DJHLJCJAIEG = 8;</code>
     * @return The dJHLJCJAIEG.
     */
    @java.lang.Override
    public boolean getDJHLJCJAIEG() {
      return dJHLJCJAIEG_;
    }

    public static final int CPAPAEPOFOE_FIELD_NUMBER = 4;
    private boolean cPAPAEPOFOE_;
    /**
     * <code>bool CPAPAEPOFOE = 4;</code>
     * @return The cPAPAEPOFOE.
     */
    @java.lang.Override
    public boolean getCPAPAEPOFOE() {
      return cPAPAEPOFOE_;
    }

    public static final int KIKBFGKBJKP_FIELD_NUMBER = 6;
    private boolean kIKBFGKBJKP_;
    /**
     * <code>bool KIKBFGKBJKP = 6;</code>
     * @return The kIKBFGKBJKP.
     */
    @java.lang.Override
    public boolean getKIKBFGKBJKP() {
      return kIKBFGKBJKP_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (cPAPAEPOFOE_ != false) {
        output.writeBool(4, cPAPAEPOFOE_);
      }
      if (kIKBFGKBJKP_ != false) {
        output.writeBool(6, kIKBFGKBJKP_);
      }
      if (pos_ != null) {
        output.writeMessage(7, getPos());
      }
      if (dJHLJCJAIEG_ != false) {
        output.writeBool(8, dJHLJCJAIEG_);
      }
      if (slot_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (cPAPAEPOFOE_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(4, cPAPAEPOFOE_);
      }
      if (kIKBFGKBJKP_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(6, kIKBFGKBJKP_);
      }
      if (pos_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (dJHLJCJAIEG_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(8, dJHLJCJAIEG_);
      }
      if (slot_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getDJHLJCJAIEG()
          != other.getDJHLJCJAIEG()) return false;
      if (getCPAPAEPOFOE()
          != other.getCPAPAEPOFOE()) return false;
      if (getKIKBFGKBJKP()
          != other.getKIKBFGKBJKP()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + DJHLJCJAIEG_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getDJHLJCJAIEG());
      hash = (37 * hash) + CPAPAEPOFOE_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getCPAPAEPOFOE());
      hash = (37 * hash) + KIKBFGKBJKP_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getKIKBFGKBJKP());
      if (hasRot()) {
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo buildPartial() {
        ...
        result.dJHLJCJAIEG_ = dJHLJCJAIEG_;
        result.cPAPAEPOFOE_ = cPAPAEPOFOE_;
        result.kIKBFGKBJKP_ = kIKBFGKBJKP_;
        if (rotBuilder_ == null) {
          result.rot_ = rot_;
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.WidgetSorushInfoOuterClass.WidgetSorushInfo other) {
        ...
        if (other.getDJHLJCJAIEG() != false) {
          setDJHLJCJAIEG(other.getDJHLJCJAIEG());
        }
        if (other.getCPAPAEPOFOE() != false) {
          setCPAPAEPOFOE(other.getCPAPAEPOFOE());
        }
        if (other.getKIKBFGKBJKP() != false) {
          setKIKBFGKBJKP(other.getKIKBFGKBJKP());
        }
        if (other.hasRot()) {
      ...
      /**
       * <code>bool DJHLJCJAIEG = 8;</code>
       * @param value The dJHLJCJAIEG to set.
       * @return This builder for chaining.
       */
      public Builder setDJHLJCJAIEG(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearDJHLJCJAIEG() {
      ...
      /**
       * <code>bool CPAPAEPOFOE = 4;</code>
       * @param value The cPAPAEPOFOE to set.
       * @return This builder for chaining.
       */
      public Builder setCPAPAEPOFOE(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCPAPAEPOFOE() {
      ...
      /**
       * <code>bool KIKBFGKBJKP = 6;</code>
       * @param value The kIKBFGKBJKP to set.
       * @return This builder for chaining.
       */
      public Builder setKIKBFGKBJKP(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearKIKBFGKBJKP() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\007 \001(\0132\007.Vector\022\023\n\013DJHLJCJAIEG\030\010 \001(\010\022\023\n\013" +
      "CPAPAEPOFOE\030\004 \001(\010\022\023\n\013KIKBFGKBJKP\030\006 \001(\010\022\024" +
    ...
    internal_static_WidgetSorushInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_WidgetSorushInfo_descriptor,
        new java.lang.String[] { "Slot", "Pos", "DJHLJCJAIEG", "CPAPAEPOFOE", "KIKBFGKBJKP", "Rot", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
