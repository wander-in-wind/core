...
public final class InBattleChessInfoOuterClass {
  ...
  public interface InBattleChessInfoOrBuilder extends
    ...
    /**
     * <code>repeated uint32 ban_card_tag_list = 12;</code>
    ...
    /**
     * <code>map&lt;uint32, .ChessPlayerInfo&gt; player_info_map = 13;</code>
     */
    ...
    /**
     * <code>uint32 excaped_monsters = 9;</code>
     * @return The excapedMonsters.
     */
    int getExcapedMonsters();

    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 2;</code>
     */
    ...
    /**
     * <code>uint32 MMLJDCLICFL = 15;</code>
     * @return The mMLJDCLICFL.
     */
    int getMMLJDCLICFL();

    /**
     * <code>uint32 NFNKKDHGPAN = 5;</code>
     * @return The nFNKKDHGPAN.
     */
    int getNFNKKDHGPAN();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BAN_CARD_TAG_LIST_FIELD_NUMBER = 12;
    ...
    public static final int PLAYER_INFO_MAP_FIELD_NUMBER = 13;
    ...
    public static final int EXCAPED_MONSTERS_FIELD_NUMBER = 9;
    ...
    public static final int SELECTED_CARD_INFO_LIST_FIELD_NUMBER = 2;
    ...
    public static final int MMLJDCLICFL_FIELD_NUMBER = 15;
    ...
    public static final int NFNKKDHGPAN_FIELD_NUMBER = 5;
    private int nFNKKDHGPAN_;
    /**
     * <code>uint32 NFNKKDHGPAN = 5;</code>
     * @return The nFNKKDHGPAN.
     */
    @java.lang.Override
    public int getNFNKKDHGPAN() {
      return nFNKKDHGPAN_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < selectedCardInfoList_.size(); i++) {
        output.writeMessage(2, selectedCardInfoList_.get(i));
      }
      if (mysteryInfo_ != null) {
        output.writeMessage(3, getMysteryInfo());
      }
      if (nFNKKDHGPAN_ != 0) {
        output.writeUInt32(5, nFNKKDHGPAN_);
      }
      if (leftMonsters_ != 0) {
        output.writeUInt32(7, leftMonsters_);
      }
      if (excapedMonsters_ != 0) {
        output.writeUInt32(9, excapedMonsters_);
      }
      if (round_ != 0) {
      ...
      com.google.protobuf.GeneratedMessageV3
        .serializeIntegerMapTo(
          ...
          13);
      if (mMLJDCLICFL_ != 0) {
        output.writeUInt32(15, mMLJDCLICFL_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < selectedCardInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, selectedCardInfoList_.get(i));
      }
      if (mysteryInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (nFNKKDHGPAN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, nFNKKDHGPAN_);
      }
      if (leftMonsters_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (excapedMonsters_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, excapedMonsters_);
      }
      if (round_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo> entry
        ...
        playerInfoMap__ = PlayerInfoMapDefaultEntryHolder.defaultEntry.newBuilderForType()
            ...
            .build();
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(13, playerInfoMap__);
      }
      if (mMLJDCLICFL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, mMLJDCLICFL_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNFNKKDHGPAN()
          != other.getNFNKKDHGPAN()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NFNKKDHGPAN_FIELD_NUMBER;
      hash = (53 * hash) + getNFNKKDHGPAN();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo buildPartial() {
        ...
        result.nFNKKDHGPAN_ = nFNKKDHGPAN_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.InBattleChessInfoOuterClass.InBattleChessInfo other) {
        ...
        if (other.getNFNKKDHGPAN() != 0) {
          setNFNKKDHGPAN(other.getNFNKKDHGPAN());
        }
      ...
      /**
       * <code>uint32 NFNKKDHGPAN = 5;</code>
       * @param value The nFNKKDHGPAN to set.
       * @return This builder for chaining.
       */
      public Builder setNFNKKDHGPAN(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNFNKKDHGPAN() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ystery_info\030\003 \001(\0132\021.ChessMysteryInfo\022\r\n\005" +
      "round\030\n \001(\r\022\031\n\021ban_card_tag_list\030\014 \003(\r\022\025" +
      "\n\rleft_monsters\030\007 \001(\r\022>\n\017player_info_map" +
      "\030\r \003(\0132%.InBattleChessInfo.PlayerInfoMap" +
      "Entry\022\030\n\020excaped_monsters\030\t \001(\r\022/\n\027selec" +
      "ted_card_info_list\030\002 \003(\0132\016.ChessCardInfo" +
      "\022\023\n\013MMLJDCLICFL\030\017 \001(\r\022\023\n\013NFNKKDHGPAN\030\005 \001" +
    ...
    internal_static_InBattleChessInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_InBattleChessInfo_descriptor,
        new java.lang.String[] { "MysteryInfo", "Round", "BanCardTagList", "LeftMonsters", "PlayerInfoMap", "ExcapedMonsters", "SelectedCardInfoList", "MMLJDCLICFL", "NFNKKDHGPAN", });
    internal_static_InBattleChessInfo_PlayerInfoMapEntry_descriptor =
