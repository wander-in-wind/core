...
public final class CreateMassiveEntityReqOuterClass {
  ...
  public interface CreateMassiveEntityReqOrBuilder extends
    ...
    /**
     * <code>repeated .ClientMassiveEntity massive_entity_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MASSIVE_ENTITY_LIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < massiveEntityList_.size(); i++) {
        output.writeMessage(2, massiveEntityList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < massiveEntityList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, massiveEntityList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Req\0221\n\023massive_entity_list\030\002 \003(\0132\024.Clien" +
