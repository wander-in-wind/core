...
public final class InstableSprayLevelFinishNotifyOuterClass {
  ...
  public interface InstableSprayLevelFinishNotifyOrBuilder extends
    ...
    /**
     * <code>bool KHKAMOPPEBE = 10;</code>
     * @return The kHKAMOPPEBE.
     */
    boolean getKHKAMOPPEBE();
    ...
    /**
     * <code>bool BMHBNKGBKEK = 12;</code>
     * @return The bMHBNKGBKEK.
     */
    boolean getBMHBNKGBKEK();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 80: {
              ...
              kHKAMOPPEBE_ = input.readBool();
              break;
            }
            case 96: {

              bMHBNKGBKEK_ = input.readBool();
              break;
            }
            case 104: {
    ...
    public static final int KHKAMOPPEBE_FIELD_NUMBER = 10;
    private boolean kHKAMOPPEBE_;
    /**
     * <code>bool KHKAMOPPEBE = 10;</code>
     * @return The kHKAMOPPEBE.
     */
    @java.lang.Override
    public boolean getKHKAMOPPEBE() {
      return kHKAMOPPEBE_;
    }
    ...
    public static final int BMHBNKGBKEK_FIELD_NUMBER = 12;
    private boolean bMHBNKGBKEK_;
    /**
     * <code>bool BMHBNKGBKEK = 12;</code>
     * @return The bMHBNKGBKEK.
     */
    @java.lang.Override
    public boolean getBMHBNKGBKEK() {
      return bMHBNKGBKEK_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (kHKAMOPPEBE_ != false) {
        output.writeBool(10, kHKAMOPPEBE_);
      }
      if (bMHBNKGBKEK_ != false) {
        output.writeBool(12, bMHBNKGBKEK_);
      }
      if (difficulty_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (kHKAMOPPEBE_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(10, kHKAMOPPEBE_);
      }
      if (bMHBNKGBKEK_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(12, bMHBNKGBKEK_);
      }
      if (difficulty_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getKHKAMOPPEBE()
          != other.getKHKAMOPPEBE()) return false;
      if (!getScoreListList()
          .equals(other.getScoreListList())) return false;
      if (getBMHBNKGBKEK()
          != other.getBMHBNKGBKEK()) return false;
      if (getStageId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + KHKAMOPPEBE_FIELD_NUMBER;
      ...
      hash = (37 * hash) + BMHBNKGBKEK_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getBMHBNKGBKEK());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify buildPartial() {
        ...
        result.kHKAMOPPEBE_ = kHKAMOPPEBE_;
        if (((bitField0_ & 0x00000001) != 0)) {
          scoreList_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000001);
        }
        result.scoreList_ = scoreList_;
        result.bMHBNKGBKEK_ = bMHBNKGBKEK_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify other) {
        ...
        if (other.getKHKAMOPPEBE() != false) {
          setKHKAMOPPEBE(other.getKHKAMOPPEBE());
        }
        ...
        if (other.getBMHBNKGBKEK() != false) {
          setBMHBNKGBKEK(other.getBMHBNKGBKEK());
        }
      ...
      /**
       * <code>bool KHKAMOPPEBE = 10;</code>
       * @param value The kHKAMOPPEBE to set.
       * @return This builder for chaining.
       */
      public Builder setKHKAMOPPEBE(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearKHKAMOPPEBE() {
      ...
      /**
       * <code>bool BMHBNKGBKEK = 12;</code>
       * @param value The bMHBNKGBKEK to set.
       * @return This builder for chaining.
       */
      public Builder setBMHBNKGBKEK(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBMHBNKGBKEK() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nd\030\017 \001(\r\022\022\n\ndifficulty\030\r \001(\r\022\023\n\013KHKAMOPP" +
      "EBE\030\n \001(\010\022\022\n\nscore_list\030\004 \003(\r\022\023\n\013BMHBNKG" +
      "BKEK\030\014 \001(\010\022\020\n\010stage_id\030\016 \001(\r\022\020\n\010level_id" +
    ...
    internal_static_InstableSprayLevelFinishNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_InstableSprayLevelFinishNotify_descriptor,
        new java.lang.String[] { "Round", "Difficulty", "KHKAMOPPEBE", "ScoreList", "BMHBNKGBKEK", "StageId", "LevelId", });
  }
