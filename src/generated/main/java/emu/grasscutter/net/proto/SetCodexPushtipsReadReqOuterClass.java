...
public final class SetCodexPushtipsReadReqOuterClass {
  ...
  public interface SetCodexPushtipsReadReqOrBuilder extends
    ...
    /**
     * <code>uint32 NACFJFLGNFH = 8;</code>
     * @return The nACFJFLGNFH.
     */
    int getNACFJFLGNFH();

    /**
     * <code>uint32 AOLDDCCIAHH = 15;</code>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 64: {
              ...
              nACFJFLGNFH_ = input.readUInt32();
              break;
            }
            case 120: {

              aOLDDCCIAHH_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int NACFJFLGNFH_FIELD_NUMBER = 8;
    private int nACFJFLGNFH_;
    /**
     * <code>uint32 NACFJFLGNFH = 8;</code>
     * @return The nACFJFLGNFH.
     */
    @java.lang.Override
    public int getNACFJFLGNFH() {
      return nACFJFLGNFH_;
    }

    public static final int AOLDDCCIAHH_FIELD_NUMBER = 15;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (nACFJFLGNFH_ != 0) {
        output.writeUInt32(8, nACFJFLGNFH_);
      }
      if (aOLDDCCIAHH_ != 0) {
        output.writeUInt32(15, aOLDDCCIAHH_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (nACFJFLGNFH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, nACFJFLGNFH_);
      }
      if (aOLDDCCIAHH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, aOLDDCCIAHH_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNACFJFLGNFH()
          != other.getNACFJFLGNFH()) return false;
      if (getAOLDDCCIAHH()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NACFJFLGNFH_FIELD_NUMBER;
      hash = (53 * hash) + getNACFJFLGNFH();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SetCodexPushtipsReadReqOuterClass.SetCodexPushtipsReadReq buildPartial() {
        ...
        result.nACFJFLGNFH_ = nACFJFLGNFH_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SetCodexPushtipsReadReqOuterClass.SetCodexPushtipsReadReq other) {
        ...
        if (other.getNACFJFLGNFH() != 0) {
          setNACFJFLGNFH(other.getNACFJFLGNFH());
        }
      ...
      /**
       * <code>uint32 NACFJFLGNFH = 8;</code>
       * @param value The nACFJFLGNFH to set.
       * @return This builder for chaining.
       */
      public Builder setNACFJFLGNFH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNACFJFLGNFH() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "dexPushtipsReadReq\022\023\n\013NACFJFLGNFH\030\010 \001(\r\022" +
      "\023\n\013AOLDDCCIAHH\030\017 \001(\rB\033\n\031emu.grasscutter." +
    ...
    internal_static_SetCodexPushtipsReadReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SetCodexPushtipsReadReq_descriptor,
        new java.lang.String[] { "NACFJFLGNFH", "AOLDDCCIAHH", });
  }
