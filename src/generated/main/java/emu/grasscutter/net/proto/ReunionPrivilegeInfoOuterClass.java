...
public final class ReunionPrivilegeInfoOuterClass {
  ...
  public interface ReunionPrivilegeInfoOrBuilder extends
    ...
    /**
     * <code>uint32 JHDBADNLDEJ = 5;</code>
     * @return The jHDBADNLDEJ.
     */
    int getJHDBADNLDEJ();

    /**
     * <code>uint32 BPDNAIHEOHE = 13;</code>
     * @return The bPDNAIHEOHE.
     */
    int getBPDNAIHEOHE();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              jHDBADNLDEJ_ = input.readUInt32();
              break;
            }
            case 104: {

              bPDNAIHEOHE_ = input.readUInt32();
              break;
            }
            case 112: {
    ...
    public static final int JHDBADNLDEJ_FIELD_NUMBER = 5;
    private int jHDBADNLDEJ_;
    /**
     * <code>uint32 JHDBADNLDEJ = 5;</code>
     * @return The jHDBADNLDEJ.
     */
    @java.lang.Override
    public int getJHDBADNLDEJ() {
      return jHDBADNLDEJ_;
    }

    public static final int BPDNAIHEOHE_FIELD_NUMBER = 13;
    private int bPDNAIHEOHE_;
    /**
     * <code>uint32 BPDNAIHEOHE = 13;</code>
     * @return The bPDNAIHEOHE.
     */
    @java.lang.Override
    public int getBPDNAIHEOHE() {
      return bPDNAIHEOHE_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (jHDBADNLDEJ_ != 0) {
        output.writeUInt32(5, jHDBADNLDEJ_);
      }
      if (bPDNAIHEOHE_ != 0) {
        output.writeUInt32(13, bPDNAIHEOHE_);
      }
      if (privilegeId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (jHDBADNLDEJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, jHDBADNLDEJ_);
      }
      if (bPDNAIHEOHE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, bPDNAIHEOHE_);
      }
      if (privilegeId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getJHDBADNLDEJ()
          != other.getJHDBADNLDEJ()) return false;
      if (getBPDNAIHEOHE()
          != other.getBPDNAIHEOHE()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + JHDBADNLDEJ_FIELD_NUMBER;
      hash = (53 * hash) + getJHDBADNLDEJ();
      hash = (37 * hash) + BPDNAIHEOHE_FIELD_NUMBER;
      hash = (53 * hash) + getBPDNAIHEOHE();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo buildPartial() {
        ...
        result.jHDBADNLDEJ_ = jHDBADNLDEJ_;
        result.bPDNAIHEOHE_ = bPDNAIHEOHE_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo other) {
        ...
        if (other.getJHDBADNLDEJ() != 0) {
          setJHDBADNLDEJ(other.getJHDBADNLDEJ());
        }
        if (other.getBPDNAIHEOHE() != 0) {
          setBPDNAIHEOHE(other.getBPDNAIHEOHE());
        }
      ...
      /**
       * <code>uint32 JHDBADNLDEJ = 5;</code>
       * @param value The jHDBADNLDEJ to set.
       * @return This builder for chaining.
       */
      public Builder setJHDBADNLDEJ(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearJHDBADNLDEJ() {
      ...
      /**
       * <code>uint32 BPDNAIHEOHE = 13;</code>
       * @param value The bPDNAIHEOHE to set.
       * @return This builder for chaining.
       */
      public Builder setBPDNAIHEOHE(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBPDNAIHEOHE() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "DBADNLDEJ\030\005 \001(\r\022\023\n\013BPDNAIHEOHE\030\r \001(\rB\033\n\031" +
    ...
    internal_static_ReunionPrivilegeInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ReunionPrivilegeInfo_descriptor,
        new java.lang.String[] { "PrivilegeId", "JHDBADNLDEJ", "BPDNAIHEOHE", });
  }
