...
public final class GCGMatchInfoOuterClass {
  ...
  public interface GCGMatchInfoOrBuilder extends
    ...
    /**
     * <code>repeated .MatchPlayerInfo player_list = 14;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PLAYER_LIST_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < playerList_.size(); i++) {
        output.writeMessage(14, playerList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < playerList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, playerList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "oto\"5\n\014GCGMatchInfo\022%\n\013player_list\030\016 \003(\013" +
