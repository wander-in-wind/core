...
public final class FishCastRodReqOuterClass {
  ...
  public interface FishCastRodReqOrBuilder extends
    ...
    /**
     * <code>uint32 AEINBNLNPJH = 11;</code>
     * @return The aEINBNLNPJH.
     */
    int getAEINBNLNPJH();

    /**
     * <code>uint32 JDNBDNLCCHN = 2;</code>
     * @return The jDNBDNLCCHN.
     */
    int getJDNBDNLCCHN();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AEINBNLNPJH_FIELD_NUMBER = 11;
    private int aEINBNLNPJH_;
    /**
     * <code>uint32 AEINBNLNPJH = 11;</code>
     * @return The aEINBNLNPJH.
     */
    @java.lang.Override
    public int getAEINBNLNPJH() {
      return aEINBNLNPJH_;
    }

    public static final int JDNBDNLCCHN_FIELD_NUMBER = 2;
    private int jDNBDNLCCHN_;
    /**
     * <code>uint32 JDNBDNLCCHN = 2;</code>
     * @return The jDNBDNLCCHN.
     */
    @java.lang.Override
    public int getJDNBDNLCCHN() {
      return jDNBDNLCCHN_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (jDNBDNLCCHN_ != 0) {
        output.writeUInt32(2, jDNBDNLCCHN_);
      }
      if (rodEntityId_ != 0) {
        output.writeUInt32(7, rodEntityId_);
      }
      if (aEINBNLNPJH_ != 0) {
        output.writeUInt32(11, aEINBNLNPJH_);
      }
      if (pos_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (jDNBDNLCCHN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, jDNBDNLCCHN_);
      }
      if (rodEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (aEINBNLNPJH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, aEINBNLNPJH_);
      }
      if (pos_ != null) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getAEINBNLNPJH()
          != other.getAEINBNLNPJH()) return false;
      if (getJDNBDNLCCHN()
          != other.getJDNBDNLCCHN()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + AEINBNLNPJH_FIELD_NUMBER;
      hash = (53 * hash) + getAEINBNLNPJH();
      hash = (37 * hash) + JDNBDNLCCHN_FIELD_NUMBER;
      hash = (53 * hash) + getJDNBDNLCCHN();
      if (hasPos()) {
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.FishCastRodReqOuterClass.FishCastRodReq buildPartial() {
        ...
        result.aEINBNLNPJH_ = aEINBNLNPJH_;
        result.jDNBDNLCCHN_ = jDNBDNLCCHN_;
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FishCastRodReqOuterClass.FishCastRodReq other) {
        ...
        if (other.getAEINBNLNPJH() != 0) {
          setAEINBNLNPJH(other.getAEINBNLNPJH());
        }
        if (other.getJDNBDNLCCHN() != 0) {
          setJDNBDNLCCHN(other.getJDNBDNLCCHN());
        }
        if (other.hasPos()) {
      ...
      /**
       * <code>uint32 AEINBNLNPJH = 11;</code>
       * @param value The aEINBNLNPJH to set.
       * @return This builder for chaining.
       */
      public Builder setAEINBNLNPJH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearAEINBNLNPJH() {
      ...
      /**
       * <code>uint32 JDNBDNLCCHN = 2;</code>
       * @param value The jDNBDNLCCHN to set.
       * @return This builder for chaining.
       */
      public Builder setJDNBDNLCCHN(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearJDNBDNLCCHN() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "FishCastRodReq\022\025\n\rrod_entity_id\030\007 \001(\r\022\023\n" +
      "\013AEINBNLNPJH\030\013 \001(\r\022\023\n\013JDNBDNLCCHN\030\002 \001(\r\022" +
    ...
    internal_static_FishCastRodReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FishCastRodReq_descriptor,
        new java.lang.String[] { "RodEntityId", "AEINBNLNPJH", "JDNBDNLCCHN", "Pos", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
