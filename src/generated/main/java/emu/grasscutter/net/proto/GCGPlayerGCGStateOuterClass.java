...
public final class GCGPlayerGCGStateOuterClass {
  ...
  public interface GCGPlayerGCGStateOrBuilder extends
    ...
    /**
     * <code>bool GFNDMEBDCIK = 5;</code>
     * @return The gFNDMEBDCIK.
     */
    boolean getGFNDMEBDCIK();
    ...
    /**
     * <code>bool CHBHOPHJBPM = 12;</code>
     * @return The cHBHOPHJBPM.
     */
    boolean getCHBHOPHJBPM();
  }
  /**
   * <pre>
   * Name: HCADHBGHFOC
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              gFNDMEBDCIK_ = input.readBool();
              break;
            }
            case 96: {

              cHBHOPHJBPM_ = input.readBool();
              break;
            }
            default: {
    ...
    public static final int GFNDMEBDCIK_FIELD_NUMBER = 5;
    private boolean gFNDMEBDCIK_;
    /**
     * <code>bool GFNDMEBDCIK = 5;</code>
     * @return The gFNDMEBDCIK.
     */
    @java.lang.Override
    public boolean getGFNDMEBDCIK() {
      return gFNDMEBDCIK_;
    }
    ...
    public static final int CHBHOPHJBPM_FIELD_NUMBER = 12;
    private boolean cHBHOPHJBPM_;
    /**
     * <code>bool CHBHOPHJBPM = 12;</code>
     * @return The cHBHOPHJBPM.
     */
    @java.lang.Override
    public boolean getCHBHOPHJBPM() {
      return cHBHOPHJBPM_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (gFNDMEBDCIK_ != false) {
        output.writeBool(5, gFNDMEBDCIK_);
      }
      if (cHBHOPHJBPM_ != false) {
        output.writeBool(12, cHBHOPHJBPM_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (gFNDMEBDCIK_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(5, gFNDMEBDCIK_);
      }
      if (cHBHOPHJBPM_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(12, cHBHOPHJBPM_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getGFNDMEBDCIK()
          != other.getGFNDMEBDCIK()) return false;
      if (getUid()
          != other.getUid()) return false;
      if (getCHBHOPHJBPM()
          != other.getCHBHOPHJBPM()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + GFNDMEBDCIK_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getGFNDMEBDCIK());
      hash = (37 * hash) + UID_FIELD_NUMBER;
      hash = (53 * hash) + getUid();
      hash = (37 * hash) + CHBHOPHJBPM_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getCHBHOPHJBPM());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState buildPartial() {
        ...
        result.gFNDMEBDCIK_ = gFNDMEBDCIK_;
        result.uid_ = uid_;
        result.cHBHOPHJBPM_ = cHBHOPHJBPM_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState other) {
        ...
        if (other.getGFNDMEBDCIK() != false) {
          setGFNDMEBDCIK(other.getGFNDMEBDCIK());
        }
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        if (other.getCHBHOPHJBPM() != false) {
          setCHBHOPHJBPM(other.getCHBHOPHJBPM());
        }
      ...
      /**
       * <code>bool GFNDMEBDCIK = 5;</code>
       * @param value The gFNDMEBDCIK to set.
       * @return This builder for chaining.
       */
      public Builder setGFNDMEBDCIK(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGFNDMEBDCIK() {
      ...
      /**
       * <code>bool CHBHOPHJBPM = 12;</code>
       * @param value The cHBHOPHJBPM to set.
       * @return This builder for chaining.
       */
      public Builder setCHBHOPHJBPM(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCHBHOPHJBPM() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "GState\022\023\n\013GFNDMEBDCIK\030\005 \001(\010\022\013\n\003uid\030\002 \001(\r" +
      "\022\023\n\013CHBHOPHJBPM\030\014 \001(\010B\033\n\031emu.grasscutter" +
    ...
    internal_static_GCGPlayerGCGState_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGPlayerGCGState_descriptor,
        new java.lang.String[] { "GFNDMEBDCIK", "Uid", "CHBHOPHJBPM", });
  }
