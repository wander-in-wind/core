...
public final class PlayerLuaShellNotifyOuterClass {
  ...
  public interface PlayerLuaShellNotifyOrBuilder extends
    ...
    /**
     * <code>.LuaShellType shell_type = 8;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LUA_SHELL_FIELD_NUMBER = 11;
    ...
    public static final int SHELL_TYPE_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (shellType_ != emu.grasscutter.net.proto.LuaShellTypeOuterClass.LuaShellType.LUASHELL_NONE.getNumber()) {
        output.writeEnum(8, shellType_);
      }
      if (!luaShell_.isEmpty()) {
        output.writeBytes(11, luaShell_);
      }
      if (id_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (shellType_ != emu.grasscutter.net.proto.LuaShellTypeOuterClass.LuaShellType.LUASHELL_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(8, shellType_);
      }
      if (!luaShell_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(11, luaShell_);
      }
      if (id_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "shell\030\013 \001(\014\022\n\n\002id\030\014 \001(\r\022!\n\nshell_type\030\010 " +
      "\001(\0162\r.LuaShellType\022\020\n\010use_type\030\002 \001(\rB\033\n\031" +
    ...
    internal_static_PlayerLuaShellNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerLuaShellNotify_descriptor,
        new java.lang.String[] { "LuaShell", "Id", "ShellType", "UseType", });
    emu.grasscutter.net.proto.LuaShellTypeOuterClass.getDescriptor();
  }
