...
public final class ActivityAcceptAllGiveGiftRspOuterClass {
  ...
  public interface ActivityAcceptAllGiveGiftRspOrBuilder extends
    ...
    /**
     * <code>repeated .ActivityAcceptGiftResultInfo accept_gift_result_info_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ACCEPT_GIFT_RESULT_INFO_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < acceptGiftResultInfoList_.size(); i++) {
        output.writeMessage(1, acceptGiftResultInfoList_.get(i));
      }
      if (scheduleId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < acceptGiftResultInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, acceptGiftResultInfoList_.get(i));
      }
      if (scheduleId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ivityAcceptAllGiveGiftRsp\022\023\n\013schedule_id" +
      "\030\006 \001(\r\022C\n\034accept_gift_result_info_list\030\001" +
      " \003(\0132\035.ActivityAcceptGiftResultInfo\022\017\n\007r" +
    ...
    internal_static_ActivityAcceptAllGiveGiftRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ActivityAcceptAllGiveGiftRsp_descriptor,
        new java.lang.String[] { "ScheduleId", "AcceptGiftResultInfoList", "Retcode", });
    emu.grasscutter.net.proto.ActivityAcceptGiftResultInfoOuterClass.getDescriptor();
  }
