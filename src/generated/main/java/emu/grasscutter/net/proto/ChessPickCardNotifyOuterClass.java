...
public final class ChessPickCardNotifyOuterClass {
  ...
  public interface ChessPickCardNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 curse_card_id = 3;</code>
     * @return The curseCardId.
     */
    int getCurseCardId();

    /**
     * <code>.ChessNormalCardInfo normal_card_info = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CURSE_CARD_ID_FIELD_NUMBER = 3;
    ...
    public static final int NORMAL_CARD_INFO_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (normalCardInfo_ != null) {
        output.writeMessage(2, getNormalCardInfo());
      }
      if (curseCardId_ != 0) {
        output.writeUInt32(3, curseCardId_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (normalCardInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, getNormalCardInfo());
      }
      if (curseCardId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, curseCardId_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\rcurse_card_id\030\003 \001(\r\022.\n\020normal_card_info" +
      "\030\002 \001(\0132\024.ChessNormalCardInfoB\033\n\031emu.gras" +
