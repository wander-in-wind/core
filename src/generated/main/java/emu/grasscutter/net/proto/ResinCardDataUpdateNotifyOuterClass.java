...
public final class ResinCardDataUpdateNotifyOuterClass {
  ...
  public interface ResinCardDataUpdateNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 today_start_time = 2;</code>
     * @return The todayStartTime.
     */
    int getTodayStartTime();

    /**
     * <code>repeated .ResinCardData card_data_list = 15;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int TODAY_START_TIME_FIELD_NUMBER = 2;
    ...
    public static final int CARD_DATA_LIST_FIELD_NUMBER = 15;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (todayStartTime_ != 0) {
        output.writeUInt32(2, todayStartTime_);
      }
      for (int i = 0; i < cardDataList_.size(); i++) {
        output.writeMessage(15, cardDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      if (todayStartTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, todayStartTime_);
      }
      for (int i = 0; i < cardDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(15, cardDataList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ify\022\030\n\020today_start_time\030\002 \001(\r\022&\n\016card_da" +
      "ta_list\030\017 \003(\0132\016.ResinCardDataB\033\n\031emu.gra" +
