...
public final class SignInInfoOuterClass {
  ...
  public interface SignInInfoOrBuilder extends
    ...
    /**
     * <code>uint32 GANAIGKNLOD = 11;</code>
     * @return The gANAIGKNLOD.
     */
    int getGANAIGKNLOD();
    ...
    /**
     * <code>uint32 ODCICMMHNOH = 8;</code>
     * @return The oDCICMMHNOH.
     */
    int getODCICMMHNOH();
    ...
    /**
     * <code>bool is_cond_satisfied = 10;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int GANAIGKNLOD_FIELD_NUMBER = 11;
    private int gANAIGKNLOD_;
    /**
     * <code>uint32 GANAIGKNLOD = 11;</code>
     * @return The gANAIGKNLOD.
     */
    @java.lang.Override
    public int getGANAIGKNLOD() {
      return gANAIGKNLOD_;
    }
    ...
    public static final int ODCICMMHNOH_FIELD_NUMBER = 8;
    private int oDCICMMHNOH_;
    /**
     * <code>uint32 ODCICMMHNOH = 8;</code>
     * @return The oDCICMMHNOH.
     */
    @java.lang.Override
    public int getODCICMMHNOH() {
      return oDCICMMHNOH_;
    }
    ...
    public static final int IS_COND_SATISFIED_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < signinDataList_.size(); i++) {
        output.writeMessage(2, signinDataList_.get(i));
      }
      if (endTime_ != 0) {
      ...
      if (oDCICMMHNOH_ != 0) {
        output.writeUInt32(8, oDCICMMHNOH_);
      }
      ...
      if (isCondSatisfied_ != false) {
        output.writeBool(10, isCondSatisfied_);
      }
      if (gANAIGKNLOD_ != 0) {
        output.writeUInt32(11, gANAIGKNLOD_);
      }
      if (beginTime_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < signinDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, signinDataList_.get(i));
      }
      if (endTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (oDCICMMHNOH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, oDCICMMHNOH_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < rewardDayList_.size(); i++) {
      ...
      if (isCondSatisfied_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(10, isCondSatisfied_);
      }
      if (gANAIGKNLOD_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, gANAIGKNLOD_);
      }
      if (beginTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getGANAIGKNLOD()
          != other.getGANAIGKNLOD()) return false;
      if (getEndTime()
          != other.getEndTime()) return false;
      if (getODCICMMHNOH()
          != other.getODCICMMHNOH()) return false;
      if (getScheduleId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + GANAIGKNLOD_FIELD_NUMBER;
      hash = (53 * hash) + getGANAIGKNLOD();
      hash = (37 * hash) + END_TIME_FIELD_NUMBER;
      hash = (53 * hash) + getEndTime();
      hash = (37 * hash) + ODCICMMHNOH_FIELD_NUMBER;
      hash = (53 * hash) + getODCICMMHNOH();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo buildPartial() {
        ...
        result.gANAIGKNLOD_ = gANAIGKNLOD_;
        result.endTime_ = endTime_;
        result.oDCICMMHNOH_ = oDCICMMHNOH_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo other) {
        ...
        if (other.getGANAIGKNLOD() != 0) {
          setGANAIGKNLOD(other.getGANAIGKNLOD());
        }
        if (other.getEndTime() != 0) {
          setEndTime(other.getEndTime());
        }
        if (other.getODCICMMHNOH() != 0) {
          setODCICMMHNOH(other.getODCICMMHNOH());
        }
      ...
      /**
       * <code>uint32 GANAIGKNLOD = 11;</code>
       * @param value The gANAIGKNLOD to set.
       * @return This builder for chaining.
       */
      public Builder setGANAIGKNLOD(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGANAIGKNLOD() {
      ...
      /**
       * <code>uint32 ODCICMMHNOH = 8;</code>
       * @param value The oDCICMMHNOH to set.
       * @return This builder for chaining.
       */
      public Builder setODCICMMHNOH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearODCICMMHNOH() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\nSignInInfo\022\023\n\013GANAIGKNLOD\030\013 \001(\r\022\020\n\010end_" +
      "time\030\005 \001(\r\022\023\n\013ODCICMMHNOH\030\010 \001(\r\022\023\n\013sched" +
      "ule_id\030\007 \001(\r\022\031\n\021is_cond_satisfied\030\n \001(\010\022" +
      "\021\n\tconfig_id\030\006 \001(\r\022\027\n\017reward_day_list\030\t " +
      "\003(\r\022%\n\020signin_data_list\030\002 \003(\0132\013.SignInDa" +
    ...
    internal_static_SignInInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SignInInfo_descriptor,
        new java.lang.String[] { "GANAIGKNLOD", "EndTime", "ODCICMMHNOH", "ScheduleId", "IsCondSatisfied", "ConfigId", "RewardDayList", "SigninDataList", "BeginTime", });
    emu.grasscutter.net.proto.SignInDataOuterClass.getDescriptor();
  }
