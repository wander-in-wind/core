...
public final class ActivitySaleChangeNotifyOuterClass {
  ...
  public interface ActivitySaleChangeNotifyOrBuilder extends
    ...
    /**
     * <code>bool is_close = 9;</code>
     * @return The isClose.
     */
    boolean getIsClose();

    /**
     * <code>uint32 sale_id = 3;</code>
     * @return The saleId.
     */
    int getSaleId();
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_CLOSE_FIELD_NUMBER = 9;
    ...
    public static final int SALE_ID_FIELD_NUMBER = 3;
    private int saleId_;
    /**
     * <code>uint32 sale_id = 3;</code>
     * @return The saleId.
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (saleId_ != 0) {
        output.writeUInt32(3, saleId_);
      }
      if (isClose_ != false) {
        output.writeBool(9, isClose_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (saleId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, saleId_);
      }
      if (isClose_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, isClose_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "vitySaleChangeNotify\022\020\n\010is_close\030\t \001(\010\022\017" +
      "\n\007sale_id\030\003 \001(\rB\033\n\031emu.grasscutter.net.p" +
      "rotob\006proto3"
    };
