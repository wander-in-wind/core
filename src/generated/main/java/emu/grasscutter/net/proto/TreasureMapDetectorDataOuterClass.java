...
public final class TreasureMapDetectorDataOuterClass {
  ...
  public interface TreasureMapDetectorDataOrBuilder extends
    ...
    /**
     * <code>bool is_region_detected = 3;</code>
     * @return The isRegionDetected.
     */
    boolean getIsRegionDetected();

    /**
     * <code>.Vector center_pos = 13;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_REGION_DETECTED_FIELD_NUMBER = 3;
    ...
    public static final int CENTER_POS_FIELD_NUMBER = 13;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isRegionDetected_ != false) {
        output.writeBool(3, isRegionDetected_);
      }
      for (int i = 0; i < spotList_.size(); i++) {
        output.writeMessage(9, spotList_.get(i));
      }
      if (centerPos_ != null) {
        output.writeMessage(13, getCenterPos());
      }
    ...
    public int getSerializedSize() {
      ...
      if (isRegionDetected_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, isRegionDetected_);
      }
      for (int i = 0; i < spotList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (centerPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, getCenterPos());
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "proto\"\221\001\n\027TreasureMapDetectorData\022\016\n\006rad" +
      "ius\030\001 \001(\r\022\021\n\tregion_id\030\002 \001(\r\022\032\n\022is_regio" +
      "n_detected\030\003 \001(\010\022\033\n\ncenter_pos\030\r \001(\0132\007.V" +
      "ector\022\032\n\tspot_list\030\t \003(\0132\007.VectorB\033\n\031emu" +
    ...
    internal_static_TreasureMapDetectorData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TreasureMapDetectorData_descriptor,
        new java.lang.String[] { "Radius", "RegionId", "IsRegionDetected", "CenterPos", "SpotList", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
