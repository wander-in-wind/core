...
public final class HomePlantSubFieldDataOuterClass {
  ...
  public interface HomePlantSubFieldDataOrBuilder extends
    ...
    /**
     * <code>uint32 LLGHDIMCDAG = 11;</code>
     * @return The lLGHDIMCDAG.
     */
    int getLLGHDIMCDAG();
    ...
    /**
     * <code>uint32 MAIEPKDDLJF = 13;</code>
     * @return The mAIEPKDDLJF.
     */
    int getMAIEPKDDLJF();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 88: {
              ...
              lLGHDIMCDAG_ = input.readUInt32();
              break;
            }
            case 104: {

              mAIEPKDDLJF_ = input.readUInt32();
              break;
            }
            case 112: {
    ...
    public static final int LLGHDIMCDAG_FIELD_NUMBER = 11;
    private int lLGHDIMCDAG_;
    /**
     * <code>uint32 LLGHDIMCDAG = 11;</code>
     * @return The lLGHDIMCDAG.
     */
    @java.lang.Override
    public int getLLGHDIMCDAG() {
      return lLGHDIMCDAG_;
    }
    ...
    public static final int MAIEPKDDLJF_FIELD_NUMBER = 13;
    private int mAIEPKDDLJF_;
    /**
     * <code>uint32 MAIEPKDDLJF = 13;</code>
     * @return The mAIEPKDDLJF.
     */
    @java.lang.Override
    public int getMAIEPKDDLJF() {
      return mAIEPKDDLJF_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lLGHDIMCDAG_ != 0) {
        output.writeUInt32(11, lLGHDIMCDAG_);
      }
      if (mAIEPKDDLJF_ != 0) {
        output.writeUInt32(13, mAIEPKDDLJF_);
      }
      if (fieldStatus_ != emu.grasscutter.net.proto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.HOME_FIELD_STATUE_NONE.getNumber()) {
    ...
    public int getSerializedSize() {
      ...
      if (lLGHDIMCDAG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, lLGHDIMCDAG_);
      }
      if (mAIEPKDDLJF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, mAIEPKDDLJF_);
      }
      if (fieldStatus_ != emu.grasscutter.net.proto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.HOME_FIELD_STATUE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + LLGHDIMCDAG_FIELD_NUMBER;
      hash = (53 * hash) + getLLGHDIMCDAG();
      ...
      hash = (37 * hash) + MAIEPKDDLJF_FIELD_NUMBER;
      hash = (53 * hash) + getMAIEPKDDLJF();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData buildPartial() {
        ...
        result.lLGHDIMCDAG_ = lLGHDIMCDAG_;
        ...
        result.mAIEPKDDLJF_ = mAIEPKDDLJF_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData other) {
        ...
        if (other.getLLGHDIMCDAG() != 0) {
          setLLGHDIMCDAG(other.getLLGHDIMCDAG());
        }
        ...
        if (other.getMAIEPKDDLJF() != 0) {
          setMAIEPKDDLJF(other.getMAIEPKDDLJF());
        }
      ...
      /**
       * <code>uint32 LLGHDIMCDAG = 11;</code>
       * @param value The lLGHDIMCDAG to set.
       * @return This builder for chaining.
       */
      public Builder setLLGHDIMCDAG(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLLGHDIMCDAG() {
      ...
      /**
       * <code>uint32 MAIEPKDDLJF = 13;</code>
       * @param value The mAIEPKDDLJF to set.
       * @return This builder for chaining.
       */
      public Builder setMAIEPKDDLJF(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMAIEPKDDLJF() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "FieldStatus.proto\"\230\001\n\025HomePlantSubFieldD" +
      "ata\022+\n\014field_status\030\016 \001(\0162\025.HomePlantFie" +
      "ldStatus\022\023\n\013LLGHDIMCDAG\030\013 \001(\r\022\026\n\016entity_" +
      "id_list\030\007 \003(\r\022\020\n\010end_time\030\006 \001(\007\022\023\n\013MAIEP" +
      "KDDLJF\030\r \001(\rB\033\n\031emu.grasscutter.net.prot" +
      "ob\006proto3"
    };
    ...
    internal_static_HomePlantSubFieldData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomePlantSubFieldData_descriptor,
        new java.lang.String[] { "FieldStatus", "LLGHDIMCDAG", "EntityIdList", "EndTime", "MAIEPKDDLJF", });
    emu.grasscutter.net.proto.HomePlantFieldStatusOuterClass.getDescriptor();
  }
