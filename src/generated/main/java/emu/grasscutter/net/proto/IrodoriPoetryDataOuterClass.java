...
public final class IrodoriPoetryDataOuterClass {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < themeDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, themeDataList_.get(i));
      }
      if (curThemeId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, curThemeId_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "theme_data_list\030\003 \003(\0132\027.IrodoriPoetryThe" +
      "meData\022\024\n\014cur_theme_id\030\016 \001(\rB\033\n\031emu.gras" +
