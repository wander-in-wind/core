...
public final class GetAllActivatedBargainDataRspOuterClass {
  ...
  public interface GetAllActivatedBargainDataRspOrBuilder extends
    ...
    /**
     * <code>repeated .BargainSnapshot snapshot_list = 8;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < snapshotList_.size(); i++) {
        output.writeMessage(8, snapshotList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < snapshotList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, snapshotList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ot_list\030\010 \003(\0132\020.BargainSnapshotB\033\n\031emu.g" +
