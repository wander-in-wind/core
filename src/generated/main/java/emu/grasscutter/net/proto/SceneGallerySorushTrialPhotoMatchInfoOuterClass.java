...
public final class SceneGallerySorushTrialPhotoMatchInfoOuterClass {
  ...
  public interface SceneGallerySorushTrialPhotoMatchInfoOrBuilder extends
    ...
    /**
     * <code>bool KCMBHJJNDBI = 13;</code>
     * @return The kCMBHJJNDBI.
     */
    boolean getKCMBHJJNDBI();

    /**
     * <code>bool DOFKELOBBGK = 2;</code>
     * @return The dOFKELOBBGK.
     */
    boolean getDOFKELOBBGK();
  }
  /**
   * <pre>
   * Name: ELPLKGHKCEL
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              dOFKELOBBGK_ = input.readBool();
              break;
            }
            case 104: {

              kCMBHJJNDBI_ = input.readBool();
              break;
            }
            default: {
    ...
    public static final int KCMBHJJNDBI_FIELD_NUMBER = 13;
    private boolean kCMBHJJNDBI_;
    /**
     * <code>bool KCMBHJJNDBI = 13;</code>
     * @return The kCMBHJJNDBI.
     */
    @java.lang.Override
    public boolean getKCMBHJJNDBI() {
      return kCMBHJJNDBI_;
    }

    public static final int DOFKELOBBGK_FIELD_NUMBER = 2;
    private boolean dOFKELOBBGK_;
    /**
     * <code>bool DOFKELOBBGK = 2;</code>
     * @return The dOFKELOBBGK.
     */
    @java.lang.Override
    public boolean getDOFKELOBBGK() {
      return dOFKELOBBGK_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (dOFKELOBBGK_ != false) {
        output.writeBool(2, dOFKELOBBGK_);
      }
      if (kCMBHJJNDBI_ != false) {
        output.writeBool(13, kCMBHJJNDBI_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (dOFKELOBBGK_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(2, dOFKELOBBGK_);
      }
      if (kCMBHJJNDBI_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(13, kCMBHJJNDBI_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getKCMBHJJNDBI()
          != other.getKCMBHJJNDBI()) return false;
      if (getDOFKELOBBGK()
          != other.getDOFKELOBBGK()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + KCMBHJJNDBI_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getKCMBHJJNDBI());
      hash = (37 * hash) + DOFKELOBBGK_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getDOFKELOBBGK());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SceneGallerySorushTrialPhotoMatchInfoOuterClass.SceneGallerySorushTrialPhotoMatchInfo buildPartial() {
        ...
        result.kCMBHJJNDBI_ = kCMBHJJNDBI_;
        result.dOFKELOBBGK_ = dOFKELOBBGK_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SceneGallerySorushTrialPhotoMatchInfoOuterClass.SceneGallerySorushTrialPhotoMatchInfo other) {
        ...
        if (other.getKCMBHJJNDBI() != false) {
          setKCMBHJJNDBI(other.getKCMBHJJNDBI());
        }
        if (other.getDOFKELOBBGK() != false) {
          setDOFKELOBBGK(other.getDOFKELOBBGK());
        }
      ...
      /**
       * <code>bool KCMBHJJNDBI = 13;</code>
       * @param value The kCMBHJJNDBI to set.
       * @return This builder for chaining.
       */
      public Builder setKCMBHJJNDBI(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearKCMBHJJNDBI() {
      ...
      /**
       * <code>bool DOFKELOBBGK = 2;</code>
       * @param value The dOFKELOBBGK to set.
       * @return This builder for chaining.
       */
      public Builder setDOFKELOBBGK(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearDOFKELOBBGK() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "chInfo\022\023\n\013KCMBHJJNDBI\030\r \001(\010\022\023\n\013DOFKELOBB" +
      "GK\030\002 \001(\010B\033\n\031emu.grasscutter.net.protob\006p" +
      "roto3"
    };
    ...
    internal_static_SceneGallerySorushTrialPhotoMatchInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneGallerySorushTrialPhotoMatchInfo_descriptor,
        new java.lang.String[] { "KCMBHJJNDBI", "DOFKELOBBGK", });
  }
