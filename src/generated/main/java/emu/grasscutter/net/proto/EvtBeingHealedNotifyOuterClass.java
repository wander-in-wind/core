...
public final class EvtBeingHealedNotifyOuterClass {
  ...
  public interface EvtBeingHealedNotifyOrBuilder extends
    ...
    /**
     * <code>float KNLBFMODPIN = 11;</code>
     * @return The kNLBFMODPIN.
     */
    float getKNLBFMODPIN();
    ...
    /**
     * <code>float OFOGNOIABMG = 12;</code>
     * @return The oFOGNOIABMG.
     */
    float getOFOGNOIABMG();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 93: {
              ...
              kNLBFMODPIN_ = input.readFloat();
              break;
            }
            case 101: {

              oFOGNOIABMG_ = input.readFloat();
              break;
            }
            default: {
    ...
    public static final int KNLBFMODPIN_FIELD_NUMBER = 11;
    private float kNLBFMODPIN_;
    /**
     * <code>float KNLBFMODPIN = 11;</code>
     * @return The kNLBFMODPIN.
     */
    @java.lang.Override
    public float getKNLBFMODPIN() {
      return kNLBFMODPIN_;
    }
    ...
    public static final int OFOGNOIABMG_FIELD_NUMBER = 12;
    private float oFOGNOIABMG_;
    /**
     * <code>float OFOGNOIABMG = 12;</code>
     * @return The oFOGNOIABMG.
     */
    @java.lang.Override
    public float getOFOGNOIABMG() {
      return oFOGNOIABMG_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (kNLBFMODPIN_ != 0F) {
        output.writeFloat(11, kNLBFMODPIN_);
      }
      if (oFOGNOIABMG_ != 0F) {
        output.writeFloat(12, oFOGNOIABMG_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (kNLBFMODPIN_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(11, kNLBFMODPIN_);
      }
      if (oFOGNOIABMG_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(12, oFOGNOIABMG_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (java.lang.Float.floatToIntBits(getKNLBFMODPIN())
          != java.lang.Float.floatToIntBits(
              other.getKNLBFMODPIN())) return false;
      if (getTargetId()
          != other.getTargetId()) return false;
      if (java.lang.Float.floatToIntBits(getOFOGNOIABMG())
          != java.lang.Float.floatToIntBits(
              other.getOFOGNOIABMG())) return false;
      if (getSourceId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + KNLBFMODPIN_FIELD_NUMBER;
      hash = (53 * hash) + java.lang.Float.floatToIntBits(
          getKNLBFMODPIN());
      hash = (37 * hash) + TARGET_ID_FIELD_NUMBER;
      hash = (53 * hash) + getTargetId();
      hash = (37 * hash) + OFOGNOIABMG_FIELD_NUMBER;
      hash = (53 * hash) + java.lang.Float.floatToIntBits(
          getOFOGNOIABMG());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.EvtBeingHealedNotifyOuterClass.EvtBeingHealedNotify buildPartial() {
        ...
        result.kNLBFMODPIN_ = kNLBFMODPIN_;
        result.targetId_ = targetId_;
        result.oFOGNOIABMG_ = oFOGNOIABMG_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.EvtBeingHealedNotifyOuterClass.EvtBeingHealedNotify other) {
        ...
        if (other.getKNLBFMODPIN() != 0F) {
          setKNLBFMODPIN(other.getKNLBFMODPIN());
        }
        if (other.getTargetId() != 0) {
          setTargetId(other.getTargetId());
        }
        if (other.getOFOGNOIABMG() != 0F) {
          setOFOGNOIABMG(other.getOFOGNOIABMG());
        }
      ...
      /**
       * <code>float KNLBFMODPIN = 11;</code>
       * @param value The kNLBFMODPIN to set.
       * @return This builder for chaining.
       */
      public Builder setKNLBFMODPIN(float value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearKNLBFMODPIN() {
      ...
      /**
       * <code>float OFOGNOIABMG = 12;</code>
       * @param value The oFOGNOIABMG to set.
       * @return This builder for chaining.
       */
      public Builder setOFOGNOIABMG(float value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearOFOGNOIABMG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "HealedNotify\022\023\n\013KNLBFMODPIN\030\013 \001(\002\022\021\n\ttar" +
      "get_id\030\010 \001(\r\022\023\n\013OFOGNOIABMG\030\014 \001(\002\022\021\n\tsou" +
      "rce_id\030\004 \001(\rB\033\n\031emu.grasscutter.net.prot" +
      "ob\006proto3"
    };
    ...
    internal_static_EvtBeingHealedNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_EvtBeingHealedNotify_descriptor,
        new java.lang.String[] { "KNLBFMODPIN", "TargetId", "OFOGNOIABMG", "SourceId", });
  }
