...
public final class BartenderCompleteOrderReqOuterClass {
  ...
  public interface BartenderCompleteOrderReqOrBuilder extends
    ...
    /**
     * <code>uint32 MJABGHGABFH = 9;</code>
     * @return The mJABGHGABFH.
     */
    int getMJABGHGABFH();
    ...
    /**
     * <code>uint32 HAPFNEIHHPP = 6;</code>
     * @return The hAPFNEIHHPP.
     */
    int getHAPFNEIHHPP();

    /**
     * <code>bool is_view_formula = 14;</code>
    ...
    /**
     * <code>repeated uint32 optional_order_list = 7;</code>
    ...
    /**
     * <code>uint32 MOBMFDJLHKD = 11;</code>
     * @return The mOBMFDJLHKD.
     */
    int getMOBMFDJLHKD();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 72: {
              ...
              mJABGHGABFH_ = input.readUInt32();
              break;
            }
            case 88: {

              mOBMFDJLHKD_ = input.readUInt32();
              break;
            }
            case 98: {
    ...
    public static final int MJABGHGABFH_FIELD_NUMBER = 9;
    private int mJABGHGABFH_;
    /**
     * <code>uint32 MJABGHGABFH = 9;</code>
     * @return The mJABGHGABFH.
     */
    @java.lang.Override
    public int getMJABGHGABFH() {
      return mJABGHGABFH_;
    }
    ...
    public static final int HAPFNEIHHPP_FIELD_NUMBER = 6;
    private int hAPFNEIHHPP_;
    /**
     * <code>uint32 HAPFNEIHHPP = 6;</code>
     * @return The hAPFNEIHHPP.
     */
    @java.lang.Override
    public int getHAPFNEIHHPP() {
      return hAPFNEIHHPP_;
    }

    public static final int IS_VIEW_FORMULA_FIELD_NUMBER = 14;
    ...
    public static final int OPTIONAL_ORDER_LIST_FIELD_NUMBER = 7;
    ...
    public static final int MOBMFDJLHKD_FIELD_NUMBER = 11;
    private int mOBMFDJLHKD_;
    /**
     * <code>uint32 MOBMFDJLHKD = 11;</code>
     * @return The mOBMFDJLHKD.
     */
    @java.lang.Override
    public int getMOBMFDJLHKD() {
      return mOBMFDJLHKD_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (hAPFNEIHHPP_ != 0) {
        output.writeUInt32(6, hAPFNEIHHPP_);
      }
      ...
      if (mJABGHGABFH_ != 0) {
        output.writeUInt32(9, mJABGHGABFH_);
      }
      if (mOBMFDJLHKD_ != 0) {
        output.writeUInt32(11, mOBMFDJLHKD_);
      }
      for (int i = 0; i < itemList_.size(); i++) {
        output.writeMessage(12, itemList_.get(i));
      }
      if (isViewFormula_ != false) {
        output.writeBool(14, isViewFormula_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (hAPFNEIHHPP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, hAPFNEIHHPP_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < optionalOrderList_.size(); i++) {
      ...
      if (mJABGHGABFH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, mJABGHGABFH_);
      }
      if (mOBMFDJLHKD_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, mOBMFDJLHKD_);
      }
      for (int i = 0; i < itemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (isViewFormula_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(14, isViewFormula_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getMJABGHGABFH()
          != other.getMJABGHGABFH()) return false;
      if (getQuestId()
          != other.getQuestId()) return false;
      if (getHAPFNEIHHPP()
          != other.getHAPFNEIHHPP()) return false;
      if (getIsViewFormula()
      ...
      if (getMOBMFDJLHKD()
          != other.getMOBMFDJLHKD()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + MJABGHGABFH_FIELD_NUMBER;
      hash = (53 * hash) + getMJABGHGABFH();
      hash = (37 * hash) + QUEST_ID_FIELD_NUMBER;
      hash = (53 * hash) + getQuestId();
      hash = (37 * hash) + HAPFNEIHHPP_FIELD_NUMBER;
      hash = (53 * hash) + getHAPFNEIHHPP();
      ...
      hash = (37 * hash) + MOBMFDJLHKD_FIELD_NUMBER;
      hash = (53 * hash) + getMOBMFDJLHKD();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq buildPartial() {
        ...
        result.mJABGHGABFH_ = mJABGHGABFH_;
        result.questId_ = questId_;
        result.hAPFNEIHHPP_ = hAPFNEIHHPP_;
        ...
        result.mOBMFDJLHKD_ = mOBMFDJLHKD_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq other) {
        ...
        if (other.getMJABGHGABFH() != 0) {
          setMJABGHGABFH(other.getMJABGHGABFH());
        }
        if (other.getQuestId() != 0) {
          setQuestId(other.getQuestId());
        }
        if (other.getHAPFNEIHHPP() != 0) {
          setHAPFNEIHHPP(other.getHAPFNEIHHPP());
        }
        ...
        if (other.getMOBMFDJLHKD() != 0) {
          setMOBMFDJLHKD(other.getMOBMFDJLHKD());
        }
      ...
      /**
       * <code>uint32 MJABGHGABFH = 9;</code>
       * @param value The mJABGHGABFH to set.
       * @return This builder for chaining.
       */
      public Builder setMJABGHGABFH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMJABGHGABFH() {
      ...
      /**
       * <code>uint32 HAPFNEIHHPP = 6;</code>
       * @param value The hAPFNEIHHPP to set.
       * @return This builder for chaining.
       */
      public Builder setHAPFNEIHHPP(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHAPFNEIHHPP() {
      ...
      /**
       * <code>uint32 MOBMFDJLHKD = 11;</code>
       * @param value The mOBMFDJLHKD to set.
       * @return This builder for chaining.
       */
      public Builder setMOBMFDJLHKD(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMOBMFDJLHKD() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\023\n\013MJABGHGABFH\030\t \001(\r\022\020\n\010quest_id\030\005 \001(\r\022" +
      "\023\n\013HAPFNEIHHPP\030\006 \001(\r\022\027\n\017is_view_formula\030" +
      "\016 \001(\010\022\035\n\titem_list\030\014 \003(\0132\n.ItemParam\022\033\n\023" +
      "optional_order_list\030\007 \003(\r\022\023\n\013MOBMFDJLHKD" +
    ...
    internal_static_BartenderCompleteOrderReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BartenderCompleteOrderReq_descriptor,
        new java.lang.String[] { "MJABGHGABFH", "QuestId", "HAPFNEIHHPP", "IsViewFormula", "ItemList", "OptionalOrderList", "MOBMFDJLHKD", });
    emu.grasscutter.net.proto.ItemParamOuterClass.getDescriptor();
  }
