...
public final class HomeFurnitureGroupDataOuterClass {
  ...
  public interface HomeFurnitureGroupDataOrBuilder extends
    ...
    /**
     * <code>repeated .HomeFurnitureData virtual_furniture_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int VIRTUAL_FURNITURE_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < virtualFurnitureList_.size(); i++) {
        output.writeMessage(3, virtualFurnitureList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < virtualFurnitureList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, virtualFurnitureList_.get(i));
      }
      if (groupFurnitureIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public int hashCode() {
      ...
      if (getVirtualFurnitureListCount() > 0) {
        hash = (37 * hash) + VIRTUAL_FURNITURE_LIST_FIELD_NUMBER;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "a\022\035\n\025group_furniture_index\030\010 \001(\r\0222\n\026virt" +
      "ual_furniture_list\030\003 \003(\0132\022.HomeFurniture" +
    ...
    internal_static_HomeFurnitureGroupData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomeFurnitureGroupData_descriptor,
        new java.lang.String[] { "GroupFurnitureIndex", "VirtualFurnitureList", });
    emu.grasscutter.net.proto.HomeFurnitureDataOuterClass.getDescriptor();
  }
