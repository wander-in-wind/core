...
public final class AddAranaraCollectionNotifyOuterClass {
  ...
  public interface AddAranaraCollectionNotifyOrBuilder extends
    ...
    /**
     * <code>.AranaraCollectionState IJBFIKCDABD = 10;</code>
     * @return The enum numeric value on the wire for iJBFIKCDABD.
     */
    int getIJBFIKCDABDValue();
    /**
     * <code>.AranaraCollectionState IJBFIKCDABD = 10;</code>
     * @return The iJBFIKCDABD.
     */
    emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState getIJBFIKCDABD();

    /**
     * <code>.AranaraCollectionState CIEAPDGLPOL = 4;</code>
     * @return The enum numeric value on the wire for cIEAPDGLPOL.
     */
    int getCIEAPDGLPOLValue();
    /**
     * <code>.AranaraCollectionState CIEAPDGLPOL = 4;</code>
     * @return The cIEAPDGLPOL.
     */
    emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState getCIEAPDGLPOL();

    /**
     * <code>uint32 collection_id = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              cIEAPDGLPOL_ = rawValue;
              break;
            }
            case 80: {
              int rawValue = input.readEnum();

              iJBFIKCDABD_ = rawValue;
              break;
            }
            default: {
    ...
    public static final int IJBFIKCDABD_FIELD_NUMBER = 10;
    private int iJBFIKCDABD_;
    /**
     * <code>.AranaraCollectionState IJBFIKCDABD = 10;</code>
     * @return The enum numeric value on the wire for iJBFIKCDABD.
     */
    @java.lang.Override public int getIJBFIKCDABDValue() {
      return iJBFIKCDABD_;
    }
    /**
     * <code>.AranaraCollectionState IJBFIKCDABD = 10;</code>
     * @return The iJBFIKCDABD.
     */
    @java.lang.Override public emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState getIJBFIKCDABD() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState result = emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.valueOf(iJBFIKCDABD_);
      return result == null ? emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.UNRECOGNIZED : result;
    }

    public static final int CIEAPDGLPOL_FIELD_NUMBER = 4;
    private int cIEAPDGLPOL_;
    /**
     * <code>.AranaraCollectionState CIEAPDGLPOL = 4;</code>
     * @return The enum numeric value on the wire for cIEAPDGLPOL.
     */
    @java.lang.Override public int getCIEAPDGLPOLValue() {
      return cIEAPDGLPOL_;
    }
    /**
     * <code>.AranaraCollectionState CIEAPDGLPOL = 4;</code>
     * @return The cIEAPDGLPOL.
     */
    @java.lang.Override public emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState getCIEAPDGLPOL() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState result = emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.valueOf(cIEAPDGLPOL_);
      return result == null ? emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (collectionId_ != 0) {
        output.writeUInt32(3, collectionId_);
      }
      if (cIEAPDGLPOL_ != emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.ARANARA_COLLECTION_STATE_NONE.getNumber()) {
        output.writeEnum(4, cIEAPDGLPOL_);
      }
      if (iJBFIKCDABD_ != emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.ARANARA_COLLECTION_STATE_NONE.getNumber()) {
        output.writeEnum(10, iJBFIKCDABD_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (collectionId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, collectionId_);
      }
      if (cIEAPDGLPOL_ != emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.ARANARA_COLLECTION_STATE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(4, cIEAPDGLPOL_);
      }
      if (iJBFIKCDABD_ != emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.ARANARA_COLLECTION_STATE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(10, iJBFIKCDABD_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (iJBFIKCDABD_ != other.iJBFIKCDABD_) return false;
      if (cIEAPDGLPOL_ != other.cIEAPDGLPOL_) return false;
      if (getCollectionId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + IJBFIKCDABD_FIELD_NUMBER;
      hash = (53 * hash) + iJBFIKCDABD_;
      hash = (37 * hash) + CIEAPDGLPOL_FIELD_NUMBER;
      hash = (53 * hash) + cIEAPDGLPOL_;
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.AddAranaraCollectionNotifyOuterClass.AddAranaraCollectionNotify buildPartial() {
        ...
        result.iJBFIKCDABD_ = iJBFIKCDABD_;
        result.cIEAPDGLPOL_ = cIEAPDGLPOL_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AddAranaraCollectionNotifyOuterClass.AddAranaraCollectionNotify other) {
        ...
        if (other.iJBFIKCDABD_ != 0) {
          setIJBFIKCDABDValue(other.getIJBFIKCDABDValue());
        }
        if (other.cIEAPDGLPOL_ != 0) {
          setCIEAPDGLPOLValue(other.getCIEAPDGLPOLValue());
        }
      ...
      /**
       * <code>.AranaraCollectionState IJBFIKCDABD = 10;</code>
       * @param value The enum numeric value on the wire for iJBFIKCDABD to set.
       * @return This builder for chaining.
       */
      public Builder setIJBFIKCDABDValue(int value) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState getIJBFIKCDABD() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState result = emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.valueOf(iJBFIKCDABD_);
        return result == null ? emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.UNRECOGNIZED : result;
      }
      /**
       * <code>.AranaraCollectionState IJBFIKCDABD = 10;</code>
       * @param value The iJBFIKCDABD to set.
       * @return This builder for chaining.
       */
      public Builder setIJBFIKCDABD(emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState value) {
        if (value == null) {
          throw new NullPointerException();
        }
        
        iJBFIKCDABD_ = value.getNumber();
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearIJBFIKCDABD() {
      ...
      /**
       * <code>.AranaraCollectionState CIEAPDGLPOL = 4;</code>
       * @param value The enum numeric value on the wire for cIEAPDGLPOL to set.
       * @return This builder for chaining.
       */
      public Builder setCIEAPDGLPOLValue(int value) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState getCIEAPDGLPOL() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState result = emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.valueOf(cIEAPDGLPOL_);
        return result == null ? emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState.UNRECOGNIZED : result;
      }
      /**
       * <code>.AranaraCollectionState CIEAPDGLPOL = 4;</code>
       * @param value The cIEAPDGLPOL to set.
       * @return This builder for chaining.
       */
      public Builder setCIEAPDGLPOL(emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.AranaraCollectionState value) {
        if (value == null) {
          throw new NullPointerException();
        }
        
        cIEAPDGLPOL_ = value.getNumber();
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearCIEAPDGLPOL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022,\n\013IJBFIKCDABD\030\n \001(\0162\027.AranaraCollectio" +
      "nState\022,\n\013CIEAPDGLPOL\030\004 \001(\0162\027.AranaraCol" +
      "lectionState\022\025\n\rcollection_id\030\003 \001(\rB\033\n\031e" +
    ...
    internal_static_AddAranaraCollectionNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AddAranaraCollectionNotify_descriptor,
        new java.lang.String[] { "CollectionType", "IJBFIKCDABD", "CIEAPDGLPOL", "CollectionId", });
    emu.grasscutter.net.proto.AranaraCollectionStateOuterClass.getDescriptor();
  }
