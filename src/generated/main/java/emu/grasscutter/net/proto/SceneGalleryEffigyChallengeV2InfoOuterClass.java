...
public final class SceneGalleryEffigyChallengeV2InfoOuterClass {
  ...
  public interface SceneGalleryEffigyChallengeV2InfoOrBuilder extends
    ...
    /**
     * <code>uint32 HHMFOEGOJMP = 9;</code>
     * @return The hHMFOEGOJMP.
     */
    int getHHMFOEGOJMP();

    /**
     * <code>uint32 HKGMKGOGFEM = 8;</code>
     * @return The hKGMKGOGFEM.
     */
    int getHKGMKGOGFEM();

    /**
     * <code>uint32 INLLPJAEMNP = 10;</code>
     * @return The iNLLPJAEMNP.
     */
    int getINLLPJAEMNP();

    /**
     * <code>uint32 NCMKJCNLDHM = 4;</code>
     * @return The nCMKJCNLDHM.
     */
    int getNCMKJCNLDHM();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 72: {
              ...
              hHMFOEGOJMP_ = input.readUInt32();
              break;
            }
            case 80: {

              iNLLPJAEMNP_ = input.readUInt32();
              break;
            }
            case 112: {
    ...
    public static final int HHMFOEGOJMP_FIELD_NUMBER = 9;
    private int hHMFOEGOJMP_;
    /**
     * <code>uint32 HHMFOEGOJMP = 9;</code>
     * @return The hHMFOEGOJMP.
     */
    @java.lang.Override
    public int getHHMFOEGOJMP() {
      return hHMFOEGOJMP_;
    }

    public static final int HKGMKGOGFEM_FIELD_NUMBER = 8;
    ...
    public static final int INLLPJAEMNP_FIELD_NUMBER = 10;
    private int iNLLPJAEMNP_;
    /**
     * <code>uint32 INLLPJAEMNP = 10;</code>
     * @return The iNLLPJAEMNP.
     */
    @java.lang.Override
    public int getINLLPJAEMNP() {
      return iNLLPJAEMNP_;
    }

    public static final int NCMKJCNLDHM_FIELD_NUMBER = 4;
    private int nCMKJCNLDHM_;
    /**
     * <code>uint32 NCMKJCNLDHM = 4;</code>
     * @return The nCMKJCNLDHM.
     */
    @java.lang.Override
    public int getNCMKJCNLDHM() {
      return nCMKJCNLDHM_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (nCMKJCNLDHM_ != 0) {
        output.writeUInt32(4, nCMKJCNLDHM_);
      }
      if (hKGMKGOGFEM_ != 0) {
        output.writeUInt32(8, hKGMKGOGFEM_);
      }
      if (hHMFOEGOJMP_ != 0) {
        output.writeUInt32(9, hHMFOEGOJMP_);
      }
      if (iNLLPJAEMNP_ != 0) {
        output.writeUInt32(10, iNLLPJAEMNP_);
      }
      if (nCABJMDBENP_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (nCMKJCNLDHM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, nCMKJCNLDHM_);
      }
      if (hKGMKGOGFEM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, hKGMKGOGFEM_);
      }
      if (hHMFOEGOJMP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, hHMFOEGOJMP_);
      }
      if (iNLLPJAEMNP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, iNLLPJAEMNP_);
      }
      if (nCABJMDBENP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getHHMFOEGOJMP()
          != other.getHHMFOEGOJMP()) return false;
      if (getHKGMKGOGFEM()
          != other.getHKGMKGOGFEM()) return false;
      if (getINLLPJAEMNP()
          != other.getINLLPJAEMNP()) return false;
      if (getNCMKJCNLDHM()
          != other.getNCMKJCNLDHM()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + HHMFOEGOJMP_FIELD_NUMBER;
      hash = (53 * hash) + getHHMFOEGOJMP();
      hash = (37 * hash) + HKGMKGOGFEM_FIELD_NUMBER;
      hash = (53 * hash) + getHKGMKGOGFEM();
      hash = (37 * hash) + INLLPJAEMNP_FIELD_NUMBER;
      hash = (53 * hash) + getINLLPJAEMNP();
      hash = (37 * hash) + NCMKJCNLDHM_FIELD_NUMBER;
      hash = (53 * hash) + getNCMKJCNLDHM();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SceneGalleryEffigyChallengeV2InfoOuterClass.SceneGalleryEffigyChallengeV2Info buildPartial() {
        ...
        result.hHMFOEGOJMP_ = hHMFOEGOJMP_;
        result.hKGMKGOGFEM_ = hKGMKGOGFEM_;
        result.iNLLPJAEMNP_ = iNLLPJAEMNP_;
        result.nCMKJCNLDHM_ = nCMKJCNLDHM_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SceneGalleryEffigyChallengeV2InfoOuterClass.SceneGalleryEffigyChallengeV2Info other) {
        ...
        if (other.getHHMFOEGOJMP() != 0) {
          setHHMFOEGOJMP(other.getHHMFOEGOJMP());
        }
        if (other.getHKGMKGOGFEM() != 0) {
          setHKGMKGOGFEM(other.getHKGMKGOGFEM());
        }
        if (other.getINLLPJAEMNP() != 0) {
          setINLLPJAEMNP(other.getINLLPJAEMNP());
        }
        if (other.getNCMKJCNLDHM() != 0) {
          setNCMKJCNLDHM(other.getNCMKJCNLDHM());
        }
      ...
      /**
       * <code>uint32 HHMFOEGOJMP = 9;</code>
       * @param value The hHMFOEGOJMP to set.
       * @return This builder for chaining.
       */
      public Builder setHHMFOEGOJMP(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHHMFOEGOJMP() {
      ...
      /**
       * <code>uint32 INLLPJAEMNP = 10;</code>
       * @param value The iNLLPJAEMNP to set.
       * @return This builder for chaining.
       */
      public Builder setINLLPJAEMNP(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearINLLPJAEMNP() {
      ...
      /**
       * <code>uint32 NCMKJCNLDHM = 4;</code>
       * @param value The nCMKJCNLDHM to set.
       * @return This builder for chaining.
       */
      public Builder setNCMKJCNLDHM(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNCMKJCNLDHM() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\023\n\013NCABJMDBENP\030\016 \001(\r\022\023\n\013HHMFOEGOJMP\030\t \001(" +
      "\r\022\023\n\013HKGMKGOGFEM\030\010 \001(\r\022\023\n\013INLLPJAEMNP\030\n " +
      "\001(\r\022\023\n\013NCMKJCNLDHM\030\004 \001(\rB\033\n\031emu.grasscut" +
    ...
    internal_static_SceneGalleryEffigyChallengeV2Info_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneGalleryEffigyChallengeV2Info_descriptor,
        new java.lang.String[] { "NCABJMDBENP", "HHMFOEGOJMP", "HKGMKGOGFEM", "INLLPJAEMNP", "NCMKJCNLDHM", });
  }
