...
public final class GCGSkillPreviewReactionInfoOuterClass {
  ...
  public interface GCGSkillPreviewReactionInfoOrBuilder extends
    ...
    /**
     * <code>uint32 EIJFJJJBIIH = 9;</code>
     * @return The eIJFJJJBIIH.
     */
    int getEIJFJJJBIIH();

    /**
     * <code>uint32 LKDBPBBGDBN = 12;</code>
     * @return The lKDBPBBGDBN.
     */
    int getLKDBPBBGDBN();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 72: {
              ...
              eIJFJJJBIIH_ = input.readUInt32();
              break;
            }
            case 96: {

              lKDBPBBGDBN_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int EIJFJJJBIIH_FIELD_NUMBER = 9;
    private int eIJFJJJBIIH_;
    /**
     * <code>uint32 EIJFJJJBIIH = 9;</code>
     * @return The eIJFJJJBIIH.
     */
    @java.lang.Override
    public int getEIJFJJJBIIH() {
      return eIJFJJJBIIH_;
    }

    public static final int LKDBPBBGDBN_FIELD_NUMBER = 12;
    private int lKDBPBBGDBN_;
    /**
     * <code>uint32 LKDBPBBGDBN = 12;</code>
     * @return The lKDBPBBGDBN.
     */
    @java.lang.Override
    public int getLKDBPBBGDBN() {
      return lKDBPBBGDBN_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (eIJFJJJBIIH_ != 0) {
        output.writeUInt32(9, eIJFJJJBIIH_);
      }
      if (lKDBPBBGDBN_ != 0) {
        output.writeUInt32(12, lKDBPBBGDBN_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (eIJFJJJBIIH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, eIJFJJJBIIH_);
      }
      if (lKDBPBBGDBN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, lKDBPBBGDBN_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getEIJFJJJBIIH()
          != other.getEIJFJJJBIIH()) return false;
      if (getLKDBPBBGDBN()
          != other.getLKDBPBBGDBN()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + EIJFJJJBIIH_FIELD_NUMBER;
      hash = (53 * hash) + getEIJFJJJBIIH();
      hash = (37 * hash) + LKDBPBBGDBN_FIELD_NUMBER;
      hash = (53 * hash) + getLKDBPBBGDBN();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.GCGSkillPreviewReactionInfoOuterClass.GCGSkillPreviewReactionInfo buildPartial() {
        ...
        result.eIJFJJJBIIH_ = eIJFJJJBIIH_;
        result.lKDBPBBGDBN_ = lKDBPBBGDBN_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GCGSkillPreviewReactionInfoOuterClass.GCGSkillPreviewReactionInfo other) {
        ...
        if (other.getEIJFJJJBIIH() != 0) {
          setEIJFJJJBIIH(other.getEIJFJJJBIIH());
        }
        if (other.getLKDBPBBGDBN() != 0) {
          setLKDBPBBGDBN(other.getLKDBPBBGDBN());
        }
      ...
      /**
       * <code>uint32 EIJFJJJBIIH = 9;</code>
       * @param value The eIJFJJJBIIH to set.
       * @return This builder for chaining.
       */
      public Builder setEIJFJJJBIIH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearEIJFJJJBIIH() {
      ...
      /**
       * <code>uint32 LKDBPBBGDBN = 12;</code>
       * @param value The lKDBPBBGDBN to set.
       * @return This builder for chaining.
       */
      public Builder setLKDBPBBGDBN(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLKDBPBBGDBN() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "H\030\t \001(\r\022\023\n\013LKDBPBBGDBN\030\014 \001(\rB\033\n\031emu.gras" +
    ...
    internal_static_GCGSkillPreviewReactionInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGSkillPreviewReactionInfo_descriptor,
        new java.lang.String[] { "EIJFJJJBIIH", "LKDBPBBGDBN", });
  }
