...
public final class CharAmusementAvatarInfoOuterClass {
  ...
  public interface CharAmusementAvatarInfoOrBuilder extends
    ...
    /**
     * <code>uint32 punish_time = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PUNISH_TIME_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (punishTime_ != 0) {
        output.writeUInt32(7, punishTime_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (punishTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, punishTime_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < avatarIdList_.size(); i++) {
