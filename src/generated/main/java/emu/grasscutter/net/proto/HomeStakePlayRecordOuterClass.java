...
public final class HomeStakePlayRecordOuterClass {
  ...
  public interface HomeStakePlayRecordOrBuilder extends
    ...
    /**
     * <code>repeated .HomeGroupPlayerInfo engaged_player_info_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ENGAGED_PLAYER_INFO_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < engagedPlayerInfoList_.size(); i++) {
        output.writeMessage(3, engagedPlayerInfoList_.get(i));
      }
      if (timestamp_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < engagedPlayerInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, engagedPlayerInfoList_.get(i));
      }
      if (timestamp_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\ttimestamp\030\013 \001(\r\0226\n\030engaged_player_info_" +
      "list\030\003 \003(\0132\024.HomeGroupPlayerInfoB\033\n\031emu." +
