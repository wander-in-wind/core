...
public final class SceneGallerySummerTimeV2BoatInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (param3_ != 0) {
        output.writeUInt32(7, param3_);
      }
      if (usedTime_ != 0) {
        output.writeUInt32(9, usedTime_);
      }
      if (param1_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (param3_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, param3_);
      }
      if (usedTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, usedTime_);
      }
      if (param1_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "param3\030\007 \001(\r\022\016\n\006param1\030\016 \001(\r\022\016\n\006param2\030\017" +
      " \001(\r\022\021\n\tused_time\030\t \001(\rB\033\n\031emu.grasscutt" +
    ...
    internal_static_SceneGallerySummerTimeV2BoatInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneGallerySummerTimeV2BoatInfo_descriptor,
        new java.lang.String[] { "Param3", "Param1", "Param2", "UsedTime", });
  }
