...
public final class SaveCustomDungeonRoomRspOuterClass {
  ...
  public interface SaveCustomDungeonRoomRspOrBuilder extends
    ...
    /**
     * <code>repeated .CustomDungeonBlock error_block_list = 5;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ERROR_BLOCK_LIST_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < errorBlockList_.size(); i++) {
        output.writeMessage(5, errorBlockList_.get(i));
      }
      if (roomId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < errorBlockList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, errorBlockList_.get(i));
      }
      if (roomId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ist\030\005 \003(\0132\023.CustomDungeonBlock\022\017\n\007room_i" +
