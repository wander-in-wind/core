...
public final class AbilityActionSetCrashDamageOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int HIT_POS_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (hitPos_ != null) {
        output.writeMessage(10, getHitPos());
      }
      if (damage_ != 0F) {
        output.writeFloat(14, damage_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (hitPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, getHitPos());
      }
      if (damage_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(14, damage_);
      }
