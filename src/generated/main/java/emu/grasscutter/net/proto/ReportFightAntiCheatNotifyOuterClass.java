...
public final class ReportFightAntiCheatNotifyOuterClass {
  ...
  public interface ReportFightAntiCheatNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 DOKPOLHDEPI = 1;</code>
     * @return The dOKPOLHDEPI.
     */
    int getDOKPOLHDEPI();

    /**
     * <code>uint32 OPFCEOHOBMH = 10;</code>
     * @return The oPFCEOHOBMH.
     */
    int getOPFCEOHOBMH();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              dOKPOLHDEPI_ = input.readUInt32();
              break;
            }
            case 80: {

              oPFCEOHOBMH_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int DOKPOLHDEPI_FIELD_NUMBER = 1;
    private int dOKPOLHDEPI_;
    /**
     * <code>uint32 DOKPOLHDEPI = 1;</code>
     * @return The dOKPOLHDEPI.
     */
    @java.lang.Override
    public int getDOKPOLHDEPI() {
      return dOKPOLHDEPI_;
    }

    public static final int OPFCEOHOBMH_FIELD_NUMBER = 10;
    private int oPFCEOHOBMH_;
    /**
     * <code>uint32 OPFCEOHOBMH = 10;</code>
     * @return The oPFCEOHOBMH.
     */
    @java.lang.Override
    public int getOPFCEOHOBMH() {
      return oPFCEOHOBMH_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (dOKPOLHDEPI_ != 0) {
        output.writeUInt32(1, dOKPOLHDEPI_);
      }
      if (oPFCEOHOBMH_ != 0) {
        output.writeUInt32(10, oPFCEOHOBMH_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (dOKPOLHDEPI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, dOKPOLHDEPI_);
      }
      if (oPFCEOHOBMH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, oPFCEOHOBMH_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getDOKPOLHDEPI()
          != other.getDOKPOLHDEPI()) return false;
      if (getOPFCEOHOBMH()
          != other.getOPFCEOHOBMH()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + DOKPOLHDEPI_FIELD_NUMBER;
      hash = (53 * hash) + getDOKPOLHDEPI();
      hash = (37 * hash) + OPFCEOHOBMH_FIELD_NUMBER;
      hash = (53 * hash) + getOPFCEOHOBMH();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ReportFightAntiCheatNotifyOuterClass.ReportFightAntiCheatNotify buildPartial() {
        ...
        result.dOKPOLHDEPI_ = dOKPOLHDEPI_;
        result.oPFCEOHOBMH_ = oPFCEOHOBMH_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ReportFightAntiCheatNotifyOuterClass.ReportFightAntiCheatNotify other) {
        ...
        if (other.getDOKPOLHDEPI() != 0) {
          setDOKPOLHDEPI(other.getDOKPOLHDEPI());
        }
        if (other.getOPFCEOHOBMH() != 0) {
          setOPFCEOHOBMH(other.getOPFCEOHOBMH());
        }
      ...
      /**
       * <code>uint32 DOKPOLHDEPI = 1;</code>
       * @param value The dOKPOLHDEPI to set.
       * @return This builder for chaining.
       */
      public Builder setDOKPOLHDEPI(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearDOKPOLHDEPI() {
      ...
      /**
       * <code>uint32 OPFCEOHOBMH = 10;</code>
       * @param value The oPFCEOHOBMH to set.
       * @return This builder for chaining.
       */
      public Builder setOPFCEOHOBMH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearOPFCEOHOBMH() {
  ...
  static {
    ...
    internal_static_ReportFightAntiCheatNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ReportFightAntiCheatNotify_descriptor,
        new java.lang.String[] { "DOKPOLHDEPI", "OPFCEOHOBMH", });
  }
