...
public final class DungeonCandidateTeamReplyInviteRspOuterClass {
  ...
  public interface DungeonCandidateTeamReplyInviteRspOrBuilder extends
    ...
    /**
     * <code>bool is_trans_point = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_TRANS_POINT_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isTransPoint_ != false) {
        output.writeBool(6, isTransPoint_);
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (isTransPoint_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(6, isTransPoint_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
