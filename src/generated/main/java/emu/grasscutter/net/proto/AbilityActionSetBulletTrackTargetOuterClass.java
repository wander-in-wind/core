...
public final class AbilityActionSetBulletTrackTargetOuterClass {
  ...
  public interface AbilityActionSetBulletTrackTargetOrBuilder extends
    ...
    /**
     * <code>uint32 chased_entity_id = 1;</code>
     * @return The chasedEntityId.
     */
    int getChasedEntityId();

    /**
     * <code>uint32 lock_point_index = 2;</code>
     * @return The lockPointIndex.
     */
    int getLockPointIndex();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              chasedEntityId_ = input.readUInt32();
              break;
            }
            case 16: {

              lockPointIndex_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int CHASED_ENTITY_ID_FIELD_NUMBER = 1;
    private int chasedEntityId_;
    /**
     * <code>uint32 chased_entity_id = 1;</code>
     * @return The chasedEntityId.
     */
    @java.lang.Override
    public int getChasedEntityId() {
      return chasedEntityId_;
    }

    public static final int LOCK_POINT_INDEX_FIELD_NUMBER = 2;
    private int lockPointIndex_;
    /**
     * <code>uint32 lock_point_index = 2;</code>
     * @return The lockPointIndex.
     */
    @java.lang.Override
    public int getLockPointIndex() {
      return lockPointIndex_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (chasedEntityId_ != 0) {
        output.writeUInt32(1, chasedEntityId_);
      }
      if (lockPointIndex_ != 0) {
        output.writeUInt32(2, lockPointIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (chasedEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, chasedEntityId_);
      }
      if (lockPointIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, lockPointIndex_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getChasedEntityId()
          != other.getChasedEntityId()) return false;
      if (getLockPointIndex()
          != other.getLockPointIndex()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + CHASED_ENTITY_ID_FIELD_NUMBER;
      hash = (53 * hash) + getChasedEntityId();
      hash = (37 * hash) + LOCK_POINT_INDEX_FIELD_NUMBER;
      hash = (53 * hash) + getLockPointIndex();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.AbilityActionSetBulletTrackTargetOuterClass.AbilityActionSetBulletTrackTarget buildPartial() {
        ...
        result.chasedEntityId_ = chasedEntityId_;
        result.lockPointIndex_ = lockPointIndex_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AbilityActionSetBulletTrackTargetOuterClass.AbilityActionSetBulletTrackTarget other) {
        ...
        if (other.getChasedEntityId() != 0) {
          setChasedEntityId(other.getChasedEntityId());
        }
        if (other.getLockPointIndex() != 0) {
          setLockPointIndex(other.getLockPointIndex());
        }
      ...
      /**
       * <code>uint32 chased_entity_id = 1;</code>
       * @param value The chasedEntityId to set.
       * @return This builder for chaining.
       */
      public Builder setChasedEntityId(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearChasedEntityId() {
      ...
      /**
       * <code>uint32 lock_point_index = 2;</code>
       * @param value The lockPointIndex to set.
       * @return This builder for chaining.
       */
      public Builder setLockPointIndex(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLockPointIndex() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "o\"W\n!AbilityActionSetBulletTrackTarget\022\030" +
      "\n\020chased_entity_id\030\001 \001(\r\022\030\n\020lock_point_i" +
      "ndex\030\002 \001(\rB\033\n\031emu.grasscutter.net.protob" +
      "\006proto3"
    };
    ...
    internal_static_AbilityActionSetBulletTrackTarget_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityActionSetBulletTrackTarget_descriptor,
        new java.lang.String[] { "ChasedEntityId", "LockPointIndex", });
  }
