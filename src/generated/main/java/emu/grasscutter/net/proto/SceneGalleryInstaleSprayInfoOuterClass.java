...
public final class SceneGalleryInstaleSprayInfoOuterClass {
  ...
  public interface SceneGalleryInstaleSprayInfoOrBuilder extends
    ...
    /**
     * <code>repeated .SceneGalleryInstableSprayBuffInfo buff_info_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BUFF_INFO_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < buffInfoList_.size(); i++) {
        output.writeMessage(3, buffInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < buffInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, buffInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \001(\r\022:\n\016buff_info_list\030\003 \003(\0132\".SceneGall" +
