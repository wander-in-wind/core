...
public final class GCGMsgCostReviseOuterClass {
  ...
  public interface GCGMsgCostReviseOrBuilder extends
    ...
    /**
     * <code>.GCGCostReviseInfo cost_revise = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int COST_REVISE_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (costRevise_ != null) {
        output.writeMessage(5, getCostRevise());
      }
      if (controllerId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (costRevise_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, getCostRevise());
      }
      if (controllerId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "vise\030\005 \001(\0132\022.GCGCostReviseInfo\022\025\n\rcontro" +
