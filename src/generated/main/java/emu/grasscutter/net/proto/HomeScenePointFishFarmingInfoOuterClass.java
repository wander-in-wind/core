...
public final class HomeScenePointFishFarmingInfoOuterClass {
  ...
  public interface HomeScenePointFishFarmingInfoOrBuilder extends
    ...
    /**
     * <code>uint32 local_entity_id = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LOCAL_ENTITY_ID_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (localEntityId_ != 0) {
        output.writeUInt32(1, localEntityId_);
      }
      if (sceneId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (localEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, localEntityId_);
      }
      if (sceneId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "id\030\t \001(\r\022\024\n\014fish_id_list\030\017 \003(\r\022\027\n\017local_" +
