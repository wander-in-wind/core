...
public final class VintageMarketStartStorePlayRspOuterClass {
  ...
  public interface VintageMarketStartStorePlayRspOrBuilder extends
    ...
    /**
     * <code>uint32 HCINPOEALAH = 10;</code>
     * @return The hCINPOEALAH.
     */
    int getHCINPOEALAH();

    /**
     * <code>uint32 BPKMLMJPAMG = 2;</code>
     * @return The bPKMLMJPAMG.
     */
    int getBPKMLMJPAMG();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int HCINPOEALAH_FIELD_NUMBER = 10;
    private int hCINPOEALAH_;
    /**
     * <code>uint32 HCINPOEALAH = 10;</code>
     * @return The hCINPOEALAH.
     */
    @java.lang.Override
    public int getHCINPOEALAH() {
      return hCINPOEALAH_;
    }

    public static final int BPKMLMJPAMG_FIELD_NUMBER = 2;
    private int bPKMLMJPAMG_;
    /**
     * <code>uint32 BPKMLMJPAMG = 2;</code>
     * @return The bPKMLMJPAMG.
     */
    @java.lang.Override
    public int getBPKMLMJPAMG() {
      return bPKMLMJPAMG_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (bPKMLMJPAMG_ != 0) {
        output.writeUInt32(2, bPKMLMJPAMG_);
      }
      if (retcode_ != 0) {
      ...
      if (hCINPOEALAH_ != 0) {
        output.writeUInt32(10, hCINPOEALAH_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (bPKMLMJPAMG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, bPKMLMJPAMG_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (hCINPOEALAH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, hCINPOEALAH_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getHCINPOEALAH()
          != other.getHCINPOEALAH()) return false;
      if (getBPKMLMJPAMG()
          != other.getBPKMLMJPAMG()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + HCINPOEALAH_FIELD_NUMBER;
      hash = (53 * hash) + getHCINPOEALAH();
      hash = (37 * hash) + BPKMLMJPAMG_FIELD_NUMBER;
      hash = (53 * hash) + getBPKMLMJPAMG();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.VintageMarketStartStorePlayRspOuterClass.VintageMarketStartStorePlayRsp buildPartial() {
        ...
        result.hCINPOEALAH_ = hCINPOEALAH_;
        result.bPKMLMJPAMG_ = bPKMLMJPAMG_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.VintageMarketStartStorePlayRspOuterClass.VintageMarketStartStorePlayRsp other) {
        ...
        if (other.getHCINPOEALAH() != 0) {
          setHCINPOEALAH(other.getHCINPOEALAH());
        }
        if (other.getBPKMLMJPAMG() != 0) {
          setBPKMLMJPAMG(other.getBPKMLMJPAMG());
        }
      ...
      /**
       * <code>uint32 HCINPOEALAH = 10;</code>
       * @param value The hCINPOEALAH to set.
       * @return This builder for chaining.
       */
      public Builder setHCINPOEALAH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHCINPOEALAH() {
      ...
      /**
       * <code>uint32 BPKMLMJPAMG = 2;</code>
       * @param value The bPKMLMJPAMG to set.
       * @return This builder for chaining.
       */
      public Builder setBPKMLMJPAMG(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBPKMLMJPAMG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "EALAH\030\n \001(\r\022\023\n\013BPKMLMJPAMG\030\002 \001(\rB\033\n\031emu." +
    ...
    internal_static_VintageMarketStartStorePlayRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_VintageMarketStartStorePlayRsp_descriptor,
        new java.lang.String[] { "Retcode", "StoreRound", "HCINPOEALAH", "BPKMLMJPAMG", });
  }
