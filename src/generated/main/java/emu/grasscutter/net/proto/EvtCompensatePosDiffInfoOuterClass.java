...
public final class EvtCompensatePosDiffInfoOuterClass {
  ...
  public interface EvtCompensatePosDiffInfoOrBuilder extends
    ...
    /**
     * <code>uint32 PGOCJMIFLCK = 1;</code>
     * @return The pGOCJMIFLCK.
     */
    int getPGOCJMIFLCK();

    /**
     * <code>uint32 EJAOGEAEKOH = 15;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PGOCJMIFLCK_FIELD_NUMBER = 1;
    private int pGOCJMIFLCK_;
    /**
     * <code>uint32 PGOCJMIFLCK = 1;</code>
     * @return The pGOCJMIFLCK.
     */
    @java.lang.Override
    public int getPGOCJMIFLCK() {
      return pGOCJMIFLCK_;
    }

    public static final int EJAOGEAEKOH_FIELD_NUMBER = 15;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (pGOCJMIFLCK_ != 0) {
        output.writeUInt32(1, pGOCJMIFLCK_);
      }
      if (curPos_ != null) {
      ...
      if (eJAOGEAEKOH_ != 0) {
        output.writeUInt32(15, eJAOGEAEKOH_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (pGOCJMIFLCK_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, pGOCJMIFLCK_);
      }
      if (curPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (eJAOGEAEKOH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, eJAOGEAEKOH_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getPGOCJMIFLCK()
          != other.getPGOCJMIFLCK()) return false;
      if (getEJAOGEAEKOH()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + PGOCJMIFLCK_FIELD_NUMBER;
      hash = (53 * hash) + getPGOCJMIFLCK();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo buildPartial() {
        ...
        result.pGOCJMIFLCK_ = pGOCJMIFLCK_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo other) {
        ...
        if (other.getPGOCJMIFLCK() != 0) {
          setPGOCJMIFLCK(other.getPGOCJMIFLCK());
        }
      ...
      /**
       * <code>uint32 PGOCJMIFLCK = 1;</code>
       * @param value The pGOCJMIFLCK to set.
       * @return This builder for chaining.
       */
      public Builder setPGOCJMIFLCK(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearPGOCJMIFLCK() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      ".proto\"\215\001\n\030EvtCompensatePosDiffInfo\022\023\n\013P" +
      "GOCJMIFLCK\030\001 \001(\r\022\023\n\013EJAOGEAEKOH\030\017 \001(\r\022\032\n" +
      "\022face_angle_compact\030\014 \001(\005\022\021\n\tentity_id\030\r" +
      " \001(\r\022\030\n\007cur_pos\030\007 \001(\0132\007.VectorB\033\n\031emu.gr" +
    ...
    internal_static_EvtCompensatePosDiffInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_EvtCompensatePosDiffInfo_descriptor,
        new java.lang.String[] { "PGOCJMIFLCK", "EJAOGEAEKOH", "FaceAngleCompact", "EntityId", "CurPos", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
