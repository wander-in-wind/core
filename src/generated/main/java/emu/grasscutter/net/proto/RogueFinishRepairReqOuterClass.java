...
public final class RogueFinishRepairReqOuterClass {
  ...
  public interface RogueFinishRepairReqOrBuilder extends
    ...
    /**
     * <code>repeated .RogueDiaryAvatar chosen_avatar_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CHOSEN_AVATAR_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < chosenAvatarList_.size(); i++) {
        output.writeMessage(3, chosenAvatarList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < chosenAvatarList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, chosenAvatarList_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < chosenCardList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "chosen_avatar_list\030\003 \003(\0132\021.RogueDiaryAva" +
      "tar\022\030\n\020chosen_card_list\030\005 \003(\rB\033\n\031emu.gra" +
