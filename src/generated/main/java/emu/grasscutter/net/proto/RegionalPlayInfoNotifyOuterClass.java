...
public final class RegionalPlayInfoNotifyOuterClass {
  ...
  public interface RegionalPlayInfoNotifyOrBuilder extends
    ...
    /**
     * <code>bool LJFEFBNPALB = 7;</code>
     * @return The lJFEFBNPALB.
     */
    boolean getLJFEFBNPALB();

    /**
     * <code>repeated .RegionalPlayVar var_list = 1;</code>
     */
    ...
    /**
     * <code>bool JEPMEPFCDDA = 8;</code>
     * @return The jEPMEPFCDDA.
     */
    boolean getJEPMEPFCDDA();

    /**
     * <code>string play_name = 11;</code>
     * @return The playName.
     */
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              lJFEFBNPALB_ = input.readBool();
              break;
            }
            case 64: {

              jEPMEPFCDDA_ = input.readBool();
              break;
            }
            case 90: {
    ...
    public static final int LJFEFBNPALB_FIELD_NUMBER = 7;
    private boolean lJFEFBNPALB_;
    /**
     * <code>bool LJFEFBNPALB = 7;</code>
     * @return The lJFEFBNPALB.
     */
    @java.lang.Override
    public boolean getLJFEFBNPALB() {
      return lJFEFBNPALB_;
    }
    ...
    public static final int JEPMEPFCDDA_FIELD_NUMBER = 8;
    private boolean jEPMEPFCDDA_;
    /**
     * <code>bool JEPMEPFCDDA = 8;</code>
     * @return The jEPMEPFCDDA.
     */
    @java.lang.Override
    public boolean getJEPMEPFCDDA() {
      return jEPMEPFCDDA_;
    }

    public static final int PLAY_NAME_FIELD_NUMBER = 11;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lJFEFBNPALB_ != false) {
        output.writeBool(7, lJFEFBNPALB_);
      }
      if (jEPMEPFCDDA_ != false) {
        output.writeBool(8, jEPMEPFCDDA_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(playName_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 11, playName_);
      }
      if (playType_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (lJFEFBNPALB_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(7, lJFEFBNPALB_);
      }
      if (jEPMEPFCDDA_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(8, jEPMEPFCDDA_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(playName_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(11, playName_);
      }
      if (playType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getLJFEFBNPALB()
          != other.getLJFEFBNPALB()) return false;
      if (!getVarListList()
          .equals(other.getVarListList())) return false;
      if (getJEPMEPFCDDA()
          != other.getJEPMEPFCDDA()) return false;
      if (!getPlayName()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + LJFEFBNPALB_FIELD_NUMBER;
      ...
      hash = (37 * hash) + JEPMEPFCDDA_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getJEPMEPFCDDA());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.RegionalPlayInfoNotifyOuterClass.RegionalPlayInfoNotify buildPartial() {
        ...
        result.lJFEFBNPALB_ = lJFEFBNPALB_;
        if (varListBuilder_ == null) {
        ...
        result.jEPMEPFCDDA_ = jEPMEPFCDDA_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.RegionalPlayInfoNotifyOuterClass.RegionalPlayInfoNotify other) {
        ...
        if (other.getLJFEFBNPALB() != false) {
          setLJFEFBNPALB(other.getLJFEFBNPALB());
        }
        if (varListBuilder_ == null) {
        ...
        if (other.getJEPMEPFCDDA() != false) {
          setJEPMEPFCDDA(other.getJEPMEPFCDDA());
        }
      ...
      /**
       * <code>bool LJFEFBNPALB = 7;</code>
       * @param value The lJFEFBNPALB to set.
       * @return This builder for chaining.
       */
      public Builder setLJFEFBNPALB(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLJFEFBNPALB() {
      ...
      /**
       * <code>bool JEPMEPFCDDA = 8;</code>
       * @param value The jEPMEPFCDDA to set.
       * @return This builder for chaining.
       */
      public Builder setJEPMEPFCDDA(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearJEPMEPFCDDA() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\021\n\tplay_type\030\016 \001(\r\022\023\n\013LJFEFBNPALB\030\007 \001(\010" +
      "\022\"\n\010var_list\030\001 \003(\0132\020.RegionalPlayVar\022\023\n\013" +
      "JEPMEPFCDDA\030\010 \001(\010\022\021\n\tplay_name\030\013 \001(\tB\033\n\031" +
    ...
    internal_static_RegionalPlayInfoNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_RegionalPlayInfoNotify_descriptor,
        new java.lang.String[] { "PlayType", "LJFEFBNPALB", "VarList", "JEPMEPFCDDA", "PlayName", });
    emu.grasscutter.net.proto.RegionalPlayVarOuterClass.getDescriptor();
  }
