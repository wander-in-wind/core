...
public final class FishInfoOuterClass {
  ...
  public interface FishInfoOrBuilder extends
    ...
    /**
     * <code>uint32 AIJOJFINDOH = 8;</code>
     * @return The aIJOJFINDOH.
     */
    int getAIJOJFINDOH();

    /**
     * <code>uint32 PIHGEIKICJI = 5;</code>
     * @return The pIHGEIKICJI.
     */
    int getPIHGEIKICJI();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              pIHGEIKICJI_ = input.readUInt32();
              break;
            }
            case 64: {

              aIJOJFINDOH_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int AIJOJFINDOH_FIELD_NUMBER = 8;
    private int aIJOJFINDOH_;
    /**
     * <code>uint32 AIJOJFINDOH = 8;</code>
     * @return The aIJOJFINDOH.
     */
    @java.lang.Override
    public int getAIJOJFINDOH() {
      return aIJOJFINDOH_;
    }

    public static final int PIHGEIKICJI_FIELD_NUMBER = 5;
    private int pIHGEIKICJI_;
    /**
     * <code>uint32 PIHGEIKICJI = 5;</code>
     * @return The pIHGEIKICJI.
     */
    @java.lang.Override
    public int getPIHGEIKICJI() {
      return pIHGEIKICJI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (pIHGEIKICJI_ != 0) {
        output.writeUInt32(5, pIHGEIKICJI_);
      }
      if (aIJOJFINDOH_ != 0) {
        output.writeUInt32(8, aIJOJFINDOH_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (pIHGEIKICJI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, pIHGEIKICJI_);
      }
      if (aIJOJFINDOH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, aIJOJFINDOH_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getAIJOJFINDOH()
          != other.getAIJOJFINDOH()) return false;
      if (getPIHGEIKICJI()
          != other.getPIHGEIKICJI()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + AIJOJFINDOH_FIELD_NUMBER;
      hash = (53 * hash) + getAIJOJFINDOH();
      hash = (37 * hash) + PIHGEIKICJI_FIELD_NUMBER;
      hash = (53 * hash) + getPIHGEIKICJI();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.FishInfoOuterClass.FishInfo buildPartial() {
        ...
        result.aIJOJFINDOH_ = aIJOJFINDOH_;
        result.pIHGEIKICJI_ = pIHGEIKICJI_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FishInfoOuterClass.FishInfo other) {
        ...
        if (other.getAIJOJFINDOH() != 0) {
          setAIJOJFINDOH(other.getAIJOJFINDOH());
        }
        if (other.getPIHGEIKICJI() != 0) {
          setPIHGEIKICJI(other.getPIHGEIKICJI());
        }
      ...
      /**
       * <code>uint32 AIJOJFINDOH = 8;</code>
       * @param value The aIJOJFINDOH to set.
       * @return This builder for chaining.
       */
      public Builder setAIJOJFINDOH(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearAIJOJFINDOH() {
      ...
      /**
       * <code>uint32 PIHGEIKICJI = 5;</code>
       * @param value The pIHGEIKICJI to set.
       * @return This builder for chaining.
       */
      public Builder setPIHGEIKICJI(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearPIHGEIKICJI() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\016FishInfo.proto\"4\n\010FishInfo\022\023\n\013AIJOJFIN" +
      "DOH\030\010 \001(\r\022\023\n\013PIHGEIKICJI\030\005 \001(\rB\033\n\031emu.gr" +
    ...
    internal_static_FishInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FishInfo_descriptor,
        new java.lang.String[] { "AIJOJFINDOH", "PIHGEIKICJI", });
  }
